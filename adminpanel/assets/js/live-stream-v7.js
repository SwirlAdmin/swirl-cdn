$(document).ready(function () {
    ...
    $('#recordingURLInputFile').on('change', function (event) {
        ...
        let fileSizeInKB = (fileSizeInBytes / 1024).toFixed(2); // in KB
        let fileSizeInMB = (fileSizeInKB / 1024).toFixed(2); // in MB

        if(fileSizeInMB >150)
        {
            toastr.error('Maximum file size is 150MB');
            $('#recordingURLInputFile').val('');
            return false;
        }
