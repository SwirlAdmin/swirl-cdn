$(document).ready(function () {
    ...
    $('#swirl-video-list').DataTable({
        'processing': true,
        'serverSide': true,
        'serverMethod': 'post',
        'ajax': {
            'url': base_url + 'admin/Swirl/getSwirlList'
        },
        dom: 'Bfrtip',
        buttons: [
            {
    ...
    $('#product-list').DataTable({
        ...
        'serverMethod': 'post',
        'ajax': {
            'url': base_url + 'admin/Swirl/swirlListing'
        },
        dom: 'Bfrtip',
        buttons: [
            {
...
$('#updategif-form').on('submit', function (e) {
    e.preventDefault();
     ...
     let base_url ='https://goswirl.online/admin/';
    $.ajax({
        type: 'POST',
