                    ...
                    <div class="SSV-play-modal">                
                        <div class="SSV-play-modal-video-container">
                            ...
                            <button type="button" class="SSV-play-modal-share SSV-play-modal-operation-btns" title="Share">
                                <img src="https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/assets/images/fintoo_share.png" alt="Share icon" height="" width="">
                            </button>
                            ...
                            <button type="button" class="SSV-play-modal-askaque SSV-play-modal-operation-btns" title="Ask Question">
                                <img src="https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/assets/images/talk_to_expert.png" alt="Ask Question icon" height="" width="">
                            </button>
            ...
            `);
                ...
                if (typeof SSVvideosAll['swilrs']['video'] != 'undefined') {
                    ...
                    jQuery('.SSV-play-modal-askaque').click(function () {
                        ...
                        // jQuery('.SSV-CTA-modal-inner').hide();
                        // jQuery('.SSV-ask-question').show();
                        window.open('https://calendly.com/fintoo/15-minutes-financial-planning-session?utm_source=93&utm_medium=1&utm_campaign=98&utm_content=Swirlspeakwithexpert', '_blank');
                    });
