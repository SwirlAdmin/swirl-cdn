...
(function () {
    ...
    if (localStorage.getItem('SSVallURL') && localStorage.getItem('SSVlastPlayed') && document.querySelector('#swirl-short-videos') == null) {
        ...
        jqTag.href = 'https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/woocommerce/v7.13/short-video.min.css';
                ...
                <div id="SSV-short-videos">
                    ...
                    <div class="SSV-play-modal">                
                        <div class="SSV-play-modal-video-container">
                            ...
                            <div class="SSV-product-info-full">
                                <label class="SSV-product-info-full-close" onclick="jQuery('.SSV-product-info-full').css('transform', 'translateY(110%)')">&times;</label>
                                <div class="SSV-pif-top">
                                ...
                                <div class="SSV-pif-middle">
                                    <div class="SSV-pif-desc">
                                        <section>
                                            <p></p>
                                        </section>
                                    </div>
                                    <div class="SSV-pif-qty">
                                        <p>Choose Quantity</p>
                                        <div>
                                            <button onclick="SSVchangeQty('minus');">-</button>
                                            <input class="pif-qty" value="1" readonly></input>
                                            <button onclick="SSVchangeQty('plus');">+</button>
                                        </div>
                                    </div>
                                    <div class="SSV-pif-ratings">                                        
                                    </div>
                                </div>                                

                                <div class="SSV-pif-ratings-all">                                                              
                                </div>

                                <div class="SSV-pif-bottom">
                                    <p class="SSV-pif-bottom-error-label">Select quantity</p>
                                    <button type="button" class="SSV-play-modal-addtocart SSV-pif-addtocart" data-action="1">Add to Cart</button>
                                    <button type="button" class="SSV-play-modal-addtocart SSV-pif-buynow" data-action="2">Buy Now</button>
                                    <button type="button" class="SSV-play-modal-addtocart SSV-pif-cart xoo-wsc-cart-trigger" data-action="3">
                                        <label class="SSV-pif-cart-count"></label>
                                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" color="black" height="26" width="26" xmlns="http://www.w3.org/2000/svg" style="color: black;"><path fill="none" stroke="#000" stroke-width="2" d="M5,5 L22,5 L20,14 L7,14 L4,2 L0,2 M7,14 L8,18 L21,18 M19,23 C18.4475,23 18,22.5525 18,22 C18,21.4475 18.4475,21 19,21 C19.5525,21 20,21.4475 20,22 C20,22.5525 19.5525,23 19,23 Z M9,23 C8.4475,23 8,22.5525 8,22 C8,21.4475 8.4475,21 9,21 C9.5525,21 10,21.4475 10,22 C10,22.5525 9.5525,23 9,23 Z"></path></svg>
                                    </button>
                                </div>
                            </div>                                                       
                            ...
                            <a href="/?add-to-cart=" data-quantity="1" data-product_id="" class="ajax_add_to_cart_ssv main-button add_to_cart_button ajax_add_to_cart" style="display: none;" onclick="alert('ssss');"></a>

                            <div class="SSV-video-popup-wrapper">
                            ...
                            <div class="SSV-video-popup-product">
                                <div class="SSV-video-popup-product-info">
                                    <img src="" alt="Product Image" height="" width="">
                                    <div>
                                        <p></p>
                                        <label></label>
                                ...
                                <div class="SSV-video-popup-product-btns">
                                    <button class="SSV-play-modal-addtocart SSV-video-popup-product-btns-shop" onclick="jQuery('.SSV-product-info-full').css('transform', 'translateY(0)');">Shop Now</button>
                                    <button type="button" class="SSV-play-modal-addtocart SSV-video-popup-product-btns-cart xoo-wsc-cart-trigger" data-action="3">
                                        <label class="SSV-pif-cart-count"></label>
                                        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" color="black" height="26" width="26" xmlns="http://www.w3.org/2000/svg" style="color: black;"><path fill="none" stroke="#000" stroke-width="2" d="M5,5 L22,5 L20,14 L7,14 L4,2 L0,2 M7,14 L8,18 L21,18 M19,23 C18.4475,23 18,22.5525 18,22 C18,21.4475 18.4475,21 19,21 C19.5525,21 20,21.4475 20,22 C20,22.5525 19.5525,23 19,23 Z M9,23 C8.4475,23 8,22.5525 8,22 C8,21.4475 8.4475,21 9,21 C9.5525,21 10,21.4475 10,22 C10,22.5525 9.5525,23 9,23 Z"></path></svg>
                                    </button>
                                </div>
                ...
                if (typeof SSVvideosAll['swilrs']['video'] != 'undefined') {
                    ...
                    SSVvideosAll['swilrs']['video'].forEach(swirl => {
                        ...
                        <div class="SSV-video-title-bottom">
                            <p class="full-t">${swirl['video_title']}</p>
        ...
        function executeNow() {
                ...
                <div id="SSV-short-videos">
                    ...
                    <div class="SSV-play-modal">                
                        <div class="SSV-play-modal-video-container">
                            ...
                            <a href="/?add-to-cart=" data-quantity="1" data-product_id="" class="ajax_add_to_cart_ssv main-button add_to_cart_button ajax_add_to_cart"></a>
            ...
            `);
                ...
                if (typeof jQuery('#swirl-short-videos').data('onpdp') != 'undefined') {
                    urlPass = 'https://api.goswirl.live/index.php/shopify/getmultiple_productvideo?url=' + url;
                }
                ...
                jQuery.ajax({
                    ...
                    success: function (data) {
                        if (typeof data['swilrs']['video'] === 'undefined' && localStorage.getItem('SSVallURL') && typeof jQuery('#swirl-short-videos').data('onpdp') != 'undefined') {
                            if (localStorage.getItem('SSVallURL') && localStorage.getItem('SSVlastPlayed')) {
                                data = JSON.parse(localStorage.getItem('SSVallURL'));
                                jQuery('#SSV-short-videos .swiper').css('display', 'none');
                            }
                        }

                        if (typeof data['swilrs']['video'] != 'undefined') {
                            ...
                            data['swilrs']['video'].forEach(swirl => {
                                let firstFivePlay = '';
                                firstFive++;
                                if (brandData['auto_play'] === '1') {
                                    firstFivePlay = firstFive > 6 ? '' : 'loop autoplay';
                                ...
                                let product_id = '';
                                let product_link = '';
                                let productblock = `<div class="SSV-product-on-carousel"></div>`;
                                if (Object.keys(swirl['product']).length > 0) {
                                    product_id = swirl['product'][0]['product_id'];
                                    product_link = swirl['product'][0]['url'];
                                    let productsBadge = Object.keys(swirl['product']).length > 1 ? `<span style="background: ${brandCustomizations['bk_color_buy_btn']}!important; color: ${brandCustomizations['front_color_buy_btn']}!important;">${Object.keys(swirl['product']).length}</span>` : '';

                                    let strikePrice = parseFloat(swirl['product'][0]['price']) > parseFloat(swirl['product'][0]['discount_price']) ? `${swirl['product'][0]['currencysymbols'] + '' + swirl['product'][0]['discount_price']} <strike>${swirl['product'][0]['currencysymbols'] + '' + swirl['product'][0]['price']}</strike>` : swirl['product'][0]['currencysymbols'] + ' ' + swirl['product'][0]['price'];
                                    productblock = `<div class="SSV-product-on-carousel">                                    
                                        <img src="${swirl['product'][0]['image']}" alt="Product Thumbnail" />                                        
                                        ${productsBadge}
                                        <p>${swirl['product'][0]['title']}</p>
                            ...
                            if (brandCustomizations['pip_mode'] === '0') {
                                ...
                                jQuery('.SSV-play-modal-pip').attr('disabled', 'disabled');
                            }
                            ...
                            jQuery('#SSV-short-videos .swiper-wrapper').empty();
                            jQuery('#SSV-short-videos .swiper').hide();
                        }
                    }
                });
...
function updateSSVModalInfos(player) {
    let PIPvideoData = localStorage.getItem('SSVlastPlayedData') && localStorage.getItem('SSVlastPlayed') ? JSON.parse(localStorage.getItem('SSVlastPlayedData')) : '';
    if (PIPvideoData) {
        productsAll[PIPvideoData['vid']] = PIPvideoData['product'];
    }

    // Buy now and add to cart btn text change
    jQuery('.SSV-play-modal-buynow-on').html(brandCustomizations['buy_btn']);
    jQuery('.SSV-pif-buynow').html(brandCustomizations['buy_btn']);
    jQuery('.SSV-pif-addtocart').html(brandCustomizations['add_to_cart_btn']);
    jQuery('.SSV-video-popup-product-btns-shop').html(brandCustomizations['buy_btn']);
    ...
    jQuery('.SSV-pif-buynow').css('background', brandCustomizations['bk_color_buy_btn']);
    jQuery('.SSV-pif-buynow')[0].style.setProperty('color', brandCustomizations['front_color_buy_btn'], 'important');
    jQuery('.SSV-pif-cart-count').css('background', brandCustomizations['bk_color_buy_btn']);
    jQuery('.SSV-pif-cart-count')[0].style.setProperty('color', brandCustomizations['front_color_buy_btn'], 'important');
    jQuery('.SSV-video-popup-product-btns-shop').css('background', brandCustomizations['bk_color_buy_btn']);
    jQuery('.SSV-video-popup-product-btns-shop')[0].style.setProperty('color', brandCustomizations['front_color_buy_btn'], 'important');

    // background add to cart    
    jQuery('.SSV-pif-addtocart').css('border-color', brandCustomizations['bk_color_add_to_cart_btn']);
    jQuery('.SSV-pif-addtocart')[0].style.setProperty('color', brandCustomizations['front_color_add_to_cart_btn'], 'important');

    // background view cart
    jQuery('.SSV-pif-cart').css('border-color', brandCustomizations['bk_color_add_to_cart_btn']);
    jQuery('.SSV-pif-cart svg')[0].style.setProperty('color', brandCustomizations['front_color_add_to_cart_btn'], 'important');
    ...
    jQuery('.SSV-pif-ratings').hide();
    jQuery('.SSV-pif-ratings-all').css('transform', 'translateY(150%)');
    jQuery('.SSV-pif-qty').hide();

    if (jQuery(window).innerWidth() < 1050) {
        jQuery('.SSV-product-info-full').css('transform', 'translateY(110%)');
    }

    // Qty 1
    jQuery('.pif-qty').val('1');

    // title
    let video = jQuery(player).children('source').attr('src');
    let title = jQuery(`.swiper-wrapper source[src="${video}"]`).length ? jQuery(`.swiper-wrapper source[src="${video}"]`).parent('video').attr('data-title') : PIPvideoData['title'];
    jQuery(player).parent('.SSV-play-modal-video-container').children('.SSV-video-popup-title').html(title);

    // Product if attached
    let vid = jQuery(`.swiper-wrapper source[src="${video}"]`).length ? jQuery(`.swiper-wrapper source[src="${video}"]`).parent('video').attr('data-vid') : PIPvideoData['vid'];
    ...
    if (Object.keys(products).length > 0) {
        ...
        let description = product['desription'].length > 300 ? '<p>' + product['desription'].substr(0, 296) + '... <a class="SSV-P-see-more" style="cursor: pointer;font-weight: normal;;text-decoration: none; color: #2196f3 !important; display:block;">See more</a></p><p style="display: none;">' + product['desription'] + ' <a class="SSV-P-see-less" style="cursor: pointer;font-weight: normal;text-decoration: none; color: #2196f3 !important; display:block;">See less</a></p>' : '<p>' + product['desription'] + '</p>';

        // new pif design
        jQuery('.SSV-pif-top p').html(product['title']);
        jQuery('.SSV-pif-top label').html(strikePrice);
        jQuery('.SSV-pif-top img').attr('src', product['image']);
        jQuery('.SSV-pif-desc section').html(description);

        // on screen
        jQuery('.SSV-video-popup-product-info p').html(product['title']);
        jQuery('.SSV-video-popup-product-info label').html(strikePrice);
        jQuery('.SSV-video-popup-product-info img').attr('src', product['image']);
        ...
        if (prodLink) {
            ...
            jQuery('.SSV-play-modal-addtocart').attr('data-bpid', product['brand_product_id']);

            if (prodLink.search(store) >= 0) {
                jQuery('.SSV-pif-addtocart').show();
                jQuery('.SSV-pif-qty').show();
            } else {
                jQuery('.SSV-pif-addtocart').hide();
            }

            // woo Commerse
            if (storeType == '2' && product['brand_product_id'] == '0') {
                jQuery('.SSV-pif-addtocart').hide();
                jQuery('.SSV-pif-qty').hide();
            }
        } else {
        ...
        if (storeType == '2') {
            if (product['brand_product_id']) {
                var url = `https://stamped.io/api/widget/reviews?productId=${product['brand_product_id']}&minRating&page&storeUrl=${brandCustomizations.store_url}&apiKey=${brandCustomizations.api_key}`
                    ...
                    if (xhr.readyState === 4) {
                        ...
                        if (Object.keys(reviews.data).length > 0) {
                            ...
                            let rappend = Object.keys(reviews.data).length > 2 ? `
                                <p class="SSV-pif-ratings-title">${totalRating} <i class="starssv"></i> (${(Object.keys(reviews.data).length)} reviews)
                                    <a class="SSV-pif-ratings-all-close" onclick="jQuery('.SSV-pif-ratings-all').css('transform', 'translateY(0%)')">See all</a>
                                </p><div class="SSV-pif-ratings-comments">
                            ` : `
                                <p class="SSV-pif-ratings-title">${totalRating} <i class="starssv"></i> (${(Object.keys(reviews.data).length)} reviews)</p><div class="SSV-pif-ratings-comments">
                            `;

                            let cappend = `
                                <div class="SSV-pif-ratings-all-title">
                                    <p>${totalRating} 
                                        ...
                                        <a class="SSV-pif-ratings-all-close" onclick="jQuery('.SSV-pif-ratings-all').css('transform', 'translateY(150%)')">&times;</a>
                                    </p>
                                </div>
                                <div class="SSV-pif-ratings-all-comments">
                            `;
                            ...
                            jQuery('.SSV-pif-ratings').html(rappend);
                            jQuery('.SSV-pif-ratings-all').html(cappend);

                            jQuery('.SSV-pif-ratings').show();
                        } else {
                            jQuery('.SSV-pif-ratings').hide();
                            jQuery('.SSV-pif-ratings-all').css('transform', 'translateY(150%)');
                        }
        ...
        jQuery('.SSV-product-info-full').show();
        if (jQuery(window).innerWidth() >= 1050) {
            jQuery('.SSV-play-modal-video-container').css('overflow', 'visible');
            jQuery('.SSV-play-modal-video-container').css('transform', 'translateX(-50%)');
        } else {
            jQuery('.SSV-play-modal-video-container').css('overflow', 'visible');
            jQuery('.SSV-play-modal-video-container').css('transform', 'translateX(0)');
        }
    } else {
        jQuery('.SSV-play-modal-buynow-on').show();
        jQuery('.SSV-play-modal-buynow-on').attr('data-link', jQuery(`.swiper-wrapper source[src="${video}"]`).length ? jQuery(`.swiper-wrapper source[src="${video}"]`).parent('video').attr('data-productlink') : PIPvideoData['productlink']);

        jQuery('.SSV-product-info-full').hide();
        jQuery('.SSV-play-modal-video-container').css('overflow', 'hidden');
        jQuery('.SSV-play-modal-video-container').css('transform', 'translateX(0)');
    }
    ...
    if (brandCustomizations['pip_mode'] === '1') {
        ...
        if (jQuery(`.swiper-wrapper source[src="${video}"]`).length) {
            let vData = jQuery(`.swiper-wrapper source[src="${video}"]`).parent('video').data();
            vData['product'] = productsAll[vData['vid']];
            localStorage.setItem('SSVlastPlayedData', JSON.stringify(vData));
        } else if (PIPvideoData) {
            localStorage.setItem('SSVlastPlayedData', JSON.stringify(PIPvideoData));
        }
    }
...
function openMultiProductDetail(prodElem) {
    ...
    if (prodLink) {
        ...
        jQuery('.SSV-play-modal-addtocart').attr('data-bpid', jQuery(prodElem).find('p').attr('data-bpid'));
        ...
        if (storeType == '2' && jQuery(prodElem).find('p').attr('data-bpid') == '0') {
            jQuery('.SSV-pmm-add-to-cart').hide();
        }
    } else {
...
function SSVaddToCart(link, btn) {
    if (parseInt(jQuery('.pif-qty').val()) <= 0) {
        jQuery('.SSV-pif-bottom-error-label').fadeIn().delay(2000).fadeOut();
        return;
    }
    if (storeType == '1') {
        // var url = link;    
                        ...
                        jQuery.ajax({
                            ...
                            data: {
                                items: [
                                    {
                                        id: productId,
                                        quantity: parseInt(jQuery('.pif-qty').val())
                                    }
                                ]
                            }
                        }
        ...
        woo_commerce_add_to_cart(jQuery(btn).attr('data-bpid'), link, btn);
    } else { }
}

// Woocommerse Addtocart code
function woo_commerce_add_to_cart(product_id, link, btn) {
    ...
    //     if (!response) {
    //         jQuery('.SSV-pif-bottom-error-label').html('Something went wrong.').fadeIn().delay(2000).fadeOut();
    //         jQuery(btn).html('Add to cart');
    //         return;
    //     }
    ...
    //         jQuery('.SSV-pif-bottom-error-label').html('Stock not available.').fadeIn().delay(2000).fadeOut();
    //         jQuery(btn).html('Add to cart');
    //         return;
    //     }
    ...
    //         let items = (response.fragments['.header .cart-icon']).match(/\d+/g).map(Number);
    //         items = Object.keys(items).length > 0 ? items[0] : 0;
    //         jQuery('.SSV-pif-cart-count').html(items);
    //         jQuery(btn).html('Added');
    //         setTimeout(() => {
    //             jQuery(btn).html('Add to cart');
    //         }, 2000);
    //         // jQuery(btn).attr('data-action', '3');
    ...
    jQuery('.ajax_add_to_cart_ssv').attr('data-quantity', parseInt(jQuery('.pif-qty').val()));
    jQuery('.ajax_add_to_cart_ssv').attr('data-product_id', product_id);
    jQuery('.ajax_add_to_cart_ssv').attr('href', '/?add-to-cart=' + product_id);
    jQuery('.ajax_add_to_cart_ssv').click();
}
...
function SSVsetPopupHight() {
    ...
    currentHeight = window.innerWidth >= 1050 ? (currentHeight - 120) : currentHeight;
...
function updateSSVSwiperNavigation() {
    if (jQuery(window).width() >= 640 && jQuery(".swiper .swiper-slide").length < 6) {
        jQuery('.swiper-button-next').addClass("swiper-button-disabled");
        jQuery('.swiper-button-prev').addClass("swiper-button-disabled");
    } else if (jQuery(window).width() < 640 && jQuery(".swiper .swiper-slide").length < 3) {
        jQuery('.swiper-button-next').addClass("swiper-button-disabled");
        jQuery('.swiper-button-prev').addClass("swiper-button-disabled");
    }
}
...
function SSVchangeQty(action) {
    if (action == 'minus') {
        jQuery('.pif-qty').val(parseInt(jQuery('.pif-qty').val()) > 1 ? (parseInt(jQuery('.pif-qty').val()) - 1) : 1);
    } else if (action == 'plus') {
        jQuery('.pif-qty').val((parseInt(jQuery('.pif-qty').val()) + 1));
    }
}