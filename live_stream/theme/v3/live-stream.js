                        ...
                        if (json['status_code'] == '1') {
                            ...
                            for (var k = 0; k < json['data']['product'].length; k++) {
                                ...
                                if (json['data']['product_count'] != '0') {
                                    ...
                                    $('#dynamic').append('<div class="card-body"><div class="product-img-div"><img src="' + json['data']['product'][k]['product_img_url'] + '" alt="..." class="img-fluid product-img"></div><div class="product-details"><h7 class="card-title">' + json['data']['product'][k]['product_title'] + '</h7><p class="card-text"><span class="price-amt">' + json['data']['currencysymbols'] + ' ' + json['data']['product'][k]['product_sell_price'] + '<span>' + discount_price + '</p></div></div><hr>');

                                    $('#dynamic-img').append('<div class="product-img-div"><img data-toggle="modal" data-target="#productidd_' + json['data']['product'][k]['product_id'] + '" src="' + json['data']['product'][k]['product_img_url'] + '" alt="..." class="img-fluid product-img"></div>');

                                    $('#dynamic-productdetails').append('<div id="productidd_' + json['data']['product'][k]['product_id'] + '" class="productlist-modal modal bottom fade"  role="dialog"><div class="modal-dialog modal-dialog-bottom product_details_modal"><div class="modal-content"><div class="modal-header"><h6 class="modal-title">Product List</h6><button type="button" class="close" data-dismiss="modal">&times;</button></div><div class="modal-body"><div class=""><div class="card-body"><div class="product-img-div"><img src="' + json['data']['product'][k]['product_img_url'] + '" alt="..." class="img-fluid product-img"></div><div class="product-details"><h7 class="card-title">' + json['data']['product'][k]['product_title'] + '</h7><p class="card-text"><span class="price-amt">' + json['data']['currencysymbols'] + ' ' + json['data']['product'][k]['product_sell_price'] + '</span>' + discount_price + '</p></div></div></div></div></div></div></div>');
/* 
                                    $('#web-dynamic-product-listing').append('<div class="media my-3 mr-3"><div class=""><img class="align-self-center mr-3 rounded proimg" src="' + json['data']['product'][k]['product_img_url'] + '"></div><div class="media-body"><h6 class="mt-0" style="word-break: break-all;" title="' + json['data']['product'][k]['product_title'] + '">' + json['data']['product'][k]['product_title'] + '</h6><p><span class="price-amt">' + json['data']['currencysymbols'] + ' ' + json['data']['product'][k]['product_sell_price'] + '</span>' + discount_price + '</p></div></div><hr>'); */

                                    $('#web-dynamic-product-listing').append('<div class="media my-3 mr-3"><div class=""><img class="align-self-center mr-3 rounded proimg" src="' + json['data']['product'][k]['product_img_url'] + '"></div><div class="media-body"><h6 class="mt-0" style="word-break: break-all;" title="'+json['data']['product'][k]['product_title']+'">'+json['data']['product'][k]['product_title']+'</h6><p><span class="price-amt">'+json['data']['currencysymbols']+' '+json['data']['product'][k]['product_sell_price']+'</span>'+discount_price+'</p><div class="product-action-btn"><button type="button" class="btn btn-buy buy-now-btn" onclick="buy_now('+json['data']['product'][k]['product_id']+','+json['data']['designer_id']+')">'+json['data']['btn2_title']+'</button></div></div></div><hr>');  
                                }
                            }
            ...
            if (change.doc.data().flag === '1') {
                if (change.type === "removed") {
                    ...
                    if ((change.doc.data().message).match(regex)) {
                        ...
                        $('<div class="message message-personal ' + fillcolor + '"><div class="mesg-blk" id="message-' + change.doc.id + '"><span class="' + changecolor + '">' + change.doc.data().name + ' : </span>' + string_link + '</div></div>').appendTo($('.mCSB_container')).addClass('new');
                    }
                    else {
                        $('<div class="message message-personal ' + fillcolor + '"><div class="mesg-blk" id="message-' + change.doc.id + '"><span class="' + changecolor + '">' + change.doc.data().name + ' : </span>' + change.doc.data().message + '</div></div>').appendTo($('.mCSB_container')).addClass('new');
                    }
                }
            }
            setTimeout(function () {
