  ...
  if(blueid != ''){
      Swal.fire({
        ...
        if (result.isConfirmed) {
          //firebase entry
          var chat_brand_name = $('#chat_brand_name').val();
          var brand_img = $('#brand_logo').val();
          var user_id = $('#user_id').val();
          var name = $("#user_fname").val();
          var utm_source = $("#utm_source").val();
         ...
         // localStorage.setItem(localStorageKey, true);
          Swal.fire({
            position: "bottom",
            title: "Submitted!",
            text: "Thanks for your test drive request! A "+chat_brand_name+" representative will reach out to you soon.",
            confirmButtonText: "Close",
            //imageUrl: "https://swirl-assets.s3.ap-south-1.amazonaws.com/brand_logo/1716536214_BYD_Logo_White_Background.png",
            imageUrl: brand_img,
            imageWidth: 80,
            imageHeight: 80,
            imageAlt: "logo"
