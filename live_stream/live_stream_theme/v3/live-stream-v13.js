...
function otpcheck_without_sp() {
    ...
    if (name == '') {
        $('.error_msg').html("Täytä nämä kentät.").fadeIn().delay(3000).fadeOut();
        $('#name').focus();
        return false;
    }
    else {
...
function ask_que_submit(b, c) {
    ...
    var msg = document.getElementById("inquiry_text_ask").value;
    if (msg == '') {
        $('.err_user_cpassword').html("Täytä nämä kentät.").fadeIn().delay(3000).fadeOut();
...
function rsvp_submit() {
    ...
    if (name == '') {
        $('.form-validation-error').html("Täytä nämä kentät").fadeIn().delay(3000).fadeOut();
        $('#rsvp-name').focus();
        return false;
    }
    else if (email == '') {
        ...
        $('.error_msg_rsvp').html("Sinun pitää hyväksyä käyttöehdot ja tietosuojaseloste").fadeIn().delay(3000).fadeOut();
        $('#checkbox').focus();
        return false;
    }
    else {
