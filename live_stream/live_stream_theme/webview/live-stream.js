...
function insertMessage() {
  if ($(window).width() > 768) {
    ...
    if ($.trim(msg) == '') {
      //msg.focus();
       setTimeout(function(){
         $('.message-input-mobile').focus();},100);
       return false;
     }
  }
    ...
    { 
      ...
      setInterval(function () {
        $.ajax({
          type: "POST",
          dataType: "json",
          url: base_url + "index.php/StreamController/otmanyproductlist",
