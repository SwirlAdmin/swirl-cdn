          ...
          /*   alert('2'); */
            ...
            for (var k = 0; k < json['data']['product'].length; k++) {
              ...
              if (json['data']['product_count'] != '0') {
                ...
                $('#bottom-showcase-products').append('<div class="swiper-slide"><a href="' + link + '" class="text-decoration-none" target="_blank"><div class="rounded"><img class="rounded mb-2" src="' + json['data']['product'][k]['product_img_url'] + '"> <p class="mb-0 text-dark text-decoration-none">' + json['data']['currencysymbols'] + ' ' + json['data']['product'][k]['product_sell_price'] + '</p></div></a></div>');
