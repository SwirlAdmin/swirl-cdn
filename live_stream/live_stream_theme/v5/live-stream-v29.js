...
var showcase_bar = (productsid != '') ? 120 : 0;
//console.log(showcase_bar);
var end_time = $('#end_time').val();
if ((end_time != '0000-00-00 00:00:00')) {
  var recordingcontrol_size = 34;
}
else{
      ...
      if (change.doc.data().flag === '1') {
        ...
        if (change.type === "removed") {
          ...
          if(isValidUrl(change.doc.data().message) == true )
          {
            ...
            $('<div id="message-' + change.doc.id + '"><div class="' + fillcolor + ' msgcontent-div" style="margin: 5px 0px;width: 100%;"><div class="icon" style="display: table-cell;padding-top: 5px;">'+ brand_logo +'</div><div class="msg-content" style="width: 100%;display: table-cell;vertical-align: top;"><p style="font-weight: bold; margin-bottom: 0px;font-size: 15px;">' + change.doc.data().name + '<span class="time '+brand_time+'">' + time +'</span></p><p>' + string_link + '</p></div></div></div>').appendTo($('.SLS-comments-all')).addClass('new');
          }
          else {
            $('<div id="message-' + change.doc.id + '"><div class="' + fillcolor + ' msgcontent-div" style="margin: 5px 0px;width: 100%;"><div class="icon" style="display: table-cell;padding-top: 5px;">'+ brand_logo +'</div><div class="msg-content" style="width: 100%;display: table-cell;vertical-align: top;"><p style="font-weight: bold; margin-bottom: 0px;font-size: 15px;">' + change.doc.data().name + '<span class="time '+brand_time+'">' + time +'</span></p><p>' + change.doc.data().message + '</p></div></div></div>').appendTo($('.SLS-comments-all')).addClass('new');
          }
        }
      }
      setTimeout(function () {
            ...
            if (json['status_code'] == '1') 
            {
              ...
              if (json['data']['product_count'] != '0') 
              {
                ...
                for (var k = 0; k < json['data']['product'].length; k++) 
                {
                  ...
                  $('.SLS-added-products-dynamic').append('<div class="d-flex align-items-start SLS-product-tile '+ is_star + '" id="pro-detail-pro-' + json['data']['product'][k]['product_id'] + '"><div class="SLS-product-image"><img src="' + json['data']['product'][k]['product_img_url'] + '" alt="Product Image" title="Product Image"></div><div class="SLS-product-content"><p class="m-0 '+ is_product_price_class + '" title="' + json['data']['product'][k]['product_title'] + '">' + json['data']['product'][k]['product_title'] + '</p><label class="m-0 mb-2 '+ is_product_price_display + '">' + json['data']['currencysymbols'] + ' ' + json['data']['product'][k]['product_sell_price'] + '<del>'+discount_price+'</del></label><button type="button" class="SLS-product-buynow-btn" onclick="buynow_firbase(this)" data-protitle="' + json['data']['product'][k]['product_title'] + '" data-proimg="' + json['data']['product'][k]['product_img_url'] + '" data-proid="' + json['data']['product'][k]['product_id'] + '" data-redirection="' + link + '" data-desid="' + brand_id + '">' + json['data']['btn2_title'] + '</button></div><div class="'+ is_star_class +'"><img class="star-animation-listing" src="https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/assets/images/star-animation.gif" class="setproduct"></div></div>');
  
                  $('#bottom-showcase-products').append('<div class="swiper-slide '+ is_star + '"><a href="' + link + '" class="text-decoration-none" target="_blank"><div class="rounded"><img class="star-animation '+ is_star_class +'" src="https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/assets/images/star-animation.gif" class="setproduct"><img class="rounded mb-2" src="' + json['data']['product'][k]['product_img_url'] + '"> <p class="mb-0 text-dark text-decoration-none '+ is_product_price_display + '">' + json['data']['currencysymbols'] + ' ' + json['data']['product'][k]['product_sell_price'] + '</p></div></a></div>'); 
                }
              }else{
                showcase_bar = 0;
