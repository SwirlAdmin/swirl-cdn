            ...
            for (var k = 0; k < json['data']['product'].length; k++) {
              ...
              if (json['data']['product_count'] != '0') {
               ...
               /*  $('#dynamic-img').append('<div class="product-img-div"><img src="' + json['data']['product'][k]['product_img_url'] + '" alt="..." class="img-fluid product-img showcase-products" data-proid="' + json['data']['product'][k]['product_id'] + '" onclick="showcase_products(this)"></div>'); */
                ...
                $('.SLS-added-products-dynamic').append('<div class="d-flex align-items-start SLS-product-tile '+ is_star + '" id="pro-detail-pro-' + json['data']['product'][k]['product_id'] + '"><div class="SLS-product-image"><img src="' + json['data']['product'][k]['product_img_url'] + '" alt="Product Image" title="Product Image"></div><div class="SLS-product-content"><p class="m-0" title="' + json['data']['product'][k]['product_title'] + '">' + json['data']['product'][k]['product_title'] + '</p><label class="m-0 mb-2 d-block">' + json['data']['currencysymbols'] + ' ' + json['data']['product'][k]['product_sell_price'] + '<del>'+discount_price+'</del></label><button type="button" class="SLS-product-buynow-btn" onclick="buynow_firbase(this)" data-protitle="' + json['data']['product'][k]['product_title'] + '" data-proimg="' + json['data']['product'][k]['product_img_url'] + '" data-proid="' + json['data']['product'][k]['product_id'] + '" data-redirection="' + link + '" data-desid="' + brand_id + '">BUY NOW</button></div><div class="'+ is_star_class +'"><img class="star-animation-listing" src="'+base_url+'assets/images/star-animation.gif" class="setproduct"></div></div>');

                $('#bottom-showcase-products').append('<div class="swiper-slide '+ is_star + '"><a href="' + link + '" class="text-decoration-none" target="_blank"><div class="rounded"><img class="star-animation '+ is_star_class +'" src="'+base_url+'assets/images/star-animation.gif" class="setproduct"><img class="rounded mb-2" src="' + json['data']['product'][k]['product_img_url'] + '"> <p class="mb-0 text-dark text-decoration-none">' + json['data']['currencysymbols'] + ' ' + json['data']['product'][k]['product_sell_price'] + '</p></div></a></div>');
