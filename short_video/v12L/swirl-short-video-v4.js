...
let ssv_baseURL = ssv_mode === 'Live' ? 'https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/short_video/v12L/swirl-style-v3.min.css' : '';
let ssv_responseData = [];
let ssv_productIds = [];
let ssv_apiURL = 'https://bigleap.live/index.php/ShortVideo/videolistingV4'; // bigleap.live  ,  api.goswirl.live
            ...
            if (Object.keys(video.product).length > 1) {
                                ...
                                <div class="product-detail-pb-ssv">
                                    <div class="product-image-pb-ssv">
                                        <img alt="Product Image"
                                            src="${product.image.includes('imagekit') ? imagekitDynamicssv(product.image, 500) : product.image}" />
                                    </div>
                ...
                productList = `
                    <div class="video-modal-product-block-list-ssv">
                        <div class="video-modal-product-tabs-ssv">
                            <div class="vmp-tab-ssv vmp-tab-init open" onclick="changeTabssv(this, 0);">Products</div>
                            <div class="vmp-tab-ssv" onclick="changeTabssv(this, 1);" style="${ssv_brandCustomizations.ask_question == '0' ? 'display: none !important;' : ''}">Ask question</div>
                        </div>   
                        <div class="vmp-tab-content-ssv vmp-tab-con-init scroll-ssv">
                            ${pl}
                        </div>       
                        <div class="vmp-tab-content-ssv" style="display: none;">
                            <div class="ask-question-tab-ssv">
                                <form onsubmit="return askQuestionssv(this, ${video.designer_id}, ${video.video_id}, true);">
                                    <textarea name="question" rows="3" placeholder="Enter query here" required></textarea>                           
                                    <button class="" style="background: ${ssv_brandCustomizations.bk_color_buy_btn} !important; color: ${ssv_brandCustomizations.front_color_buy_btn} !important;">Send</button>                           
                                </form>                           
                            </div>
                        </div>
                    </div>
                ...
                productList = `
                    <div class="video-modal-product-block-product-ssv">
                        ...
                        <div class="vmp-tab-content-ssv vmp-tab-con-init">
                            ...
                            <div class="product-middle-pb-ssv">                            
                                <div class="product-detail-pb-ssv">
                                    <div class="product-image-pb-ssv">
                                        <img alt="Product Image"
                                            src="${video.product[0].image.includes('imagekit') ? imagekitDynamicssv(video.product[0].image, 500) : video.product[0].image}" />
                                    </div>
                                    <div class="product-detail-block-pb-ssv">
                                        <p>${video.product[0].title}</p>
            ...
            <div class="swiper-slide ${typeof video.product[0] == 'undefined' ? 'no-product-ssv' : ''} ${buynowBtn ? 'video-redirect-on-ssv' : ''}">
                <div class="video-modal-video-container-ssv">
                    ...
                    <div class="video-modal-actions-ssv">  
                        <button class="video-modal-fs-products-ssv" onclick="openCloseFSProductssv(this);" title="Products" style="${typeof video.product[0] == 'undefined' ? 'display: none !important;' : ''}">
                            <img src="https://apigoswirl.com/short_video/assets/images/landscape/shopping-cart-white.webp"
                                alt="Cart icon">   
                            <span style="${typeof video.product[0] == 'undefined' ? 'display: none !important;' : ''} background: ${ssv_brandCustomizations.bk_color_buy_btn} !important; color: ${ssv_brandCustomizations.front_color_buy_btn} !important;">${Object.keys(video.product).length}</span>                                              
                        </button>
                        <button class="video-modal-download-ssv" title="Download Video" onclick="downloadVideossv(this, '${video.video_url}', ${video.video_id}, ${video.designer_id})" style="${ssv_brandCustomizations.download_icon == '0' ? 'display: none !important;' : ''}">
                            <img src="https://apigoswirl.com/short_video/assets/images/landscape/download.webp"
                                alt="Download icon">                                   
                        </button>                                                                   
                        ...
                        <button class="video-modal-fullscreen-ssv" title="Full Screen" onclick="fullScreenVideossv(this.dataset.swtch);" data-swtch="1">
                    ...
                    <div class="video-modal-askque-modal-ssv">
                        ...
                        <div class="askque-modal-form-ssv askque-modal-form2-ssv">
                            <form onsubmit="return registerUserssv(this, ${video.video_id});">
                                ...
                                <div class="askque-modal-form-phone-ssv">
                                    ...
                                    <input name="phone" type="text" onfocus="ssv_swiper_modal.disable();" onfocusout="ssv_swiper_modal.enable();" style="margin: 0px !important;" placeholder="Enter your phone" pattern=".{10,10}" onkeypress='return event.charCode >= 48 && event.charCode <= 57' title="Minimum 10 and maximim 10 digits." required />                                
                                </div> 
                            ...
                            <div class="urp-form-ssv">
                                <form onsubmit="return userRegistrationssv(this, ${video.video_id});">
                                    ...
                                    <div class="urp-form-phone-ssv">
                                        ...
                                        <input name="phone" type="text" style="margin: 0px !important;" placeholder="Enter your phone" pattern=".{10,10}" onkeypress='return event.charCode >= 48 && event.charCode <= 57' title="Minimum 10 and maximim 10 digits." required />                                
                                    </div> 
    ...
    jQuery('body').append(`
        <div class="swirl-short-videos">
            <style>
                ...
                .vmp-tab-ssv.open {
                    color: ${ssv_brandCustomizations.front_color_buy_btn};
            ...
            <div class="video-pip-ssv" onclick="fullscreenpipssv(event);">
                ...
                <button class="video-pip-volume-ssv pfs-ex-ssv" title="Mute/Unmute" onclick="volumepipssv(this)" style="background: rgb(0, 0, 0, .6) !important;">
                    <img class="pfs-ex-ssv" src="https://apigoswirl.com/short_video/assets/images/landscape/unmuteunmute.webp"
                        alt="Volume icon">                    
                </button>
                <button class="video-pip-close-ssv pfs-ex-ssv" title="Close" onclick="closepipssv();" style="background: rgb(0, 0, 0, .6) !important;">
                    <img class="pfs-ex-ssv" src="https://apigoswirl.com/short_video/assets/images/landscape/close-line.webp"
                        alt="Close icon">
                </button>
...
function playssv(slideno) {
    ...
    // Full screen reset
    jQuery('.swiper-ssv-m .swiper-slide').removeClass('rotateOn-ssv');
...
function openCloseFSProductssv(btn) {
    if (jQuery(btn).closest('.video-modal-video-container-ssv').find('.video-modal-product-block-ssv').css('transform') == 'matrix(1, 0, 0, 1, 0, 0)') {
...
function fullScreenVideossv(swtch) {
    if (getMobileOperatingSystemssv() == 'iOS') {
        let player = jQuery('.swiper-slide-active .video-modal-video-container-ssv video')[0];

        if (player.webkitEnterFullscreen) {
            player.webkitEnterFullscreen(); // Enter fullscreen for iOS
            return;
        }
    } else {
        // if (swtch == '0') {
        ...
        //     jQuery('.swiper-slide-active .video-modal-fullscreen-ssv img').attr('src', 'https://apigoswirl.com/short_video/assets/images/landscape/fullscreen-line.webp');
        //     jQuery('.swiper-slide-active .video-modal-fullscreen-ssv').attr('data-swtch', '1');
        // } else {
        //     jQuery('.swiper-ssv-m .swiper-slide').addClass('rotateOn-ssv');

        //     document.body.requestFullscreen();
        //     screen.orientation.lock("landscape");

        //     jQuery('.swiper-slide-active .video-modal-fullscreen-ssv img').attr('src', 'https://apigoswirl.com/short_video/assets/images/landscape/fullscreen-line.webp');
        //     jQuery('.swiper-slide-active .video-modal-fullscreen-ssv').attr('data-swtch', '0');
        // }
...
function changeTabssv(btn, n) {
    jQuery(btn).parents('.video-modal-product-block-ssv').find('.vmp-tab-content-ssv').hide();
    jQuery(btn).parents('.video-modal-product-block-ssv').find('.vmp-tab-content-ssv').eq(n).show();
    jQuery(btn).parents('.video-modal-product-block-ssv').find('.vmp-tab-ssv').removeClass('open');
    jQuery(btn).addClass('open');
}

function askQuestionssv(form, designerId, videoId, open = false) {
    ...
    if (ssv_userData) {
        ...
        jQuery.ajax({
            ...
            success: function (response) {
                if (response.success == true) {
                    ...
                    jQuery(form).closest('.video-modal-video-container-ssv').find('.ask-question-tab-ssv textarea').val('');
                } else {
                    videoAlertssv('Failed! Try again.', 2000);
                }
            },
        ...
        if (open) openAskquessv(form), jQuery('.askque-modal-form1-ssv textarea').val(question);
...
function closeAllpopupsssv() {
    ...
    // Reset tab
    jQuery('.vmp-tab-content-ssv').hide();
    jQuery('.vmp-tab-ssv').removeClass('open');
    jQuery('.vmp-tab-con-init').show();
    jQuery('.vmp-tab-init').addClass('open');
...
function handleOrientationChange() {
    ...
    if (orientation === 0 || orientation === 180) {
        ...
        // alert('Portrait');
        // fullScreenVideossv(0);
        jQuery('.swiper-ssv-m .swiper-slide').removeClass('rotateOn-ssv');
    } else if (orientation === 90 || orientation === -90) {
        // Landscape orientation
        // alert('Landscape');
        // fullScreenVideossv(1);
        jQuery('.swiper-ssv-m .swiper-slide').addClass('rotateOn-ssv');
    }
}
...
if (window.addEventListener) {
    ...
    window.attachEvent('orientationchange', handleOrientationChange);
}
