//v10.12 - New design with new swiping up-down [Reels] feature + PDP PIP
...
let ssv_storeType = '0';
let ssv_storeCode = '';
let ssv_baseURL = ssv_mode === 'Live' ? 'https://apigoswirl.com/short_video/v10/single_page_pip/style.min.css' : '';
...
function executessv() {
    ...
    if (document.querySelector('#swirl-short-videos') != null || localStorage.getItem('_ssv_pip')) {
        ...
        // Inits
        ssv_store = window.location.origin;
        ...
        // testing
        // currentURL = 'https://olliecraft.com/products/little-brown-teddy';
