    ...
    videos.forEach(video => {
        ...
        cSlides += `
            <div class="swiper-slide" onclick="openVideoModalssv13(${i}, ${no});">
                <video style="aspect-ratio: ${video.is_landscape == '0' ? '16 / 9' : '9 / 16'};" data-src="${video.cover_video}" data-srcf="${video.server_url}" data-id="${video.video_id}" class="carousel-video-ssv13 ${video.is_landscape == '0' ? 'JS-cvideo-L-ssv13-off' : 'JS-cvideo-P-ssv13-off'} ${videoConflictClass}" onplay="this.closest('.swiper-slide').querySelector('.carousel-video-play-ssv13').style.display='none';"
