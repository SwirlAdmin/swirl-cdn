...
function generatessv13(videos, target, no) {
    ...
    if (!ssv13_pipMode && carouselLoad) {
        ssv13_swiper[no] = new Swiper(`.swiper-ssv13-c${no}`, {
            slidesPerView: ssv13_brandCustomizations.pdpStoryView == '1' ? Object.keys(videos).length : 2,
            direction: 'horizontal',
            spaceBetween: 15,
            centeredSlidesBounds: true,
            centerInsufficientSlides: true,
            ...
            breakpoints: {
                ...
                768: {
                    slidesPerView: ssv13_brandCustomizations.pdpStoryView == '1' ? Object.keys(videos).length : 3,
                    centeredSlides: false,
                },
                1080: {
                    slidesPerView: ssv13_brandCustomizations.pdpStoryView == '1' ? Object.keys(videos).length : 4,
                    centeredSlides: false,
                    cssMode: false
                },
                1366: {
                    slidesPerView: ssv13_brandCustomizations.pdpStoryView == '1' ? Object.keys(videos).length : 5,
                    centeredSlides: false,
                    cssMode: false
                }
            },
