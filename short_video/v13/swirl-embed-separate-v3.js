...
(() => {
    ...
    jqTag.href = !window.location.href.includes('short-videos-carousel/v13') ? 'https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/short_video/v13/style-v3.min.css' : 'style.css';
