...
(() => {
    ...
    jqTag.href = window.location.href.includes('short-videos-carousel/v13') ?
        'style.css' :
        document.querySelector('script[src="https://livevideoshopping.in/swirl-embed/short-videos-carousel/v13/swirl-embed.js"]') ?
            'https://livevideoshopping.in/swirl-embed/short-videos-carousel/v13/style.css' :
...
function generatessv13(videos, target, no) {
    // testing
    ssv13_brandCustomizations.chat_bot = '1';
