...
(() => {
    ...
    jqTag.href = 'https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/short_video/v13/style-v6.min.css';
...
function generatessv13(videos, target, no) {
    ...
    ssv13_brandCustomizations.pdpStoryView = typeof target.dataset.story != 'undefined' ? target.dataset.story : '0';
    ...
    videos.forEach(video => {
        ...
        cProduct = ssv13_brandCustomizations.pdpStoryView == '1' ? '' : cProduct;
        let cTitle = ssv13_brandCustomizations.product_blog_img == '1' && cProduct ? `` : `
            <p class="video-title-ssv13" title="${video.video_title}" style="${ssv13_brandCustomizations.video_title == '1' ? '' : 'display: none;'}">
                ${ssv13_brandCustomizations.pdpStoryView == '1' ? video.video_title?.trim().split(/\s+/).slice(0, 2).join(' ') : video.video_title}
            </p>`;
        cSlides += `
        ...
        let bottomShareBtn = ssv13_brandCustomizations.brand_id == '236633622' && window.innerWidth <= 768 ? `
        ...
        mSlides += `
            <div class="swiper-slide swiper-slide-m">
                <div class="video-modal-sl-video-container-ssv ${!Object.keys(video.product).length ? 'no-products-slide-ssv13' : ''}">
                    <video id="ssv13-video-m-${video.video_id}" data-src="${video.server_url}" data-products="${Object.keys(video.product).length}" data-id="${video.video_id}" class="video-modal-sl-video-ssv13 ${video.is_landscape == '0' ? 'JS-mvideo-L-ssv13' : 'JS-mvideo-P-ssv13'} ${videoConflictClass}"
                    ...
                    <div class="video-modal-sl-top-controls-ssv13">
                        ...
                        <svg class="video-modal-sl-video-control-ssv13 video-modal-sl-vc-toggle-ssv13" style="${ssv13_brandCustomizations.brand_id == '236633622' ? 'display: none !important;' : ''}"
                        ...
                        <svg style="${ssv13_brandCustomizations.pip_mode == '1' ? '' : 'display: none !important;'} ${ssv13_brandCustomizations.brand_id == '236633622' ? 'display: inline-block !important;' : ''}" class="video-modal-sl-video-control-ssv13 video-modal-sl-vc-pip-ssv13" onclick="openPIPssv13();"
                    ...
                    <div class="video-modal-share-popup-ssv13">
                        ...
                        <p class="video-modal-sp-pip-ssv13" onclick="openPIPssv13();" style="${ssv13_brandCustomizations.pip_mode == '1' ? '' : 'display: none !important;'} ${ssv13_brandCustomizations.brand_id == '236633622' ? 'display: none !important;' : ''}">
    ...
    let storyViewCSS = ssv13_brandCustomizations.pdpStoryView == '1' ? `
        <style>
            ...
            .carousel-video-story-ring-ssv13 {
                ...
                ${ssv13_brandCustomizations.brand_id == '236633622' ? 'display: none !important;' : ''}
                position: absolute;
                top: 0;
                left: 0;
                width: 100%;
            ...
            .carousel-video-ssv13 {
                ...
                border-radius: 50%; 
                padding: 8px;
                ${ssv13_brandCustomizations.brand_id == '236633622' ? 'padding: 0px !important;' : ''}             
            }
    ...
    `;
    let chatBotCSS = ssv13_brandCustomizations.chat_bot == '1' ? `
    ...
    let areovedaCSS = ssv13_brandCustomizations.brand_id == '236633622' ? `
        .sidecart {
    ...
    if (!ssv13_pipMode && carouselLoad) {
        ssv13_swiper[no] = new Swiper(`.swiper-ssv13-c${no}`, {
            slidesPerView: ssv13_brandCustomizations.pdpStoryView == '1' ? 5 : 2,
            direction: 'horizontal',
            spaceBetween: ssv13_brandCustomizations.pdpStoryView == '1' ? 8 : 15,
            centeredSlidesBounds: true,
            centerInsufficientSlides: true,
            // centeredSlides: true,
            cssMode: true,
            breakpoints: {
                ...
                768: {
                    slidesPerView: ssv13_brandCustomizations.pdpStoryView == '1' ? 5 : 3,
                    centeredSlides: false,
                },
                1080: {
                    slidesPerView: ssv13_brandCustomizations.pdpStoryView == '1' ? 5 : 4,
                    centeredSlides: false,
                    cssMode: false
                },
                1366: {
                    slidesPerView: ssv13_brandCustomizations.pdpStoryView == '1' ? 5 : 5,
                    centeredSlides: false,
                    cssMode: false
                }
            },
            ...
            on: {
                init: function () {
                    if (ssv13_brandCustomizations.auto_play == '1') {
                        ...
                        pff = ssv13_brandCustomizations.pdpStoryView == '1' ? Object.keys(videos).length : pff;
    ...
    ssv13_swiper_modal[no] = new Swiper(`.swiper-ssv13-m${no}`, {
        ...
        on: {
            init: function () {
                ...
                if (ssv13_brandCustomizations.pip_mode == '1' && ssv13_brandCustomizations.brand_id == '236633622' && ssv13_brandCustomizations.pdpStoryView == '1') {
                    ssv13_globalMute = true;
                    let pipData = JSON.stringify({
                        src: videos[0].server_url,
                        poster: videos[0].cover_image
            ...
            slideNextTransitionEnd: function () {
                if (window.innerWidth > 768) {
                    ...
                    if (ssv13_brandCustomizations.chat_bot == '1') document.querySelector(`.swirl-short-videos-m-ssv13-${no} .AI-chatbox-header-back-ssv13`).dispatchEvent(new Event('click'));
                }
            },
...
function openAIChatssv13() {
    if (event.target.classList.contains('AI-chatbox-header-back-ssv13')) return;

    event.target.closest('.AI-chatbox-ssv13').classList.add('opened-ssv13');

    document.querySelector(`.swirl-short-videos-m-ssv13-${ssv13_currentModal} .video-modal-fade-white-R-ssv13`).style.display = 'block';
    document.querySelector(`.swirl-short-videos-m-ssv13-${ssv13_currentModal} .AI-chatbox-ssv13`).style.transform = 'translateY(0%)';
}

function closeAIChatssv13() {
    event.target.closest('.AI-chatbox-ssv13').classList.remove('opened-ssv13');

    document.querySelector(`.swirl-short-videos-m-ssv13-${ssv13_currentModal} .AI-chatbox-ssv13`).style.transform = 'translateY(calc(100% - 40px))';
...
function sendAIChatssv13() {
    ...
    if (ssv13_userData) {
        ...
        // Popup height for desktop
        if (document.querySelectorAll('.AI-chatbox-chat-card-ssv13.card-R').length && window.innerWidth > 768) {
            document.querySelector(`.swirl-short-videos-m-ssv13-${ssv13_currentModal} .AI-chatbox-ssv13`).style.height = '60%';
        }
    } else {
