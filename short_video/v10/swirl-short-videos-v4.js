...
let ssv_storeType = '0';
let ssv_storeCode = '';
let ssv_baseURL = ssv_mode === 'Live' ? 'https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/short_video/v10/swirl-short-videos-v5.min.css' : 'https://goswirl.shop/swirl-embed/short-videos-carousel/v10/style.css';
        ...
        modalSlides += `
            <div class="swiper-slide">
                <div class="video-modal-video-container-ssv">
                    <video loop playsinline="" preload="metadata" data-setup="{}" onplay="jQuery(this).next().hide()"
