...
function addtocartssv(videoId, productId, skuCode, btn) {
    ...
    if (ssv_storeType == '1') {  // Shopify        
        ...
        jQuery.ajax({
            ...
            data: JSON.stringify({
                ...
                query: `mutation { addProductsToCart( cartId: ${localStorage.getItem('cartID')} cartItems: [ { quantity: ${quantity}  sku: ${skuCode} } ] ) { cart { total_quantity items { id product { name sku } quantity } } user_errors { code message } }}`,
                variables: {
