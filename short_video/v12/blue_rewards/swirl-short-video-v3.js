//v12M - New design with new swiping up-down + Multiple Product + No Product + Multiple Page + PDP PIP (v10 Upgrade) [Reels] feature
...
let ssv_baseURL = ssv_mode === 'Live' ? 'https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/short_video/v12/blue_rewards/style-v2.min.css' : '';
let ssv_responseData = [];
let ssv_productIds = [];
let ssv_apiURL = 'https://api.goswirl.live/index.php/ShortVideo/videolistingV6'; // bigleap.live  ,  api.goswirl.live
        ...
        if (!ssv_pip && !ssv_pdppipHideOnscreen) {
            ...
            onpageSlides += `
                <div class="swiper-slide ms-${video.video_id}" onclick="playssv(${i})">
                    <h4 class="video-c-title-ssv">${video.video_title}</h4>
        ...
        if (typeof video.product[0] != 'undefined') {
            if (Object.keys(video.product).length > 1) {
                ...
                video.product.forEach(product => {
                    ...
                    let buynowHref = `href="${product.url}"`;
                    let buynowAct = '';
                    if (video.designer_id == '236633816') buynowAct = `openCustomePopupssv(this, '${product.product_id}', '${product.title}', '${product.image}', '${product.url}', '${video.designer_id}', '${video.video_id}');`, buynowHref = '';

                    let cta = ssv_brandCustomizations.cta_on_tile == '1' ? `
                        <div class="ontile-cta-ssv">
                            ${moredetails}
                            <a class="ontile-buynow-ssv" ${buynowHref} onclick="${buynowAct} CTAClicksssv(${product.product_id}, '${product.sku_code}', '${product.title}', '${product.image}', '${product.url}', ${video.designer_id}, ${video.video_id}, '1');" style="background: ${ssv_brandCustomizations.bk_color_buy_btn} !important; color: ${ssv_brandCustomizations.front_color_buy_btn} !important; ${ssv_brandCustomizations.buy_now == '0' ? 'display: none !important;' : ''} ${ssv_brandCustomizations.add_to_cart == '0' ? 'width: 100% !important;' : ''}">
                            ...
                            <div class="video-modal-product-tile-ssv frommoredetail" onclick="openListProductssv(event, this, ${pi});">
                                <div class="product-info-pt-ssv" style="${ssv_brandCustomizations.product_tile_cta_btn == '0' || ssv_brandCustomizations.cta_on_tile == '1' ? 'width: 100% !important;' : ''}">
                                    ...
                                    <div class="product-detail-pt-ssv" style="${ssv_brandCustomizations.mobile_product_tile_img == '1' ? 'width: calc(100% - 75px) !important;' : ''}">
                                        <p>${product.title}</p>
                                        ${desc}
                                        <label style="${ssv_brandCustomizations.product_price_status == '0' ? 'display: none !important;' : ''} color:${ssv_brandCustomizations.dis_fk_color} !important;">${product.currencysymbols} ${formatCurrencyssv(product.discount_price)} <strike style="${parseFloat(product.price) > parseFloat(product.discount_price) ? '' : 'display: none;'} color:${ssv_brandCustomizations.mrp_fk_color} !important;">${product.currencysymbols} ${formatCurrencyssv(product.price)}</strike>
                    ...
                    pb += `
                        <div class="video-modal-product-block-product-ssv video-modal-product-block-product-multi-ssv" style="transform: translateX(110%);">
                            ...
                            <div class="product-bottom-pb-ssv">
                                ...
                                <a ${buynowHref} onclick="${buynowAct} CTAClicksssv(${product.product_id}, '${product.sku_code}', '${product.title}', '${product.image}', '${product.url}', ${video.designer_id}, ${video.video_id}, '1');">
                ...
                let buynowHref = `href="${video.product[0].url}"`;
                let buynowAct = '';
                if (video.designer_id == '236633816') buynowAct = `openCustomePopupssv(this, '${video.product[0].product_id}', '${video.product[0].title}', '${video.product[0].image}', '${video.product[0].url}', '${video.designer_id}', '${video.video_id}');`, buynowHref = '';

                let cta = ssv_brandCustomizations.cta_on_tile == '1' ? `
                    <div class="ontile-cta-ssv">
                        ${moredetails}
                        <a class="ontile-buynow-ssv" ${buynowHref} onclick="${buynowAct} CTAClicksssv(${video.product[0].product_id}, '${video.product[0].sku_code}', '${video.product[0].title}', '${video.product[0].image}', '${video.product[0].url}', ${video.designer_id}, ${video.video_id}, '1');" style="background: ${ssv_brandCustomizations.bk_color_buy_btn} !important; color: ${ssv_brandCustomizations.front_color_buy_btn} !important; ${ssv_brandCustomizations.buy_now == '0' ? 'display: none !important;' : ''} ${ssv_brandCustomizations.add_to_cart == '0' ? 'width: 100% !important;' : ''}">
                            ${video.cta_customization ? video.cta_customization : ssv_brandCustomizations.buy_btn}
                        </a>
                    </div>
                ` : '';
                    ...
                    <div class="video-modal-product-tile-ssv frommoredetail" onclick="openProductssv(event, this);">
                        <div class="product-info-pt-ssv" style="${ssv_brandCustomizations.product_tile_cta_btn == '0' || ssv_brandCustomizations.cta_on_tile == '1' ? 'width: 100% !important;' : ''}">
                            ...
                            <div class="product-detail-pt-ssv" style="${ssv_brandCustomizations.mobile_product_tile_img == '1' ? 'width: calc(100% - 75px) !important;' : ''}">
                                ...
                                ${desc}
                                <label style="${ssv_brandCustomizations.product_price_status == '0' ? 'display: none !important;' : ''} color:${ssv_brandCustomizations.dis_fk_color} !important;">${video.product[0].currencysymbols} ${formatCurrencyssv(video.product[0].discount_price)} <strike style="${parseFloat(video.product[0].price) > parseFloat(video.product[0].discount_price) ? '' : 'display: none;'} color:${ssv_brandCustomizations.mrp_fk_color} !important;">${video.product[0].currencysymbols} ${formatCurrencyssv(video.product[0].price)}</strike>
                ...
                let ptClick = ssv_brandCustomizations.buy_now == '1' ? `onclick="window.location='${video.product[0].url}'; CTAClicksssv(${video.product[0].product_id}, '${video.product[0].sku_code}', '${video.product[0].title}', '${video.product[0].image}', '${video.product[0].url}', ${video.designer_id}, ${video.video_id}, '1');"` : '';
                productList = `
                    <div class="video-modal-product-block-product-ssv">
                        ...
                        <div class="product-bottom-pb-ssv">
                            ...
                            <a ${buynowHref} onclick="${buynowAct} CTAClicksssv(${video.product[0].product_id}, '${video.product[0].sku_code}', '${video.product[0].title}', '${video.product[0].image}', '${video.product[0].url}', ${video.designer_id}, ${video.video_id}, '1');">
                                <button class="product-buynow-pb-ssv" style="background: ${ssv_brandCustomizations.bk_color_buy_btn} !important; color: ${ssv_brandCustomizations.front_color_buy_btn} !important; ${ssv_brandCustomizations.buy_now == '0' ? 'display: none !important;' : ''} ${ssv_brandCustomizations.view_cart == '0' ? 'width: calc(50% - 5px) !important;' : ''} ${ssv_brandCustomizations.add_to_cart == '0' ? 'width: 100% !important; margin: 0 !important' : ''}">${video.cta_customization ? video.cta_customization : ssv_brandCustomizations.buy_btn}</button>
                            </a>
                            <a href="${window.location.origin}/${ssv_brandCustomizations.cust_cart_redirection_link}">
                            <button class="product-cart-pb-ssv" style="background: none !important; border: 2px solid ${ssv_brandCustomizations.front_color_add_to_cart_btn} !important; color: ${ssv_brandCustomizations.front_color_add_to_cart_btn} !important; ${ssv_brandCustomizations.add_to_cart == '0' || ssv_brandCustomizations.view_cart == '0' ? 'display: none !important;' : ''}">
        ...
        modalSlides += `
            <div class="swiper-slide ${typeof video.product[0] == 'undefined' ? 'no-product-ssv' : ''} ${buynowBtn ? 'video-redirect-on-ssv' : ''}">
                <div class="video-modal-video-container-ssv">
                    ...
                    <button class="video-modal-muteunmute-ssv" title="Mute/Unmute" onclick="volumessv(this)" style="background: rgb(0, 0, 0, .6) !important;">
                        <img src="https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/assets/images/goswirl-webp/volume-up-fill.webp"
                            alt="Volume icon">
                        <p>Mute</p>
                    </button>                                             
                    <div class="video-modal-actions-ssv" style="display: none !important;">                                           
                    ...
                    <div class="video-modal-book-test-ssv">
                        <p class="video-modal-bt-title-ssv">Book a test drive?</p>
                        <p class="video-modal-bt-desc-ssv">Do you wish to book a test drive of BYD ?</p>
                        <button class="video-modal-bt-yes-ssv" style="background: ${ssv_brandCustomizations.bk_color_buy_btn} !important; color: ${ssv_brandCustomizations.front_color_buy_btn} !important;" onclick="customePopupSubmitssv(this);">Confirm</button>
                        <button class="video-modal-bt-no-ssv" style="background: none !important; border: 0px solid ${ssv_brandCustomizations.front_color_add_to_cart_btn} !important; color: ${ssv_brandCustomizations.front_color_add_to_cart_btn} !important;" onclick="closeCustomePopupssv(this);">Cancel</button>
                    </div>

                    <div class="video-modal-book-test-success-ssv">                        
                        <img class="video-modal-bts-logo-ssv" src="https://swirl-assets.s3.ap-south-1.amazonaws.com/brand_logo/blue_reward_squircle.png" alt="BYD logo" title="BYD logo" >
                        <p class="video-modal-bts-title-ssv">Submitted!</p>
                        <p class="video-modal-bts-desc-ssv">Thanks for your test drive request! A BYD representative will reach out to you soon.</p>
                        <button class="video-modal-bts-close-ssv" style="background: ${ssv_brandCustomizations.bk_color_buy_btn} !important; color: ${ssv_brandCustomizations.front_color_buy_btn} !important;" onclick="closeCustomePopupSuccessssv(this);">Close</button>                        
                    </div>
    ...
    jQuery('body').append(`
        <div class="swirl-short-videos">
            <style>
                ...
                .swiper-ssv-c .swiper-wrapper {
                    flex-direction: column !important;
                    align-items: center !important;
                }

                .swiper-ssv-c .swiper-button-next-ssv, .swiper-ssv-c .swiper-button-prev-ssv {
                    display: none !important;
                }

                .swiper-ssv-c .swiper-slide {
                    width: 100% !important;  
                    overflow: visible;     
                    margin-top: 50px;                            
                }
...
function playWithPromisessv(player) {
    ...
    jQuery(player).parent('.video-modal-video-container-ssv').find('.video-modal-muteunmute-ssv img').attr('src', src);
    jQuery(player).parent('.video-modal-video-container-ssv').find('.video-modal-muteunmute-ssv p').html(ssv_globalMute ? 'Mute' : 'Unmute');
...
let tbookData = [];
function openCustomePopupssv(btn, pId, pTitle, pImage, pUrl, dId, vId) {
    jQuery(btn).closest('.video-modal-video-container-ssv').find('.video-modal-book-test-ssv .video-modal-bt-desc-ssv').html(`Do you wish to book a test drive of ${pTitle} ?`)
    jQuery(btn).closest('.video-modal-video-container-ssv').find('.video-modal-book-test-ssv').css('transform', 'translateY(0%)');
    setTimeout(() => {
        jQuery('.video-modal-fade-ssv').show();
    }, 300);
...
function closeCustomePopupssv(btn) {
    jQuery(btn).closest('.video-modal-video-container-ssv').find('.video-modal-book-test-ssv').css('transform', 'translateY(110%)');
    setTimeout(() => {
        jQuery('.video-modal-fade-ssv').hide();
    }, 300);
}

function customePopupSubmitssv(btn) {
    const urlSearchParams = new URLSearchParams(window.location.search);
    const params = Object.fromEntries(urlSearchParams.entries());
    if (typeof params['blue_id'] != 'undefined' && typeof params['username'] != 'undefined' && typeof params['utm_source'] != 'undefined') {
        tbookData['blue_id'] = params['blue_id'];
        tbookData['name'] = params['username'];
        tbookData['utm'] = params['utm_source'];
        tbookData['created_date'] = new Date().getTime();

        if (typeof tbookData.video_id != 'undefined') {
            ssv_fsdb.collection("short_videos_blue_rewards").doc(`${tbookData.video_id}`).collection('buyNow').add(tbookData).then(function () {
                // console.log('SWIRL CTA Track Success!');
            }).catch((error) => {
    ...
    jQuery(btn).closest('.video-modal-video-container-ssv').find('.video-modal-book-test-ssv').css('transform', 'translateY(110%)');
    setTimeout(() => {
        jQuery(btn).closest('.video-modal-video-container-ssv').find('.video-modal-book-test-success-ssv').css('transform', 'translateY(0%)');
    }, 300);
}

function closeCustomePopupSuccessssv(btn) {
    jQuery(btn).closest('.video-modal-video-container-ssv').find('.video-modal-book-test-success-ssv').css('transform', 'translateY(110%)');
    setTimeout(() => {
        jQuery('.video-modal-fade-ssv').hide();
    }, 300);
}
...
function closeAllpopupsssv() {
    ...
    // Custom popup / Book test drive
    jQuery('.video-modal-book-test-ssv').css('transform', 'translateY(110%)');
    jQuery('.video-modal-book-test-success-ssv').css('transform', 'translateY(110%)');
}
...
function closeAnyPopupssv() {
    ...
    if (jQuery('.swiper-slide-active .video-modal-book-test-ssv').css('transform') == 'matrix(1, 0, 0, 1, 0, 0)') {
        jQuery('.swiper-slide-active .video-modal-book-test-ssv .video-modal-bt-no-ssv').click();
    }

    if (jQuery('.swiper-slide-active .video-modal-book-test-success-ssv').css('transform') == 'matrix(1, 0, 0, 1, 0, 0)') {
        jQuery('.swiper-slide-active .video-modal-book-test-success-ssv .video-modal-bts-close-ssv').click();
    }
