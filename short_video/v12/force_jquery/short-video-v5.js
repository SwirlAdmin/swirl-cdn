        ...
        if (!ssv_pip && !ssv_pdppipHideOnscreen) {
            ...
            onpageSlides += `
                <div class="swiper-slide ms-${video.video_id}" onclick="playssv(${i})">
                    ...
                    <img ${ssv_brandCustomizations.product_blog_img == '0' || typeof video.product[0] == 'undefined' ? 'style="top: calc(50% - 20px) !important;"' : ''} class="carousel-video-play-ssv" src="https://apigoswirl.com/short_video/assets/images/webp/play.webp"
                        alt="Play icon" />  
                    <div class="video-views-count-top-ssv" ${ssv_brandCustomizations.views === '0' ? 'style="display: none !important;"' : ''}>
                        <p><img src="https://apigoswirl.com/short_video/assets/images/webp/views-icon.webp" alt="Views icon" height="" width="">
                            ${video.total_views}
                        </p>                            
                    </div>   
                            ...
                            <div class="video-modal-product-tile-ssv" onclick="openListProductssv(event, this, ${pi});">
                                ...
                                <div class="product-buy-btn-pt-ssv" style="${ssv_brandCustomizations.product_tile_cta_btn == '0' || ssv_brandCustomizations.cta_on_tile == '1' ? 'display: none !important;' : ''}">
                                    <button style="background: ${ssv_brandCustomizations.bk_color_buy_btn} !important; color: ${ssv_brandCustomizations.front_color_buy_btn} !important;">
                                        ${video.cta_customization ? video.cta_customization : ssv_brandCustomizations.buy_btn}
                                        <img style="display: none !important;" src="https://apigoswirl.com/short_video/assets/images/webp/forward-arrow.webp"
                                            alt="Forward icon">
                                    </button>
                                </div>
                            </div>
                    ...
                    pl += `
                        <div class="product-list-block-ssv" onclick="openListProductssv(event, this, ${pi});">
                            ...
                            <div class="product-list-block-open-ssv">
                                <img src="https://apigoswirl.com/short_video/assets/images/webp/previous-arrow.webp" alt="Previous icon">
                            </div>
                        </div>
                    `;
                    ...
                    pb += `
                        <div class="video-modal-product-block-product-ssv video-modal-product-block-product-multi-ssv" style="transform: translateX(110%);">
                            <div class="product-top-pb-ssv product-top-pb-multi-ssv" onclick="closeListProductssv(this);">
                                <img class="video-modal-pb-close-ssv" src="https://apigoswirl.com/short_video/assets/images/webp/previous-arrow.webp"
                                    alt="Previous icon">                                                              
                            </div>
                ...
                productTile = `
                    <div class="swiper swiper-ssv-pt swiper-ssv-pt-${video.video_id}">
                        ...
                        <div class="sw-button-next">
                            <img src="https://apigoswirl.com/short_video/assets/images/webp/next-btn.webp" height="" width="" alt="Next icon">
                        </div>
                        <div class="sw-button-prev">
                            <img src="https://apigoswirl.com/short_video/assets/images/webp/back-btn.webp" height="" width="" alt="Previous icon">
                        </div>
                    </div>
                `;
            } else {
            ...
            <div class="swiper-slide ${typeof video.product[0] == 'undefined' ? 'no-product-ssv' : ''} ${buynowBtn ? 'video-redirect-on-ssv' : ''}">
                <div class="video-modal-video-container-ssv">
                    ...
                    <div class="video-modal-video-loader-ssv">
                        <img src="https://apigoswirl.com/short_video/assets/images/webp/spiner.webp"
                            alt="Spinner">
                    </div>
                    <div class="video-modal-video-controls-ssv" onclick="hidePhoneControlsssv(this, event);" onmouseout="hideControlsssv(this);">
                        <div class="video-controls-ssv">
                            <img class="video-rewind-ssv" onclick="videoForwardRewindssv(this, 'R');"
                                src="https://apigoswirl.com/short_video/assets/images/webp/rewind.webp"
                                alt="Rewind icon" />
                            <img class="video-playpause-ssv" onclick="videoPlayPausessv(this);"
                                src="https://apigoswirl.com/short_video/assets/images/webp/pause.webp"
                                alt="Play/Pause icon" />
                            <img class="video-forward-ssv" onclick="videoForwardRewindssv(this, 'F');"
                                src="https://apigoswirl.com/short_video/assets/images/webp/forward.webp"
                                alt="Forward icon" />
                        </div>
                    ...
                    <button class="video-modal-close-ssv" title="Close" onclick="closessv();" style="background: rgb(0, 0, 0, .6) !important;">
                        <img src="https://apigoswirl.com/short_video/assets/images/webp/close.webp"
                            alt="Close icon">
                    </button>                    
                    <button class="video-modal-pip-ssv" title="PIP Mode" onclick="playpipssv();" style="${ssv_brandCustomizations.pip_mode == '0' ? 'display: none !important;' : ''} background: rgb(0, 0, 0, .6) !important;">
                        <img src="https://apigoswirl.com/short_video/assets/images/webp/pip.webp"
                            alt="PIP icon">
                    </button>                                             
                    <div class="video-modal-actions-ssv">                                           
                        ...
                        <button class="video-modal-like-ssv" title="Like" onclick="likeVideossv(this, ${video.video_id}, ${video.designer_id});" style="background: rgb(0, 0, 0, .6) !important;">
                            <img src="${getCookie(`ssv_vl_${video.video_id}`) ? 'https://apigoswirl.com/short_video/assets/images/webp/heart-fill-2.webp' : 'https://apigoswirl.com/short_video/assets/images/webp/heart-outline.webp'}"
                                alt="Heart icon">
                        ...
                        <button class="video-modal-askque-ssv" title="Ask Question" onclick="openAskquessv(this);" style="${ssv_brandCustomizations.ask_question == '0' ? 'display: none !important;' : ''} background: rgb(0, 0, 0, .6) !important;">
                            <img src="https://apigoswirl.com/short_video/assets/images/webp/ask-question.webp"
                                alt="Close icon">
                            <p>Question</p>
                        </button>     
                        <button class="video-modal-volume-ssv" title="Mute/Unmute" onclick="volumessv(this)" style="background: rgb(0, 0, 0, .6) !important;">
                            <img src="https://apigoswirl.com/short_video/assets/images/webp/volume-up-fill.webp"
                                alt="Volume icon">
                            <p>Mute</p>
                        </button>
                        <button class="video-modal-share-ssv" title="Share" onclick="openSharessv(this);" style="background: rgb(0, 0, 0, .6) !important;">
                            <img src="https://apigoswirl.com/short_video/assets/images/webp/share-icon.webp"
                                alt="Close icon">
                            <p>Share</p>
                        </button> 
                    </div>                      
                    ...
                    <div class="video-modal-share-modal-ssv">
                        <div class="video-modal-share-modal-top-ssv">
                            <img class="video-modal-share-modal-close"
                                src="https://apigoswirl.com/short_video/assets/images/webp/previous-arrow.webp"
                                alt="Previous icon" onclick="closeSharessv(this);">
                            <p>Share to</p>     
                        </div>                           
                        <a href="https://www.facebook.com/sharer/sharer.php?u=${ssv_store}?ssv=${window.btoa(video.video_id)}" target="_blank"><img class="video-modal-share-modal-social-ssv" src="https://apigoswirl.com/short_video/assets/images/webp/facebook.webp" alt="Facebook icon" title="Share on Facebook"></a>
                        <a href="https://twitter.com/share?url=${ssv_store}?ssv=${window.btoa(video.video_id)}" target="_blank"><img class="video-modal-share-modal-social-ssv" src="https://apigoswirl.com/short_video/assets/images/webp/twitter.webp" alt="Twitter icon" title="Share on Twitter"></a>
                        <a href="https://api.whatsapp.com/send?text=${ssv_store}?ssv=${window.btoa(video.video_id)}" target="_blank"><img class="video-modal-share-modal-social-ssv" src="https://apigoswirl.com/short_video/assets/images/webp/whatsapp.webp" alt="Whatsapp icon" title="Share on Whatsapp"></a>
                        <a onclick="copyEmailEmbedssv('${ssv_store}?ssv=${window.btoa(video.video_id)}', '${video.cover_image}');" target="_blank"><img class="video-modal-share-modal-social-ssv" src="https://apigoswirl.com/short_video/assets/images/webp/email.webp" alt="Email icon" title="Share on Email"></a>
                        <a onclick="jQuery(this).next().click();"><img class="video-modal-share-modal-social-ssv" src="https://apigoswirl.com/short_video/assets/images/webp/copy-link.webp" alt="Copy link icon" title="Copy Link"></a>                                
                    ...
                    <div class="video-modal-askque-modal-ssv">
                        <div class="video-modal-askque-modal-top-ssv">
                            <img src="https://apigoswirl.com/short_video/assets/images/webp/previous-arrow.webp"
                    ...
                    <div class="video-modal-cart-popup-ssv">
                        <div class="cart-popup-flex-ssv">
                            <div class="cart-popup-wraper-ssv">
                                <img onclick="closeCartPopupssv(this);" src="https://apigoswirl.com/short_video/assets/images/webp/close.webp" alt="Close icon">
        ...
        <div class="swirl-short-videos">
            ...
            <div class="video-modal-ssv" style="display: none;">
                <div class="video-modal-container-ssv">
                    <div class="swiper swiper-ssv-m">
                        ...
                        <div class="swiper-button-next">
                            <img src="https://apigoswirl.com/short_video/assets/images/webp/next-btn.webp"
                                alt="Next icon">
                        </div>
                        <div class="swiper-button-prev">
                            <img src="https://apigoswirl.com/short_video/assets/images/webp/back-btn.webp"
                                alt="Previous icon">
                        </div>
                    </div>                    
                </div>                    
            ...
            <div class="video-pip-ssv">
                ...
                <button class="video-pip-playpause-ssv" title="Play/Pause" onclick="playpausepipssv(this)" style="background: rgb(0, 0, 0, .6) !important;">
                    <img src="https://apigoswirl.com/short_video/assets/images/webp/pause.webp"
                        alt="Play/Pause icon" />
                </button>                            
                            ...
                            if (Object.keys(reviews.data).length > 0) {
                                ...
                                let cappend = `
                                    <div class="product-rating-all-title-ssv">
                                        <p>
                                            <img class="product-rating-all-close-ssv" src="https://apigoswirl.com/short_video/assets/images/webp/previous-arrow.webp" alt="Previous icon" onclick="closeRatingssv(this);">
                                            ${totalRating} 
...
function playWithPromisessv(player) {
    ...
    let src = ssv_globalMute ? 'https://apigoswirl.com/short_video/assets/images/webp/volume-mute-fill.webp' : 'https://apigoswirl.com/short_video/assets/images/webp/volume-up-fill.webp';
...
function volumessv(btn) {
    if (jQuery(btn).closest('.video-modal-video-container-ssv').find('video').prop('muted')) {
        jQuery(btn).children('img').attr('src', 'https://apigoswirl.com/short_video/assets/images/webp/volume-up-fill.webp');
        ...
        jQuery(btn).children('img').attr('src', 'https://apigoswirl.com/short_video/assets/images/webp/volume-mute-fill.webp');
...
function videoPlayPausessv(btn) {
    ...
    if (player.paused) {
        player.play();
        jQuery(btn).closest('.video-modal-video-container-ssv').find('.video-playpause-ssv').attr('src', 'https://apigoswirl.com/short_video/assets/images/webp/pause.webp');
    } else {
        player.pause();
        jQuery(btn).closest('.video-modal-video-container-ssv').find('.video-playpause-ssv').attr('src', 'https://apigoswirl.com/short_video/assets/images/webp/play.webp');
    }
}
...
function playpausepipssv(btn) {
    ...
    if (player.paused) {
        player.play();
        jQuery('.video-pip-playpause-ssv img').attr('src', 'https://apigoswirl.com/short_video/assets/images/webp/pause.webp');
    } else {
        player.pause();
        jQuery('.video-pip-playpause-ssv img').attr('src', 'https://apigoswirl.com/short_video/assets/images/webp/play.webp');
    }
}

function volumepipssv(btn) {
    if (jQuery('.video-pip-ssv video').prop('muted')) {
        jQuery('.video-pip-volume-ssv img').attr('src', 'https://apigoswirl.com/short_video/assets/images/webp/volume-up-fill.webp');
        jQuery('.video-pip-ssv video').prop('muted', false);

        ssv_globalMute = false;
    } else {
        jQuery('.video-pip-volume-ssv img').attr('src', 'https://apigoswirl.com/short_video/assets/images/webp/volume-mute-fill.webp');
...
function likeVideossv(btn, videoId, designerId) {
    ...
    jQuery(btn).find('img').attr('src', 'https://apigoswirl.com/short_video/assets/images/webp/heart-fill-2.webp');
    SWIRLHeartFlawsssv(elm);
    SWIRLHeartFlawsssv(elm);
            ...
            <table cellpadding="0" cellspacing="0" border="0" style="min-height: 640px; min-width: 360px">
                ...
                <tr>
                    ...
                    <table width="100%" align="center" cellpadding="0" cellspacing="0" border="0" style="min-width: 100%">
                        <tbody>
                        <tr>
                            <td height="640" width="360" background="https://apigoswirl.com/short_video/assets/images/webp/play-icon.webp" style="background-image: url(https://apigoswirl.com/short_video/assets/images/webp/play-icon.webp); background-repeat: no-repeat; background-position: center; position: relative; display: inline-block; height: 640px; width:360px; min-width: 100%;">
