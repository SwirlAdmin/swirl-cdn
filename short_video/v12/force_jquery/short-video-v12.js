            ...
            <div class="swiper-slide ${typeof video.product[0] == 'undefined' ? 'no-product-ssv' : ''} ${buynowBtn ? 'video-redirect-on-ssv' : ''}">
                <div class="video-modal-video-container-ssv">
                    ...
                    <div class="video-modal-actions-ssv">                                           
                        ...
                        <button class="video-modal-download-ssv" title="Download Video" onclick="downloadVideossv('${video.video_url}')" style="${ssv_brandCustomizations.download_icon == '0' ? 'display: none !important;' : ''} background: rgb(0, 0, 0, .6) !important;">
