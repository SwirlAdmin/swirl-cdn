...
let ssv_baseURL = ssv_mode === 'Live' ? 'https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/short_video/v12/swirl-style-farsi-v28.min.css' : '';
        ...
        if (typeof video.product[0] != 'undefined') {
                ...
                productList = `
                    <div class="video-modal-product-block-product-ssv">
                        ...
                        <div class="product-middle-pb-ssv">                            
                            ...
                            <div class="product-desc-pb-ssv">
                                <p class="product-desc-title-pb-ssv">جزئیات محصول</p>
                                <section>${video.product[0].desription}</section>                                
                            </div>                                    
                            <div class="product-quantity-pb-ssv" style="${ssv_storeType == '0' || ssv_brandCustomizations.product_qty == '0' ? 'display: none !important;' : ''}">
                                <div class="product-quantity-title-pt-ssv">
            ...
            buynowBtn = video.product_link && ssv_brandCustomizations.buy_now == '1' ? `
                <a href="${video.product_link}" onclick="CTAClicksssv(0, '', '', '', ${video.designer_id}, ${video.video_id}, '1');">
                    <button class="video-redirect-btn-ssv" style="background: ${ssv_brandCustomizations.bk_color_buy_btn} !important; color: ${ssv_brandCustomizations.front_color_buy_btn} !important; ${ssv_brandCustomizations.buy_now == '0' ? 'display: none !important;' : ''}">هم اکنون خریداری کنید</button>
                </a>
            ` : '';
        }
        ...
        modalSlides += `
            <div class="swiper-slide ${typeof video.product[0] == 'undefined' ? 'no-product-ssv' : ''} ${buynowBtn ? 'video-redirect-on-ssv' : ''}">
                <div class="video-modal-video-container-ssv">
                    ...
                    <button class="video-modal-close-ssv" title="بستن" onclick="closessv();" style="background: rgb(0, 0, 0, .6) !important;">
                        <img src="https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/assets/images/goswirl-webp/close.webp"
                            alt="بستن">
                    </button>                    
                    <button class="video-modal-pip-ssv" title="حالت تصویر در تصویر" onclick="playpipssv();" style="${ssv_brandCustomizations.pip_mode == '0' ? 'display: none !important;' : ''} background: rgb(0, 0, 0, .6) !important;">
                    ...
                    <div class="video-modal-actions-ssv">                                           
                        ...
                        <button class="video-modal-download-ssv" title="دانلود" onclick="downloadVideossv(this, '${video.video_url}', ${video.video_id}, ${video.designer_id})" style="${ssv_brandCustomizations.download_icon == '0' ? 'display: none !important;' : ''} background: rgb(0, 0, 0, .6) !important;">
                            <img src="https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/assets/images/goswirl-webp/download.webp"
                                alt="دانلود">
                            <p>دانلود</p>
                        </button>                        
                        <button class="video-modal-askque-ssv" title="سوال بپرس" onclick="openAskquessv(this);" style="${ssv_brandCustomizations.ask_question == '0' ? 'display: none !important;' : ''} background: rgb(0, 0, 0, .6) !important;">
                            <img src="https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/assets/images/goswirl-webp/ask-question.webp"
                                alt="Close icon">
                            <p>سوالات</p>
                        </button>     
                        <button class="video-modal-volume-ssv" title="بی صدا/باصدا کردن" onclick="volumessv(this)" style="background: rgb(0, 0, 0, .6) !important;">
                            <img src="https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/assets/images/goswirl-webp/volume-up-fill.webp"
                                alt="Volume icon">
                            <p>باصدا کردن</p>
                        </button>
                        <button class="video-modal-share-ssv" title="اشتراک گذاری" onclick="openSharessv(this);" style="background: rgb(0, 0, 0, .6) !important;">
                    ...
                    <div class="video-modal-share-modal-ssv">
                        <div class="video-modal-share-modal-top-ssv">
                            ...
                            <p>اشتراک گذاری برای</p>     
                        </div>                           
                        <a href="https://www.facebook.com/sharer/sharer.php?u=${ssv_store}?ssv=${window.btoa(video.video_id)}" target="_blank"><img class="video-modal-share-modal-social-ssv" src="https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/assets/images/goswirl-webp/facebook.webp" alt="Facebook icon" title="فیس بوک"></a>
                        <a href="https://twitter.com/share?url=${ssv_store}?ssv=${window.btoa(video.video_id)}" target="_blank"><img class="video-modal-share-modal-social-ssv" src="https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/assets/images/goswirl-webp/twitter.webp" alt="Twitter icon" title="توییتر"></a>
                        <a href="https://api.whatsapp.com/send?text=${ssv_store}?ssv=${window.btoa(video.video_id)}" target="_blank"><img class="video-modal-share-modal-social-ssv" src="https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/assets/images/goswirl-webp/whatsapp.webp" alt="Whatsapp icon" title="واتساپ"></a>
                        <a onclick="copyEmailEmbedssv('${ssv_store}?ssv=${window.btoa(video.video_id)}', '${video.cover_image}');" target="_blank"><img class="video-modal-share-modal-social-ssv" src="https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/assets/images/goswirl-webp/email.webp" alt="Email icon" title="پست الکترونیک"></a>
                        <a onclick="jQuery(this).next().click();"><img class="video-modal-share-modal-social-ssv" src="https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/assets/images/goswirl-webp/copy-link.webp" alt="Copy link icon" title="لینک را کپی کنید"></a>                                
                    ...
                    <div class="video-modal-askque-modal-ssv">
                        ...
                        <div class="askque-modal-form-ssv askque-modal-form1-ssv">
                            <form onsubmit="return askQuestionssv(this, ${video.designer_id}, ${video.video_id});">
                                <textarea name="question" rows="3" onfocus="ssv_swiper_modal.disable();" onfocusout="ssv_swiper_modal.enable();" placeholder="پرس و جو را در اینجا وارد کنید" required></textarea>                           
                                <button class="askque-modal-btn-ssv askque-modal-btn1-ssv" style="background: ${ssv_brandCustomizations.bk_color_buy_btn} !important; color: ${ssv_brandCustomizations.front_color_buy_btn} !important;">  ارسال</button>                           
                            </form>
                        </div>
                        <div class="askque-modal-form-ssv askque-modal-form2-ssv">
                            <form onsubmit="return registerUserssv(this, ${video.video_id});">
                                <input name="fullname" type="text" onfocus="ssv_swiper_modal.disable();" onfocusout="ssv_swiper_modal.enable();" placeholder="اسمت را وارد کن" style="margin-bottom: 8px !important;" pattern=".{3,25}" onkeypress='return (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || event.charCode === 32' onpaste='return (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || event.charCode === 32' title="Minimum 3 Maximum 25 character, No special characters, No Digits." required />
                                ...
                                <input name="phone" id="phone${video.video_id}" type="text" onfocus="ssv_swiper_modal.disable();" onfocusout="ssv_swiper_modal.enable();" style="margin: 0px !important;" placeholder="گوشی خود را وارد کنید" pattern=".{10,10}" onkeypress='return event.charCode >= 48 && event.charCode <= 57' title="حداقل 10 و حداکثر 10 رقم" required />                                
                                <button class="askque-modal-btn-ssv askque-modal-btn2-ssv" style="background: ${ssv_brandCustomizations.bk_color_buy_btn} !important; color: ${ssv_brandCustomizations.front_color_buy_btn} !important;">ثبت نام</button>                           
                            </form>
                        </div>                        
                    </div>                       
                        ...
                        <div class="user-registration-popup-inner-ssv">
                            ...
                            <div class="urp-form-ssv">
                                <form onsubmit="return userRegistrationssv(this, ${video.video_id});" autocomplete="off">
                                    <input name="fullname" type="text" placeholder="اسمت را وارد کن" style="margin-bottom: 8px !important;" pattern=".{3,25}" onkeypress='return (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || event.charCode === 32' onpaste='return (event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || event.charCode === 32' title="حداقل 3 حداکثر 25 کاراکتر، بدون نویسه خاص، بدون رقم" required autocomplete="off" />
                                    <div class="urp-form-phone-ssv">
                                        ...
                                        <input name="phone" type="text" style="margin: 0px !important;" placeholder="گوشی خود را وارد کنید" pattern=".{10,10}" onkeypress='return event.charCode >= 48 && event.charCode <= 57' title="Minimum 10 and maximim 10 digits." required autocomplete="off" />                                
                                    </div>
                                    <button class="urp-btn-ssv" style="background: ${ssv_brandCustomizations.bk_color_buy_btn} !important; color: ${ssv_brandCustomizations.front_color_buy_btn} !important;">ثبت نام</button>                           
                                </form>
                            </div> 
                        </div>     
                    </div>                    
    ...
    jQuery('body').append(`
        <div class="swirl-short-videos">
            ...
            <div class="video-pip-ssv" onclick="fullscreenpipssv(event);">
                ...
                <button class="video-pip-volume-ssv pfs-ex-ssv" title="بی صدا/باصدا کردن" onclick="volumepipssv(this)" style="background: rgb(0, 0, 0, .6) !important;">
                    <img class="pfs-ex-ssv" src="https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/assets/images/goswirl-webp/volume-up-fill.webp"
                        alt="Volume icon">                    
                </button>
                <button class="video-pip-close-ssv pfs-ex-ssv" title="بستن" onclick="closepipssv();" style="background: rgb(0, 0, 0, .6) !important;">
                    <img class="pfs-ex-ssv" src="https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/assets/images/goswirl-webp/close.webp"
                        alt="Close icon">
                </button>
                <button class="video-pip-fullscreen-ssv" title="تمام صفحه" style="border: 2.5px solid #fff !important;">
                </button>
            </div>
                        ...
                        if (xhr.readyState === 4) {
                            ...
                            if (Object.keys(reviews.data).length > 0) {
                                ...
                                let rappend = Object.keys(reviews.data).length > 2 ? `
                                    <p class="product-rating-title-ssv">${totalRating} <i class="starssv"></i> (${(Object.keys(reviews.data).length)} بررسی ها)
                                        <a class="product-rating-all-btn-ssv" onclick="openRatingssv(this);">همه را ببین</a>
                                    </p>
                                    <div class="product-rating-comments-ssv">
                                    ` : `
                                    <p class="product-rating-title-ssv">${totalRating} <i class="starssv"></i> (${(Object.keys(reviews.data).length)} بررسی ها)</p>
                                    <div class="product-rating-comments-ssv">
                                `;
...
function playWithPromisessv(player) {
    ...
    jQuery(player).parent('.video-modal-video-container-ssv').find('.video-modal-volume-ssv p').html(ssv_globalMute ? 'باصدا کردن' : 'بی صدا');
...
function volumessv(btn) {
    if (jQuery(btn).closest('.video-modal-video-container-ssv').find('video').prop('muted')) {
        ...
        jQuery(btn).children('p').html('بی صدا');
        ...
        jQuery(btn).children('p').html('باصدا کردن');
...
function copyLinkssv(inp) {
    ...
    videoAlertssv('لینک کپی شد', '2000');
...
function askQuestionssv(form, designerId, videoId) {
    ...
    if (ssv_userData) {
        ...
        // }).then(function () {
        //     videoAlertssv('درخواست شما ارسال شد، متشکرم!', 3000);
        //     setTimeout(() => {
        //         closeAskquessv(form);
        //     }, 1000);
