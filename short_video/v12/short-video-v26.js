...
let ssv_baseURL = ssv_mode === 'Live' ? 'https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/short_video/v12/swirl-style-v19.min.css' : '';
...
let clientImpClasses = ['hs-site-cart-popup-layout', 'hs-bg-slide-cart'];
