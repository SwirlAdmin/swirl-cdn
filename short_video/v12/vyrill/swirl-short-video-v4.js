...
const addTocartForOdr = async (productId, btn, fddsfsd, index) => {

    const colorSelected = document.getElementById(`selectedColor-${fddsfsd}-${index}`).value
    let id;
    ...
    const ele = document.getElementById(`quantity_val-${productId}`)
    const obj = {
        "form_type": "product",
                            ...
                            <div class="product-middle-pb-ssv">                            
                                ...
                                <div class="product-quantity-pb-ssv" style="${ssv_storeType == "0" || ssv_brandCustomizations.product_qty == "0" ? "display: none !important;" : ""}">
                                    ...
                                    <div class="product-quantity-inp-pb-ssv">
                                        ...
                                        <input id="quantity_val-${product.brand_product_id}" class="quantity-inp-ssv" value="1" readonly></input>
                        ...
                        "imagekit"
                            ...
                            <div style="padding: 10px 15px;">
                                <div class="find-your-fit-wrapper">
                                    <p>Find Your Fit</p>
                                    <div class="shoe-gender-wrapper">
                                        <div class="shoe-size-input-wrapper">
                                            <label for="shoeSize-${video.product[0].product_id}-${index}">What's your gym shoe size?</label>
                                            <input style="margin-top:8px" class="shoe-size-input" type="number" id="shoeSize-${video.product[0].product_id}-${index}" placeholder="Enter size" />
                                        </div>
                                        <div class="gender-wrapper">
                                            <label>Gender</label>
                                            <select style="margin-top:8px" id="genderForSize-${video.product[0].product_id}-${index}">
                            ...
                            <div class="product-quantity-pb-ssv" style="${ssv_storeType == "0" || ssv_brandCustomizations.product_qty == "0" ? "display: none !important;" : ""}">  
                                ...
                                <div class="product-quantity-inp-pb-ssv">
                                    <button style="background: #eaeaea !important; color: #323232 !important;" onclick="changeQtyssv('minus', this);">-</button>
                                    <input id="quantity_val-${video.product[0].brand_product_id}" class="quantity-inp-ssv" value="1" readonly></input>
                                    <button style="background: #eaeaea !important; color: #323232 !important;" onclick="changeQtyssv('plus', this);">+</button>
                                </div>
                            </div>
                            <div class="product-rating-ssv prssv-${video.video_id
