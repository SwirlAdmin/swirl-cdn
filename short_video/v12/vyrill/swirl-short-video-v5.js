...
let ssv_productIds = [];
let ssv_apiURL = "https://goswirl.info:4000/api/videolistingV4";
// "https://api.goswirl.live/index.php/ShortVideo/videolistingV4"; // bigleap.live  ,  api.goswirl.live
let ssv_pdpapiURL =
...
function handleFindFitWrapper(id, index) {
    ...
    shoeGenderWrapper.style.display = (shoeGenderWrapper.style.display === 'none' || shoeGenderWrapper.style.display === '') ? 'grid' : 'none';
}
var yourSize = 1
...
const addTocartForOdr = async (productId, btn, clr, index) => {
    ...
    // document.getElementById(`quantity_val-${productId}`).value = 5;
        ...
        if (ssv_pdppip || ssv_storePlaylist) {
            jQuery.ajax({
                ...
                url: localStorage.getItem("filtered") == "true"
                    ? "https://goswirl.info:4000/api/videolistingV4WithSearchAndFilter"
                    : finalAPICall,
                data: {
                    // user: "kgtges9q",
                    // playlist: "qPgWYv",
                    ...
                    `;
                        ...
                        <div class="video-modal-product-block-product-ssv video-modal-product-block-product-multi-ssv" style="transform: translateX(110%);">
                            ...
                            <div class="product-bottom-pb-ssv">
                                <button class="product-addtocart-pb-ssv" onclick="addTocartForOdr(${video.product[0].brand_product_id},this,${video.product[0].product_id},${index})" style="background: none !important; border: 2px solid ${ssv_brandCustomizations.front_color_add_to_cart_btn
                            } !important; color: ${ssv_brandCustomizations.front_color_add_to_cart_btn
                            } !important; ${ssv_brandCustomizations.add_to_cart == "0"
                                ? "display: none !important;"
                                : ""
                ...
                `;
                    ...
                    <div class="video-modal-product-block-product-ssv">
                        ...
                        "imagekit"
                            ...
                            <div class="product-desc-pb-ssv">
                                <p class="product-desc-title-pb-ssv">Product Details</p>
                                <section style="font-size:14px !important">${video.product[0].desription
                        }</section>                                
                            </div>
                            <div style="padding: 10px 15px;">
                                <div class="find-your-fit-wrapper">
                                    <p class="underline" style="cursor:pointer" onclick="handleFindFitWrapper(${video.product[0].product_id},${index})">Find Your Fit</p>
                                    <div class="shoe-gender-wrapper" id="shoeGenderWrapper-${video.product[0].product_id}-${index}" style="display:none">
                                        <div class="shoe-size-input-wrapper">
                                            <label style="margin-bottom:3px" for="shoeSize-${video.product[0].product_id}-${index}">What's your gym shoe size?</label>
                                            <input class="shoe-size-input" type="number" id="shoeSize-${video.product[0].product_id}-${index}" placeholder="Enter size" />
                                        </div>
                                    ...
                                    <div class="selectSizeAndColorWrapper">
                                        <select id="select-size-${video.product[0].product_id}-${index}" onchange="handleSizeChange(${video.product[0].product_id},${index})" style="padding: 10px; width:100%;">
                                            ...
                                            <option value="xs" style="${video.product[0].brand_product_id == 6040740593834 ? 'display:block' : 'display:none'}">XS</option>                                  
                                            <option value="s" style="${video.product[0].brand_product_id == 6040740593834 ? 'display:block' : 'display:none'}">S</option>                                  
                                            <option value="m" style="${video.product[0].brand_product_id == 6040740593834 ? 'display:block' : 'display:none'}">M</option>
                                            <option value="l" style="${video.product[0].brand_product_id == 6040740593834 ? 'display:block' : 'display:none'}">L</option>
                                            <option value="5" style="${video.product[0].brand_product_id == 4733388685366 ? 'display:block' : 'display:none'}">5</option>
                                            <option value="6" style="${video.product[0].brand_product_id == 4733388685366 ? 'display:block' : 'display:none'}">6</option>
                                            <option value="7" style="${video.product[0].brand_product_id == 4733388685366 ? 'display:block' : 'display:none'}">7</option>
                                            <option value="8" style="${video.product[0].brand_product_id == 4733388685366 ? 'display:block' : 'display:none'}">8</option>
                                            <option value="9" style="${video.product[0].brand_product_id == 4733388685366 ? 'display:block' : 'display:none'}">9</option>
                                            <option value="10" style="${video.product[0].brand_product_id == 4733388685366 ? 'display:block' : 'display:none'}">10</option>
                                            <option value="11" style="${video.product[0].brand_product_id == 4733388685366 ? 'display:block' : 'display:none'}">11</option>
                                            <option value="12" style="${video.product[0].brand_product_id == 4733388685366 ? 'display:block' : 'display:none'}">12</option>
                                            <option value="13" style="${video.product[0].brand_product_id == 4733388685366 ? 'display:block' : 'display:none'}">13</option>
                                        </select>
                                        
                                        <div class="color-wrapper" style="display: ${video.product[0].brand_product_id == 4733388685366 ? 'block' : 'none'}">
                        ...
                        <div class="product-bottom-pb-ssv">
                            <button class="product-addtocart-pb-ssv" disabled id="add-to-cart-btn-${video.product[0].product_id}-${index}" onclick="addTocartForOdr(${video.product[0].brand_product_id},this,${video.product[0].product_id},${index})" style="background: none !important;opacity: 0.5; border: 2px solid ${ssv_brandCustomizations.front_color_add_to_cart_btn
                        } !important; color: ${ssv_brandCustomizations.front_color_add_to_cart_btn
                        } !important; ${ssv_brandCustomizations.add_to_cart == "0"
                            ? "display: none !important;"
                            : ""
            ...
            <div class="swiper-slide ${typeof video.product[0] == "undefined" ? "no-product-ssv" : ""
                ...
                <div class="video-modal-video-container-ssv">
                    ...
                    <video id="modalVideossv-${video.video_id
                        ...
                        poster="${video.cover_image}" myindex="${index}">
                    ...
                    <button class="video-modal-pip-ssv" title="PIP Mode" onclick="playpipssv('','',${index});" style="${ssv_brandCustomizations.pip_mode == "0"
                    ? "display: none !important;"
                    : ""
        ...
        !ssv_pip && !ssv_pdppipHideOnscreen
                ...
                <div class="left_section_first_row">
                    <div class="icon_video_filter">
                        <svg width="41" height="35" viewBox="0 0 41 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M34.375 1.25H6.625C3.79681 1.25 1.25 3.21071 1.25 5.875V29.125C1.25 31.7893 3.79681 33.75 6.625 33.75H34.375C37.2032 33.75 39.75 31.7893 39.75 29.125V5.875C39.75 3.21071 37.2032 1.25 34.375 1.25ZM28.3404 17.5L16.625 24.8617V10.1383L28.3404 17.5Z"
                ...
                <div class="left_section_second_row">
                    ...
                    <div class="search-container">
                        ...
                        <option  data-object="null" value="0">-- Select Location --</option>
                                 <option ${selecteOrNotCheck({
                "city": "Brighton",
                "state": "Utah",
                "country": "USA"
            }) ? "selected" : ""} value="3" data-object='{
                                    "city": "Brighton",
                                    "state": "Utah",
                                    "country": "USA"
            ...
            < option  ${selecteOrNotCheck({
                ...
                "country": "Lithuania"
                    ...
                    <!-- <input type="text" class="sort_by_filter location_input_field" placeholder="Search for Ski Locations here" /> -->
                </div>
...
`);
    ...
    if (clear_filter_btn_wrapper_status) {
        clear_filter_btn_wrapper.style.display = "block"
    } else {
        clear_filter_btn_wrapper.style.display = "none"
    }
...
function playWithPromisessv(player) {
    ...
    if (ssv_brandCustomizations.pip_mode === "1") {
        ...
        localStorage.setItem(
            "_ssv_index_buy_pip",
            jQuery(player).attr("myindex") ? jQuery(player).attr("myindex"):" "
        );
...
function fullscreenpipssv(e) {
    ...
    updateCartCountssv();
    closepipssv();
    playssv(ind ? ind : localStorage.getItem("_ssv_index_buy_pip"));
}
