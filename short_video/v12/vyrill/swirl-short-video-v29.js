...
let filter_css = "https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/short_video/v12/vyrill/swirl-style-v76.min.css"
let ssv_responseData = [];
let ssv_productIds = [];
let ssv_apiURL = window.location.href.includes("olliecraft") ? "https://api.goswirl.live/index.php/ShortVideo/videolistingV4" : "https://goswirl.info:4000/api/videolistingV4";
...
console.log(window.location.href.includes("olliecraft") || window.location.href.includes("localhost"));
...
function executessv() {
    ...
    if (document.querySelector("#swirl-short-videos") != null || localStorage.getItem("_ssv_pip")) {
        ...
        let finalAPICall = ssv_pdppip ? ssv_pdpapiURL : localStorage.getItem("filtered") == "true" ? window.location.href.includes("odrskis") ? "https://goswirl.info:4000/api/videolistingV4WithSearchAndFilter" : "https://goswirl.info:4000/api/videolistingV4WithSearchAndCustomFilter" : ssv_apiURL;
...
async function generatessv(videos) {
    ...
    if (ssv_brandCustomizations.age === 1) {
        ...
        async function updateSelectedValues() {
            ...
            if (globalData.ageGroups.length > 0 || globalData.skieLevel.length > 0 || globalData.address.state !== "" || globalData.sortBy.length > 0 || globalData.productFilter.length > 0) {
                filtered = true;
                localStorage.setItem("filtered", true)
                await executessv();
            } else {
...
function addtocartssv(videoId, productId, skuCode, btn, qty = 0) {
    console.log(videoId, productId, skuCode, btn, qty);
