...
let selectedVarient;
var yourSize = 1;
var globalData = { ageGroups: [], skieLevel: [], address: {}, sortBy: "", searchQuery: "" };
    ...
    if (document.querySelector("#swirl-short-videos") != null || localStorage.getItem("_ssv_pip")) {
        ...
        if (ssv_pdppip || ssv_storePlaylist) {
            jQuery.ajax({
                type: "GET",
                dataType: "json",
                url: localStorage.getItem("filtered") == "true" ? "https://goswirl.info:4000/api/videolistingV4WithSearchAndFilter" : finalAPICall,
                data: {
                    user: ssv_storeCode,
...
function generatessv(videos) {
                ...
                if (Object.keys(video.product).length > 1) {
                    ...
                    <div class="video-modal-product-block-product-ssv">
                        ...
                        <div class="product-middle-pb-ssv">                            
                            ...
                            <div class="sizeGenderFitWrapper">
                            <div style="border: 1px solid #eaeaea;padding:10px;background-color:#eaeaea; border-radius:10px">
            ...
            <div class="second_row">
                <div class="left_section_second_row">
                    ...
                    <div class="search-container">
                        <i class="search-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 19 27" fill="none">
                                <path d="M9.5 0C4.24786 0 0 4.2255 0 9.45C0 16.5375 9.5 27 9.5 27C9.5 27 19 16.5375 19 9.45C19 4.2255 14.7521 0 9.5 0ZM2.71429 9.45C2.71429 5.724 5.75429 2.7 9.5 2.7C13.2457 2.7 16.2857 5.724 16.2857 9.45C16.2857 13.338 12.3771 19.1565 9.5 22.788C6.67714 19.1835 2.71429 13.2975 2.71429 9.45Z" fill="#676EF0" />
                                <path d="M9.5 14C11.433 14 13 12.433 13 10.5C13 8.567 11.433 7 9.5 7C7.567 7 6 8.567 6 10.5C6 12.433 7.567 14 9.5 14Z" fill="#676EF1" />
                            </svg>
                        </i>
                ...
                <div class="center_section_second_row">
                    ...
                    <div class="multi-select-container" style="margin-left: 15px;" id="multiSelectContainer"></div>
                </div>
                <div class="right_section_second_row">
                    <h4 class="sortby_text">Age</h4>
                    <div class="multi-select-container2" style="margin-left: 15px;" id="multiSelectContainer2"></div>
                </div>
            </div>
        </div>
    ...
    async function updateSelectedValues() {
        ...
        if (globalData.ageGroups.length > 0 || globalData.skieLevel.length > 0 || globalData.address.state !== undefined || globalData.sortBy.length > 0) {
            filtered = true;
