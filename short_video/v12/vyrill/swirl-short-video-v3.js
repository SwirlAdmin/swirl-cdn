...
const addTocartForOdr = async (productId) => {
    ...
    const obj = {
        "form_type": "product",
        "quantity": ele?.value ? ele.value : 1,
            ...
            if (typeof video.product[0] != "undefined") {
                ...
                `;
                    ...
                    <div class="video-modal-product-block-product-ssv">
                        ...
                        <div class="product-bottom-pb-ssv">
                            <button class="product-addtocart-pb-ssv" onclick="addTocartForOdr(${video.product[0].brand_product_id},${document.getElementById(`quantity_val-${video.product[0].brand_product_id}`)})" style="background: none !important; border: 2px solid ${ssv_brandCustomizations.front_color_add_to_cart_btn
                        } !important; color: ${ssv_brandCustomizations.front_color_add_to_cart_btn
                        } !important; ${ssv_brandCustomizations.add_to_cart == "0"
                            ? "display: none !important;"
                            : ""
