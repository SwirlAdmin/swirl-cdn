...
let ssv_baseURL = ssv_mode === 'Live' ? 'https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/short_video/v12/swirl-style-v64.min.css' : '';
                            ...
                            <div class="video-modal-product-tile-ssv frommoredetail" onclick="openListProductssv(event, this, ${pi});">
                                <div class="product-info-pt-ssv" style="${ssv_brandCustomizations.product_tile_cta_btn == '0' || ssv_brandCustomizations.cta_on_tile == '1' ? 'width: 100% !important;' : ''}">
                                    ...
                                    <div class="product-detail-pt-ssv" style="${ssv_brandCustomizations.mobile_product_tile_img == '1' ? 'width: calc(100% - 75px) !important;' : ''}">
                                        <p>${product.title}</p>
                                        ${desc}
                                        <label class="dynamic-price-ssv-${product.product_id}" style="${ssv_brandCustomizations.product_price_status == '0' ? 'display: none !important;' : ''} color:${ssv_brandCustomizations.dis_fk_color} !important;">${product.currencysymbols}${product.discount_price} <strike style="${parseFloat(product.price) > parseFloat(product.discount_price) ? '' : 'display: none;'} color:${ssv_brandCustomizations.mrp_fk_color} !important;">${product.currencysymbols}${product.price}</strike>
                            ...
                            <div class="product-middle-pb-ssv">                            
                                <div class="product-detail-pb-ssv" style="${ssv_brandCustomizations.buy_now == '1' ? 'cursor: pointer;' : ''}" ${ptClick}>
                                    ...
                                    <div class="product-detail-block-pb-ssv">
                                        ...
                                        <label class="dynamic-price-up-ssv dynamic-price-ssv-${product.product_id}" style="${ssv_brandCustomizations.product_price_status == '0' ? 'display: none !important;' : ''} color:${ssv_brandCustomizations.dis_fk_color} !important;">${product.currencysymbols}${product.discount_price} <strike style="${parseFloat(product.price) > parseFloat(product.discount_price) ? '' : 'display: none;'} color:${ssv_brandCustomizations.mrp_fk_color} !important;">${product.currencysymbols}${product.price}</strike>
                                            <span style="${parseFloat(product.price) > parseFloat(product.discount_price) ? '' : 'display: none;'} color:${ssv_brandCustomizations.off_fk_color} !important; background:${ssv_brandCustomizations.off_bk_color} !important;">${parseFloat(product.price) > parseFloat(product.discount_price) ? Math.round(((product.price - product.discount_price) * 100) / product.price) : ''}% OFF</span></label>
                                    </div>
                                </div>                            
                    ...
                    <div class="video-modal-product-tile-ssv frommoredetail" onclick="openProductssv(event, this);">
                        <div class="product-info-pt-ssv" style="${ssv_brandCustomizations.product_tile_cta_btn == '0' || ssv_brandCustomizations.cta_on_tile == '1' ? 'width: 100% !important;' : ''}">
                            ...
                            <div class="product-detail-pt-ssv" style="${ssv_brandCustomizations.mobile_product_tile_img == '1' ? 'width: calc(100% - 75px) !important;' : ''}">
                                ...
                                ${desc}
                                <label class="dynamic-price-ssv-${video.product[0].product_id}" style="${ssv_brandCustomizations.product_price_status == '0' ? 'display: none !important;' : ''} color:${ssv_brandCustomizations.dis_fk_color} !important;">${video.product[0].currencysymbols}${video.product[0].discount_price} <strike style="${parseFloat(video.product[0].price) > parseFloat(video.product[0].discount_price) ? '' : 'display: none;'} color:${ssv_brandCustomizations.mrp_fk_color} !important;">${video.product[0].currencysymbols}${video.product[0].price}</strike>
                        ...
                        <div class="product-middle-pb-ssv">                            
                            <div class="product-detail-pb-ssv" style="${ssv_brandCustomizations.buy_now == '1' ? 'cursor: pointer;' : ''}" ${ptClick2}>
                                ...
                                <div class="product-detail-block-pb-ssv">
                                    ...
                                    <label class="dynamic-price-up-ssv dynamic-price-ssv-${video.product[0].product_id}" style="${ssv_brandCustomizations.product_price_status == '0' ? 'display: none !important;' : ''} color:${ssv_brandCustomizations.dis_fk_color} !important;">${video.product[0].currencysymbols}${video.product[0].discount_price} <strike style="${parseFloat(video.product[0].price) > parseFloat(video.product[0].discount_price) ? '' : 'display: none;'} color:${ssv_brandCustomizations.mrp_fk_color} !important;">${video.product[0].currencysymbols}${video.product[0].price}</strike>
                                        <span style="${parseFloat(video.product[0].price) > parseFloat(video.product[0].discount_price) ? '' : 'display: none;'} color:${ssv_brandCustomizations.off_fk_color} !important; background:${ssv_brandCustomizations.off_bk_color} !important;">${parseFloat(video.product[0].price) > parseFloat(video.product[0].discount_price) ? Math.round(((video.product[0].price - video.product[0].discount_price) * 100) / video.product[0].price) : ''}% OFF</span></label>
                                </div>
                            </div>                            
                            <div class="product-desc-pb-ssv">
                    ...
                    if (typeof response.data != 'undefined') {
                        if (Object.keys(response.data.skus).length) {
                            ...
                            $(`.swiper-ssv-c .dynamic-price-ssv-${product.product_id}`).html(`
                                ${product.currencysymbols}${response.data.skus[i].sellingPrice} 
                                <strike style="${parseFloat(response.data.skus[i].mrp) > parseFloat(response.data.skus[i].sellingPrice) ? '' : 'display: none;'} color:${ssv_brandCustomizations.mrp_fk_color} !important;">${product.currencysymbols}${response.data.skus[i].mrp}</strike>
                                <br>
