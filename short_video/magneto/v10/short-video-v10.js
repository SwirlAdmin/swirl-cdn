//v12.1 - New design with new swiping up-down + Multiple Product + No Product + Multiple Page + PDP PIP (v10 Upgrade) [Reels] feature
...
let ssv_baseURL = ssv_mode === 'Live' ? 'https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/short_video/magneto/v10/style-v10.min.css' : '';
...
require([
    ...
    function ($, Swiper, app, firebase, auth, firestore) {
        $(document).ready(function () {
                        ...
                        <div class="swiper-slide ${typeof video.product[0] == 'undefined' ? 'no-product-ssv' : ''} ${buynowBtn ? 'video-redirect-on-ssv' : ''}">
                            <div class="video-modal-video-container-ssv">
                                ...
                                <div class="video-modal-actions-ssv">                                           
                                    ...
                                    <button class="video-modal-download-ssv" title="Download Video" onclick="downloadVideossv('${video.video_url}')" style="${ssv_brandCustomizations.download_icon == '0' ? 'display: none !important;' : ''} background: rgb(0, 0, 0, .6) !important; display: none !important;">
                                ...
                                <div class="video-modal-share-modal-ssv">
                                    ...
                                    <a href="https://twitter.com/share?url=${ssv_store}?ssv=${window.btoa(video.video_id)}" target="_blank"><img class="video-modal-share-modal-social-ssv" src="https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/assets/images/goswirl-webp/twitter-x-logo.webp" alt="Twitter icon" title="Share on Twitter"></a>
            ...
            jqTag = document.createElement('script');
            jqTag.rel = 'text/javascript';
            jqTag.src = 'https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/short_video/magneto/v10/custom_submodule-v10.min.js';
            document.body.insertBefore(jqTag, document.body.lastChild);
        });
    });