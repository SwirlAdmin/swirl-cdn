...
let ssv_productIds = [];
let ssv_apiURL = 'https://api.goswirl/index.php/ShortVideo/videolistingV4'; // bigleap.live  ,  api.goswirl.live
...
require([
    ...
    function ($, Swiper, gumlet, intlTelInput, app, firebase, auth, firestore) {
        $(document).ready(function () {
                ...
                videos.forEach(video => {
                    ...
                    if (typeof video.product[0] != 'undefined') {
                        if (Object.keys(video.product).length > 1) {
                            ...
                            video.product.forEach(product => {
                                ...
                                productTile += `
                                    <div class="swiper-slide-pt">                        
                                        <div class="video-modal-product-tile-ssv" ${ssv_brandCustomizations.cta_on_tile == '0' ? 'onclick="openListProductssv(this, ' + pi + ');"' : ''}>
                                ...
                                pl += `
                                    <div class="product-list-block-ssv" ${ssv_brandCustomizations.cta_on_tile == '0' ? 'onclick="openListProductssv(this, ' + pi + ');"' : ''}>
                                        ...
                                        <div class="product-list-block-open-ssv">
                                            <img src="https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn@latest/assets/images/previous-arrow.svg" alt="Previous icon" ${ssv_brandCustomizations.cta_on_tile == '1' ? 'onclick="openListProductssv(this, ' + pi + ');"' : ''}>
                                        </div>
                                    </div>
                                `;
                            ...
                            productTile = `
                                <div class="video-modal-product-tile-ssv" ${ssv_brandCustomizations.cta_on_tile == '0' ? 'onclick="openProductssv(this);"' : ''}>
                                    <div class="product-info-pt-ssv" style="${ssv_brandCustomizations.product_tile_cta_btn == '0' || ssv_brandCustomizations.cta_on_tile == '1' ? 'width: 100% !important;' : ''}">
                                        <div class="product-image-pt-ssv" style="${ssv_brandCustomizations.mobile_product_tile_img == '1' ? 'display: block !important;' : ''}">
                                            <img alt="Product Image"
            ...
            jqTag = document.createElement('script');
            jqTag.rel = 'text/javascript';
            jqTag.src = 'https://goswirl.shop/swirl-embed/short-videos-carousel/magento/v12/custom_submodule.js';
            document.body.insertBefore(jqTag, document.body.lastChild);
        });
    });