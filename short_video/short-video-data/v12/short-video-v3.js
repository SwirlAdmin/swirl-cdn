...
let ssv_baseURL =
  ssv_mode === "Live"
    ? "https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/short_video/v12/swirl-style-v67.min.css"
    : "";
...
function generatessv(videos) {
  ...
  jQuery.ajax({
    ...
    dataType: "json",
    crossorigin: true,
    url: "https://goswirl.world:3001/getTotalViewsByVideoId",
    data: { video_ids: videoIds.join(",") },
    success: function (data) {
      swirlViews = data.swirl_views || [];
    },
    ...
    Promise.all(updatedData)
      .then(async (modifiedData) => {
        ...
        await fetch("https://goswirl.world:3001/insertVideoData", {
          ...
          body: JSON.stringify({ payloads: modifiedData }),
        })
          .then((response) => {
            videoDataArray = [];
            if (!response.ok) {
