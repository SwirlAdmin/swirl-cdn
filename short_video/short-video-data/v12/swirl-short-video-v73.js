...
let ssv_baseURL =
  ssv_mode === "Live"
    ? "https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/short_video/v12/swirl-style-v73.min.css"
    : "";
...
async function initializeVideoData(videoId, videoUrl) {
  ...
  const existingVideoData = videoDataArray.find((data) => data.url == videoUrl);
