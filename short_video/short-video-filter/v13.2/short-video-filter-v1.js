...
(() => {
    ...
    jqTag.href = !window.location.href.includes('short-videos-carousel/v13.2') ? 'https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/short_video/short-video-filter/v13.2/style-v1.min.css' : 'style.css';
