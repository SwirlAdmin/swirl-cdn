...
(() => {
    ...
    jqTag.href = window.location.href.includes('short-videos-carousel/v13') ?
        ...
        document.querySelector('script[src="https://goswirl.shop/swirl-embed/short-videos-carousel/v13.2/swirl-embed.js"]') ?
            ...
            'https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/short_video/short-video-filter/v13.2/style-v6.min.css';
...
function initssv13() {
    ...
    if (ssv13_storeCode || ssv13_pipMode) {
        fetch(`https://api.goswirl.live/index.php/ShortVideo/getFiltersv13_2?sCode=${ssv13_storeCode}&limit=${ssv13_videoPerPage}`, requestOptions)
...
function filterVideossv13() {
    ...
    if (vIds || pIds) {
        ...
        fetch(`https://api.goswirl.live/index.php/ShortVideo/getFilteredVideosv13_2?brandId=${ssv13_brandCustomizations.brand_id}&videoIds=${vIds}&productIds=${pIds}&limit=${ssv13_videoPerPage}&page=${pageNo}`, requestOptions).then(response => response.text()).then(result => {
            let data = JSON.parse(result);
