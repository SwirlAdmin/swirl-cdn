...
function initssv13() {
    ...
    if (ssv13_storeCode || ssv13_pipMode) {
        fetch(`https://bigleap.live/index.php/ShortVideo/getFiltersv13?sCode=${ssv13_storeCode}`, requestOptions)
            ...
            .then(result => {
                ...
                generatessv13(data.data.video, ssv13_masterDiv, 0);
...
function generateFilterssv13(filter, product, target, no) {
    ...
    if (Object.keys(product).length) {
        ...
        <select id="ssvProductsFilter" name="ssvProductsFilter" data-placeholder="Search" data-max="3" data-select-all="false" multiple data-ssvmulti-select>`;
        product.forEach(p => {
    ...
    filterHTML += `</div><button style="display: none !important;" id="filters-master-form-submit-ssv13"></button></form>`
...
function filterVideossv13() {
    ...
    if (fValues || pIds) {
        ...
        fetch(`https://bigleap.live/index.php/ShortVideo/getFilteredVideosv13?brandId=${ssv13_brandCustomizations.brand_id}&filter=${fValues}&productIds=${pIds}`, requestOptions).then(response => response.text()).then(result => {
            let data = JSON.parse(result);
        ...
        generatessv13(ssv13_responseData.data.video, ssv13_masterDiv, 0);
    }
}
    ...
    videos.forEach(video => {
        ...
        video.product.forEach(prd => {
                    ...
                    <div class="video-modal-ps-card-ssv13"
                        ...
                        <div class="video-modal-ps-detail-ssv13">
                            ...
                            <div class="video-modal-ps-cta-ssv13" style="${ssv13_brandCustomizations.cta_on_tile == '0' ? 'display: none !important;' : ''}">
                                <button style="${ssv13_brandCustomizations.add_to_cart == '0' ? 'width: 100% !important;' : ''} background: ${videoBuyBG} !important; color: ${videoBuyFont} !important; ${ssv13_brandCustomizations.buy_now == '0' ? 'display: none !important;' : ''}" onclick="CTAClickssv13(${prd.product_id}, ${video.designer_id}, ${video.video_id}, '1'); window.location='${prd.url}';"
                                ...
                                <button style="${ssv13_brandCustomizations.buy_now == '0' ? 'width: 100% !important;' : ''} ${ssv13_brandCustomizations.add_to_cart == '0' ? 'display: none !important;' : ''}" onclick="CTAClickssv13(${prd.product_id}, ${video.designer_id}, ${video.video_id}, '2'); addtocartssv13(${video.video_id}, ${prd.product_id}, '${prd.sku_code}', this, 1);"
            ...
            if (Object.keys(prd.pReviews).length) {
                ...
                mReviewSlider += `
                <p style="text-align: center; margin: 0 !important; color: #8B8B8E; font-size: 14px; position: absolute; width: 100%; top: calc(50% - 24px);">
        ...
        mSlides += `
            <div class="swiper-slide swiper-slide-m">
                <div class="video-modal-sl-video-container-ssv ${!Object.keys(video.product).length ? 'no-products-slide-ssv13' : ''}">
                    <video id="ssv13-video-m-${video.video_id}" data-src="${video.server_url}" data-products="${Object.keys(video.product).length}" class="video-modal-sl-video-ssv13"
                    ...
                    <button class="video-cta-redi-button-ssv13" style="background: ${videoBuyBG} !important; color: ${videoBuyFont} !important; ${ssv13_brandCustomizations.buy_now == '0' || !videoCTA ? 'display: none !important;' : ''}" onclick="CTAClickssv13('0', ${video.designer_id}, ${video.video_id}, '1'); window.open('${video.product_link}', '_blank');">
                        ${video.cta_customization ? video.cta_customization : ssv13_brandCustomizations.buy_btn}
                    </button>
                        ...
                        <div class="video-modal-structure-right-ssv13">
                            ...
                            <div class="video-modal-cart-popup-ssv13">
                                ...
                                <div class="cart-popup-flex-ssv13">
                                    <button class="cart-popup-btn-viewcart-ssv13" onclick="window.location='${ssv13_storeURL}/${ssv13_brandCustomizations.cust_cart_redirection_link}'">
                                        ${ssv13_brandCustomizations.view_cart_txt}
                                    </button>
                                    <button class="cart-popup-btn-continue-ssv13" onclick="closeCartPopupssv13();" style="background: ${ssv13_brandCustomizations.bk_color_buy_btn} !important; color: ${ssv13_brandCustomizations.front_color_buy_btn} !important;">
        ...
        ssv13_swiper_product[`sw${video.video_id}-${no}`] = new Swiper(`.swiper-product-ssv13-${video.video_id}-${no}`, {
            ...
            on: {
                slideChange: function () {
                    ...
                    ssv13_swiper_review[`sw${video.video_id}-${no}`].slideTo(activeInd);
                }
            }
        });
...
function closePopupssv13(bg) {
    if (window.getComputedStyle(bg.closest('.video-modal-sl-video-container-ssv').querySelector('.video-modal-share-popup-ssv13')).transform == 'matrix(1, 0, 0, 1, 0, 0)') {
        if (window.innerWidth > 768) {
            bg.closest('.video-modal-sl-video-container-ssv').querySelector('.video-modal-share-popup-ssv13').style.transform = 'translateY(calc(-110% - 50px))';
        } else {
...
function openReviewSliderssv13(btn) {
    ...
    btn.closest('.video-modal-sl-video-container-ssv').querySelector('.video-modal-pr-bottom-ssv13').scrollTop = 0;
