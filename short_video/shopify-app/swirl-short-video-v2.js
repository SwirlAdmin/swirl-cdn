        ...
        videos.forEach(video => {
            ...
            if (shopifyProduct) {
                if (Object.keys(shopifyProduct).length > 1) {
                    ...
                    shopifyProduct[0].compare_at_price = shopifyProduct[0].compare_at_price ? shopifyProduct[0].compare_at_price : shopifyProduct[0].price, shopifyProduct[0].description = shopifyProduct[0].description ? shopifyProduct[0].description : '';
                    let productVariantSelection = '';
