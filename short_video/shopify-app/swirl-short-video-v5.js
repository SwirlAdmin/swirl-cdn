                        ...
                        <div class="video-modal-product-tile-ssv" onclick="openProductssv(this);">
                            <div class="product-info-pt-ssv" style="${ssv_brandCustomizations.product_tile_cta_btn == '0' ? 'style="width: 100% !important;"' : ''}">
                                ...
                                <div class="product-detail-pt-ssv" style="${ssv_brandCustomizations.mobile_product_tile_img == '1' ? 'width: calc(100% - 75px) !important;' : ''}">
                                    ...
                                    <label ${ssv_brandCustomizations.product_price_status == '0' ? 'style="display: none !important;"' : ''}>${ssv_brandCustomizations.currencySymbol}${(shopifyProduct[0].price).toFixed(2)} <strike ${parseFloat((shopifyProduct[0].compare_at_price / 100).toFixed(2)) > parseFloat((shopifyProduct[0].price).toFixed(2)) ? '' : 'style="display: none;"'}>${ssv_brandCustomizations.currencySymbol}${(shopifyProduct[0].compare_at_price / 100).toFixed(2)}</strike>
                                        <br><span ${parseFloat((shopifyProduct[0].compare_at_price / 100).toFixed(2)) > parseFloat((shopifyProduct[0].price).toFixed(2)) ? '' : 'style="display: none;"'}>${parseFloat((shopifyProduct[0].compare_at_price / 100).toFixed(2)) > parseFloat((shopifyProduct[0].price).toFixed(2)) ? Math.round((((shopifyProduct[0].compare_at_price / 100).toFixed(2) - (shopifyProduct[0].price).toFixed(2)) * 100) / (shopifyProduct[0].compare_at_price / 100).toFixed(2)) : ''}% OFF</span></label>
                                </div>
                            </div>
                            <div class="product-buy-btn-pt-ssv" style="${ssv_brandCustomizations.product_tile_cta_btn == '0' ? 'style="display: none !important;"' : ''}">
                                <button style="background: ${ssv_brandCustomizations.bk_color_buy_btn} !important; color: ${ssv_brandCustomizations.front_color_buy_btn} !important;">
                            ...
                            <div class="product-middle-pb-ssv">                            
                                <div class="product-detail-pb-ssv">
                                    ...
                                    <div class="product-detail-block-pb-ssv">
                                        ...
                                        <section>${shopifyProduct[0].description}</section>
                                        <label ${ssv_brandCustomizations.product_price_status == '0' ? 'style="display: none !important;"' : ''}>${ssv_brandCustomizations.currencySymbol}${(shopifyProduct[0].price).toFixed(2)} <strike ${parseFloat((shopifyProduct[0].compare_at_price / 100).toFixed(2)) > parseFloat((shopifyProduct[0].price).toFixed(2)) ? '' : 'style="display: none;"'}>${ssv_brandCustomizations.currencySymbol}${(shopifyProduct[0].compare_at_price / 100).toFixed(2)}</strike>
                                            <span ${parseFloat((shopifyProduct[0].compare_at_price / 100).toFixed(2)) > parseFloat((shopifyProduct[0].price).toFixed(2)) ? '' : 'style="display: none;"'}>${parseFloat((shopifyProduct[0].compare_at_price / 100).toFixed(2)) > parseFloat((shopifyProduct[0].price).toFixed(2)) ? Math.round((((shopifyProduct[0].compare_at_price / 100).toFixed(2) - (shopifyProduct[0].price).toFixed(2)) * 100) / (shopifyProduct[0].compare_at_price / 100).toFixed(2)) : ''}% OFF</span></label>
                                    </div>
                                </div>                            
                                <div class="product-desc-pb-ssv">
                                    <p>Product Details</p>
