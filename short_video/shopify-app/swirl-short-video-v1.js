...
let ssv_baseURL = ssv_mode === 'Live' ? 'https://apigoswirl.com/short_video/shopify/style.min.css' : '';
let ssv_responseData = [];
let ssv_IdProducts = [];
let ssv_handleProducts = [];
let ssv_videoProducts = [];
let ssv_apiURL = 'https://api.goswirl.live/index.php/APIv1/shopifyApp/getPlaylistVideos'; // bigleap.live  ,  api.goswirl.live
let ssv_pdpapiURL = 'https://api.goswirl.live/index.php/APIv1/shopifyApp/getPDPVideos'; // bigleap.live  ,  api.goswirl.live
    ...
    getAllShopifyProductssv(allHandles).then(responses => {
        ...
        videos.forEach(video => {
            ...
            if (!ssv_pip && !ssv_pdppipHideOnscreen) {
                if (shopifyProduct) shopifyProduct[0].compare_at_price = shopifyProduct[0].compare_at_price ? shopifyProduct[0].compare_at_price : shopifyProduct[0].price, shopifyProduct[0].description = shopifyProduct[0].description ? shopifyProduct[0].description : '';
                let outerProduct = shopifyProduct ? `
                    <div class="product-on-carousel-ssv" ${ssv_brandCustomizations.product_blog_img == '0' ? 'style="display: none !important;"' : ''}>                                    
                        ...
                        <label ${ssv_brandCustomizations.product_price_status == '0' ? 'style="display: none !important;"' : ''}>$ ${(shopifyProduct[0].compare_at_price / 100).toFixed(2)} <strike ${parseFloat((shopifyProduct[0].price / 100).toFixed(2)) > parseFloat((shopifyProduct[0].compare_at_price / 100).toFixed(2)) ? '' : 'style="display: none;"'}>$ ${(shopifyProduct[0].price / 100).toFixed(2)}</strike>
                            <br><span ${parseFloat((shopifyProduct[0].price / 100).toFixed(2)) > parseFloat((shopifyProduct[0].compare_at_price / 100).toFixed(2)) ? '' : 'style="display: none;"'}>${parseFloat((shopifyProduct[0].price / 100).toFixed(2)) > parseFloat((shopifyProduct[0].compare_at_price / 100).toFixed(2)) ? Math.round((((shopifyProduct[0].price / 100).toFixed(2) - (shopifyProduct[0].compare_at_price / 100).toFixed(2)) * 100) / (shopifyProduct[0].price / 100).toFixed(2)) : ''}% OFF</span></label>
                    </div>
                ` : `
            ...
            if (shopifyProduct) {
                if (Object.keys(shopifyProduct).length > 1) {
                    ...
                    shopifyProduct.forEach(product => {
                        product.compare_at_price = product.compare_at_price ? product.compare_at_price : product.price, product.description = product.description ? product.description : '';
                        pi++;
                            ...
                            <div class="video-modal-product-tile-ssv" onclick="openListProductssv(this, ${pi});">
                                <div class="product-info-pt-ssv" style="${ssv_brandCustomizations.product_tile_cta_btn == '0' ? 'style="width: 100% !important;"' : ''}">
                                    ...
                                    <div class="product-detail-pt-ssv" style="${ssv_brandCustomizations.mobile_product_tile_img == '1' ? 'width: calc(100% - 75px) !important;' : ''}">
                                        ...
                                        <label ${ssv_brandCustomizations.product_price_status == '0' ? 'style="display: none !important;"' : ''}>$ ${(product.compare_at_price / 100).toFixed(2)} <strike ${parseFloat((product.price / 100).toFixed(2)) > parseFloat((product.compare_at_price / 100).toFixed(2)) ? '' : 'style="display: none;"'}>$ ${(product.price / 100).toFixed(2)}</strike>
                                            <br><span ${parseFloat((product.price / 100).toFixed(2)) > parseFloat((product.compare_at_price / 100).toFixed(2)) ? '' : 'style="display: none;"'}>${parseFloat((product.price / 100).toFixed(2)) > parseFloat((product.compare_at_price / 100).toFixed(2)) ? Math.round((((product.price / 100).toFixed(2) - (product.compare_at_price / 100).toFixed(2)) * 100) / (product.price / 100).toFixed(2)) : ''}% OFF</span></label>
                                    </div>
                                </div>
                        ...
                        pl += `
                            <div class="product-list-block-ssv" onclick="openListProductssv(this, ${pi});">
                                ...
                                <div class="product-list-block-detail-ssv">
                                    ...
                                    <section>${product.description}</section>
                                    <label ${ssv_brandCustomizations.product_price_status == '0' ? 'style="display: none !important;"' : ''}>$ ${(product.compare_at_price / 100).toFixed(2)} <strike ${parseFloat((product.price / 100).toFixed(2)) > parseFloat((product.compare_at_price / 100).toFixed(2)) ? '' : 'style="display: none;"'}>$ ${(product.price / 100).toFixed(2)}</strike>
                                        <span ${parseFloat((product.price / 100).toFixed(2)) > parseFloat((product.compare_at_price / 100).toFixed(2)) ? '' : 'style="display: none;"'}>${parseFloat((product.price / 100).toFixed(2)) > parseFloat((product.compare_at_price / 100).toFixed(2)) ? Math.round((((product.price / 100).toFixed(2) - (product.compare_at_price / 100).toFixed(2)) * 100) / (product.price / 100).toFixed(2)) : ''}% OFF</span></label>
                                </div>
                        ...
                        <div class="video-modal-product-tile-ssv" onclick="openProductssv(this);">
                            <div class="product-info-pt-ssv" style="${ssv_brandCustomizations.product_tile_cta_btn == '0' ? 'style="width: 100% !important;"' : ''}">
                                ...
                                <div class="product-detail-pt-ssv" style="${ssv_brandCustomizations.mobile_product_tile_img == '1' ? 'width: calc(100% - 75px) !important;' : ''}">
                                    ...
                                    <label ${ssv_brandCustomizations.product_price_status == '0' ? 'style="display: none !important;"' : ''}>$ ${(shopifyProduct[0].compare_at_price).toFixed(2)} <strike ${parseFloat((shopifyProduct[0].price / 100).toFixed(2)) > parseFloat((shopifyProduct[0].compare_at_price).toFixed(2)) ? '' : 'style="display: none;"'}>$ ${(shopifyProduct[0].price / 100).toFixed(2)}</strike>
                                        <br><span ${parseFloat((shopifyProduct[0].price / 100).toFixed(2)) > parseFloat((shopifyProduct[0].compare_at_price).toFixed(2)) ? '' : 'style="display: none;"'}>${parseFloat((shopifyProduct[0].price / 100).toFixed(2)) > parseFloat((shopifyProduct[0].compare_at_price).toFixed(2)) ? Math.round((((shopifyProduct[0].price / 100).toFixed(2) - (shopifyProduct[0].compare_at_price).toFixed(2)) * 100) / (shopifyProduct[0].price / 100).toFixed(2)) : ''}% OFF</span></label>
                                </div>
                            </div>
                            <div class="product-buy-btn-pt-ssv" style="${ssv_brandCustomizations.product_tile_cta_btn == '0' ? 'style="display: none !important;"' : ''}">
                                <button style="background: ${ssv_brandCustomizations.bk_color_buy_btn} !important; color: ${ssv_brandCustomizations.front_color_buy_btn} !important;">
                            ...
                            <div class="product-middle-pb-ssv">                            
                                <div class="product-detail-pb-ssv">
                                    ...
                                    <div class="product-detail-block-pb-ssv">
                                        ...
                                        <section>${shopifyProduct[0].description}</section>
                                        <label ${ssv_brandCustomizations.product_price_status == '0' ? 'style="display: none !important;"' : ''}>$ ${(shopifyProduct[0].compare_at_price).toFixed(2)} <strike ${parseFloat((shopifyProduct[0].price / 100).toFixed(2)) > parseFloat((shopifyProduct[0].compare_at_price).toFixed(2)) ? '' : 'style="display: none;"'}>$ ${(shopifyProduct[0].price / 100).toFixed(2)}</strike>
                                            <span ${parseFloat((shopifyProduct[0].price / 100).toFixed(2)) > parseFloat((shopifyProduct[0].compare_at_price).toFixed(2)) ? '' : 'style="display: none;"'}>${parseFloat((shopifyProduct[0].price / 100).toFixed(2)) > parseFloat((shopifyProduct[0].compare_at_price).toFixed(2)) ? Math.round((((shopifyProduct[0].price / 100).toFixed(2) - (shopifyProduct[0].compare_at_price).toFixed(2)) * 100) / (shopifyProduct[0].price / 100).toFixed(2)) : ''}% OFF</span></label>
                                    </div>
                                </div>                            
                                <div class="product-desc-pb-ssv">
                                    <p>Product Details</p>
                ...
                <div class="swiper-slide ${!shopifyProduct ? 'no-product-ssv' : ''} ${buynowBtn ? 'video-redirect-on-ssv' : ''}">
                    <div class="video-modal-video-container-ssv">
                        ...
                        <div class="video-modal-actions-ssv">
                            <div class="SWIRLhearts ${ssv_brandCustomizations.ask_question == '0' ? 'askoff' : ''}"></div>                
                            <button class="video-modal-like-ssv ${ssv_brandCustomizations.ask_question == '0' ? 'askoff' : ''}" title="Like" onclick="likeVideossv(this, ${video.video_id}, ${video.designer_id});" style="background: rgb(0, 0, 0, .6) !important;">
        ...
        videos.forEach(video => {
            ...
            // Old code - Needs to be update in loopin for multiple products
            // if (typeof shopifyProduct[0] != 'undefined') {
            //     // Append reviews 
            //     if (ssv_storeType == '2' && shopifyProduct[0].brand_product_id && ssv_brandCustomizations.stamped === 1) {
            //         var url = `https://stamped.io/api/widget/reviews?productId=${shopifyProduct[0].brand_product_id}&minRating&page&storeUrl=${ssv_brandCustomizations.store_url}&apiKey=${ssv_brandCustomizations.api_key}`
