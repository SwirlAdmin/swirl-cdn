...
(function () {
    ...
    if (localStorage.getItem('SSVallURL') && localStorage.getItem('SSVlastPlayed') && document.querySelector('#swirl-short-videos') == null) {
        ...
        jqTag.href = 'https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/short_video/v7/swirl-short-videos.min.css';
                ...
                <div id="SSV-short-videos">
                    ...
                    <div class="SSV-play-modal">                
                        <div class="SSV-play-modal-video-container">
                            <video id="gumlet-video-count" loop ontimeupdate="updateSSVModalProgressBar(this);" onloadeddata="updateSSVModalInfos(this);"  playsinline preload="metadata" data-setup="{}" >
