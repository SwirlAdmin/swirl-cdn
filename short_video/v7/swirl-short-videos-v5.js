...
(function () {
    if (localStorage.getItem('SSVallURL') && localStorage.getItem('SSVlastPlayed') && document.querySelector('#swirl-short-videos') == null) {
        ...
        jqTag.href = 'https://apigoswirl.com/short_video/v7/single_page/swirl-short-videos-v5.min.css';
                        ...
                        if (typeof data['swilrs']['video'] != 'undefined') {
                            ...
                            data['swilrs']['video'].forEach(swirl => {
                                ...
                                if (Object.keys(swirl['product']).length > 0) {
                                    ...
                                    strikePrice = brandCustomizations['product_price_status'] ? strikePrice : '';
...
function updateSSVModalInfos(player) {
    ...
    jQuery('.SSV-pm-buy-now').css('border-color', brandCustomizations['bk_color_buy_btn']);
    jQuery('.SSV-pmm-buy-now').css('background', brandCustomizations['bk_color_buy_btn']);
    jQuery('.SSV-pmm-buy-now').css('border-color', brandCustomizations['bk_color_buy_btn']);
    ...
    let title = jQuery(`.swiper-wrapper video[data-videourl="${video}"]`).length ? jQuery(`.swiper-wrapper video[data-videourl="${video}"]`).attr('data-title') : PIPvideoData['title'];
    ...
    // Product if attached
    let vid = jQuery(`.swiper-wrapper video[data-videourl="${video}"]`).length ? jQuery(`.swiper-wrapper video[data-videourl="${video}"]`).attr('data-vid') : PIPvideoData['vid'];
    ...
    if (Object.keys(products).length > 0) {
        ...
        let rLink = jQuery(`.swiper-wrapper video[data-videourl="${video}"]`).length ? jQuery(`.swiper-wrapper video[data-videourl="${video}"]`).attr('data-productlink') : PIPvideoData['productlink'];
        if (rLink) {
    ...
    if (brandCustomizations['pip_mode'] === '1') {
        ...
        if (jQuery(`.swiper-wrapper video[data-videourl="${video}"]`).length) {
            let vData = jQuery(`.swiper-wrapper video[data-videourl="${video}"]`).data();
...
function SSVaskQuestion(form) {
    ...
    if (SWIRLuser) {
        ...
        let swirlId = jQuery(`.swiper-wrapper video[data-videourl="${SSVCurrentURL}"]`).attr('data-vid');
