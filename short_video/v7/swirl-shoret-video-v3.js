...
(function () {
    ...
    if (localStorage.getItem('SSVallURL') && localStorage.getItem('SSVlastPlayed') && document.querySelector('#swirl-short-videos') == null) {
        ...
        jqTag.href = 'https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/short_video/v7/swirl-short-videos-v3.min.css';
        ...
        function executeNow() {
            ...
            `);
                ...
                urlPass = "https://bigleap.live/index.php/shopify/videolistingV2?user=" + code;
