...
function initssv13() {
    ...
    apiCall = ssv13_pdppip ? 'https://pdp-reviews-api.goswirl.in/api/product/reviews/playlist' : 'https://api.goswirl.live/index.php/ShortVideo/getVideosv13';
    ...
    if (ssv13_pipMode && !ssv13_storePlaylist && localStorage.getItem('ssv13_pdppip')) {
        ...
        apiCall = 'https://pdp-reviews-api.goswirl.in/api/product/reviews/playlist';
    }
...
function searchVideos(frm) {
    ...
    let apiCall = 'https://pdp-reviews-api.goswirl.in/api/product/reviews/playlist';
    let cUrl = window.location.href;
    cUrl = cUrl.split('?')[0];
    cUrl = cUrl.split('#')[0];
    let myHeaders = new Headers();
