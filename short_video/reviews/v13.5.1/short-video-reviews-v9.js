    ...
    videos.forEach(video => {
        ...
        let cReview = ssv13_pdppip && ssv13_reviewId ? `
            <div class="video-c-bottom-reviews-ssv13">
                <div>${reviewStarsC[video.rating]}</div>
                <div class="video-c-bottom-review-text-ssv13">
                    <p>${video.c_name ? video.c_name : 'Anonymous'}</p>
                    <label>
        ...
        cSlides += `
            <div class="swiper-slide" onclick="openVideoModalssv13(${i}, ${no});">
                <video data-src="${video.cover_video}" data-srcf="${video.server_url}" data-id="${video.video_id}" class="carousel-video-ssv13 ${video.is_landscape == '0' ? 'JS-cvideo-L-ssv13' : 'JS-cvideo-P-ssv13'} ${videoConflictClass}" onplay="this.closest('.swiper-slide').querySelector('.carousel-video-play-ssv13').style.display='none';"
