...
(function () {    
    ...
    if (localStorage.getItem('SSVallURL') && localStorage.getItem('SSVlastPlayed') && document.querySelector('#swirl-short-videos') == null) {
        ...
        jqTag.href = 'https://forelsket.goswirl.live/assets/css/short-videos-dynamic.css';
        ...
        function executeNow1() {
                ...
                <div id="SWIRL-short-videos">
                    <div class="swiper" style="display: none!important;">
                        <div class="swiper-wrapper">
                            <p style="margin: 50px 0; padding: 10px; text-align: center; font-size: 20px; color: #999;display: block;width: 100%;">Loading... SWIRL Short Videos.</p>
                        </div>
            ...
            `);
                ...
                url = url.replace('#SWIRL-short-videos', '');
                url = url.replace('#', '');
                ...
                if (typeof SSVvideosAll['swilrs']['video'] != 'undefined') {
                    ...
                    SSVvideosAll['swilrs']['video'].forEach(swirl => {
                        ...
                        let coverPoster = swirl['image'] ? swirl['image'] : 'https://goswirl.shop/swirl-embed/assets/default-video-thumbnail.jpg';
                        ...
                        <video poster="${coverPoster}" ontimeupdate="updateSSVProgressBar(this);" onloadeddata="updateSSVDurations(this);" playsinline preload="metadata" data-setup="{}" muted ${firstFivePlay} width="100%" height="100%" data-product="${product_link}" data-title="${swirl['video_title']}" data-cover="${swirl['image']}" data-link="${swirl['link']}" data-vid="${swirl['video_id']}" data-did="${swirl['designer_id']}" data-productid="${product_id}" data-productlink="${product_link}" data-gumletassetid="${swirl['gumletAssetId']}" data-totalviews="${swirl['total_views']}">
                    ...
                    jQuery('#SWIRL-short-videos .swiper-wrapper').append(append);
                    ...
                    jQuery('.swiper-slide').click(function () {
                        window.location = '#SWIRL-short-videos';
                        ...
                        jQuery('.SSV-play-modal video').get(0).play().catch((e)=>{});
                    ...
                    jQuery('.close-SSV-modal').click(function () {
                        ...
                        // jQuery('.SSV-PIP video').get(0).play();
                        // jQuery('.SSV-PIP').show();
                    ...
                    jQuery('.SSV-play-modal-play-pause').click(function () {
                        ...
                        if (video.paused) {
                            // jQuery('.SSV-play-modal-play-pause').children('img').attr('src', 'https://goswirl.shop/swirl-embed/assets/pause.svg');
                            video.play();
                        } else {
                    ...
                    if (typeof params['ssv'] != 'undefined') {
                        ...
                        setTimeout(() => {
                            var elmnt = document.getElementById("SWIRL-short-videos");
        ...
        function executeNow() {
                ...
                <div id="SWIRL-short-videos">
                    ...
                    <div class="SSV-play-modal">                
                        <div class="SSV-play-modal-video-container">
                            ...
                            <div class="SSV-CTA-modal">          
                                <div class="SSV-OTP-send SSV-CTA-modal-inner">
                                    <label><div class="regi-label d-inline">Register Yourself </div><span style="font-family: arial;" title="Close">&times;</span></label>
                                    <p class="SSV-CTA-message"></p>
                                    <form onsubmit="return SSVsendOTP(this);">
                                    <input type="text" name="SSVuserName" placeholder="Name" class="SSVuserName" autocomplete="off" required>
                                    <div style="position: relative;" class="phone-and-code">
                                        <select name="SSVcountryCode" id="SSVcountryCode">
                                        <option data-countryCode="DZ" value="213">Algeria (+213)</option>
                                        <option data-countryCode="AD" value="376">Andorra (+376)</option>
                                        <option data-countryCode="AO" value="244">Angola (+244)</option>
                                        <option data-countryCode="AI" value="1264">Anguilla (+1264)</option>
                                        ...
                                        <input type="number" id="SSVcountryCode" name="SSVphoneNumber" placeholder="Phone Number" autocomplete="off" required>
                                    </div>
                                    <button><span class="btnregi">Register</span><p class="SSV-CTA-loader"></p></button>
                                    </form>
                                </div>
                                <div class="SSV-OTP-verification SSV-CTA-modal-inner">
                                    <label>Verify Yourself <span style="font-family: arial;" title="Close">&times;</span></label>
                                ...
                                <div class="SSV-ask-question SSV-CTA-modal-inner">
                                    <div>
                                    <label><div class="ask-label d-inline">Ask Question </div><span style="font-family: arial;" title="Close">&times;</span></label>
                                    <p class="SSV-CTA-message"></p>
                                    <form onsubmit="return SSVaskQuestion(this);">
                                    <textarea placeholder="Type here" name="SSVaskQue" class="SSVaskQue" rows="3" autocomplete="off" required></textarea>
                                    <button><span class="ask_send">Send</span><p class="SSV-CTA-loader"></p></button>
                                    </form>
                                    </div>
                                </div>
                            </div>
            ...
            `);
                ...
                url = url.replace('#SWIRL-short-videos', '');
                url = url.replace('#', '');
                let code = jQuery('#swirl-short-videos').data('designerid');
                ...
                let urlPass = '';
                urlPass = "https://forelsket.goswirl.live/index.php/shopify/videolisting_storefront?user=" + code;

                if (typeof jQuery('#swirl-short-videos').data('byshopify') != 'undefined') {
                    urlPass = 'https://store.goswirl.live/shopify-app/swirl_short_videos.php';
                }
                    ...
                    success: function (data) {
                        if (typeof data['swilrs']['video'] != 'undefined') {
                            ...
                            data['swilrs']['video'].forEach(swirl => {
                                ...
                                //translation text 
                                let piphover = data['swilrs']['translate']['pip'];  
                                let muteunmutehover = data['swilrs']['translate']['muteunmute'];    
                                let closehover = data['swilrs']['translate']['close'];  
                                let sharehover = data['swilrs']['translate']['share'];  
                                let askquehover = data['swilrs']['translate']['ask_que'];   
                                askquetitle = data['swilrs']['translate']['ask_que'];   
                                askque_msg = data['swilrs']['translate']['askque_msg']; 
                                askque_btn = data['swilrs']['translate']['askque_btn']; 
                                share_to = data['swilrs']['translate']['share_to']; 
                                let register_label = data['swilrs']['translate']['register_label']; 
                                let register_name = data['swilrs']['translate']['register_name'];   
                                let register_phone = data['swilrs']['translate']['register_phone']; 
                                let register_btn = data['swilrs']['translate']['register_btn']; 
                                let buynow_btn = data['swilrs']['translate']['buynow_btn']; 
                                console.log(buynow_btn);
                                jQuery(".SSV-play-modal-buynow-on").text(buynow_btn);   
                                jQuery(".SSV-pmm-buy-now").text(buynow_btn);    
                                jQuery(".SSV-pm-buy-now").text(buynow_btn); 
                                jQuery(".regi-label").text(register_label); 
                                jQuery(".SSVuserName").attr("placeholder",register_name);   
                                jQuery(".SSVphoneNumber").attr("placeholder",register_phone);   
                                jQuery(".btnregi").text(register_btn);  
                                jQuery(".SSV-play-modal-pip").attr("title",piphover);   
                                jQuery(".SSV-play-modal-mute-unmute").attr("title",muteunmutehover);    
                                jQuery(".close-SSV-modal").attr("title",closehover);    
                                jQuery(".SSV-play-modal-share").attr("title",sharehover);   
                                jQuery(".SSV-play-modal-askaque").attr("title",askquehover);
                                ...
                                append += `<div class="swiper-slide">
                                <video poster="${coverPoster}" ontimeupdate="updateSSVProgressBar(this);" onloadeddata="updateSSVDurations(this);" playsinline="playsinline" preload="metadata" data-setup="{}" muted ${firstFivePlay} width="100%" height="100%" data-product="${product_link}" data-title="${swirl['video_title']}" data-cover="${swirl['image']}" data-link="${swirl['link']}" data-vid="${swirl['video_id']}" data-did="${swirl['designer_id']}" data-productid="${product_id}"  data-gumletassetid="${swirl['gumlet_asset_id']}" data-totalviews="${swirl['total_views']}"  data-productlink="${product_link}">
                                    <source src="${swirl['video_url']}" type="video/mp4">
                                </video>
                                <div class="SSV-play-btn">
                                    <label></label>
                            ...
                            // jQuery('#SWIRL-short-videos .swiper-wrapper').empty();
                            jQuery('#SWIRL-short-videos .swiper-wrapper').html(append);
                            ...
                            jQuery('.swiper-slide').click(function () {
                                ...
                                let video = jQuery(this).children('video').children('source').attr('src');
                                let poster = jQuery(this).children('video').attr('data-cover');
                                let gumlet_asset_id = jQuery(this).children('video').attr('data-gumletassetid');
                                let total_views = jQuery(this).children('video').attr('data-totalviews');
                                ...
                                let proid = jQuery(this).children('video').attr('data-productid');
                                if(proid == '19894')
                                {
                                    jQuery('.SSV-pm-add-to-cart').html('Watch on Tata');
                                    jQuery('.SSV-pm-buy-now').html('Share Now');
                                }
                                disableScroll();
                                if(gumlet_asset_id != null){
                                    // Get total views
                                    var playerOptions = {
                                    preload: false
                                    };
                                    ...
                                    var player_id = document.getElementById('demovideo');  
                                    var gumletInsights = gumlet.insights(gumletConfig);
                                    gumletInsights.register(player_id);
                                    vid = jQuery(`.swiper-wrapper source[src="${video}"]`).parent('video').attr('data-vid');
                            ...
                            jQuery('.SSV-play-modal-share').click(function () {
                                jQuery('.SSV-video-popup-share').show();
                                jQuery(".SSV-video-popup-share p").text(share_to);
                                setTimeout(() => {
                                    jQuery('.SSV-video-popup-share').addClass('SSV-video-popup-share-cover');
                                }, 100);
                            });
                            ...
                            jQuery('.SSV-play-modal-askaque').click(function () {
                                ...
                                jQuery('.SSV-CTA-modal-inner').hide();
                                jQuery('.SSV-ask-question').show();
                                jQuery(".ask-label").text(askquetitle);
                                jQuery(".SSVaskQue").attr("placeholder",askque_msg);
                                jQuery(".ask_send").text(askque_btn);
                            });
        ...
        if (Object.keys(products).length === 1) {
            ...
            if (prodLink) {
                ...
                if (addedtoCart.includes(prodLink)) {
                    ...
                    jQuery('.SSV-pm-add-to-cart').html('Add to Cart');
                ...
                if(product['product_id'] == '19894')
                {
                    jQuery('.SSV-pm-add-to-cart').show();
                    jQuery('.SSV-pm-add-to-cart').html('Watch on Jio');
                    jQuery('.SSV-pm-add-to-cart').attr('data-action', '2');
                    prodLink = 'https://www.voot.com/shows/bigg-boss/100730';
                    jQuery('.SSV-play-modal-addtocart').attr('data-link', prodLink);
                    jQuery('.SSV-pm-buy-now').html('Watch on Voot');
                    jQuery('.SSV-play-modal-addtocart').attr('data-link', prodLink); 
                }


                if(product['product_id'] == '20454')
                {
                    jQuery('.SSV-pm-add-to-cart').show();
                    jQuery('.SSV-pm-add-to-cart').html('Contact');
                    jQuery('.SSV-pm-add-to-cart').attr('data-action', '2');
                    jQuery('.SSV-play-modal-addtocart').attr('data-link','https://api.whatsapp.com/send/?phone=919810128617&text&type=phone_number&app_absent=0Reach');
                    jQuery('.SSV-pm-buy-now').html('View Details');
                    jQuery('.SSV-pm-buy-now').attr('data-link', 'https://img.staticmb.com/mbimages/project/1468920497284unity-the-amaryllis-e-brochure.pdf'); 
                }



                if(product['product_id'] == '19890')
                {
                    jQuery('.SSV-pm-add-to-cart').show();
                    jQuery('.SSV-pm-add-to-cart').html('Watch on Tata');
                    jQuery('.SSV-pm-add-to-cart').attr('data-action', '2');
                    prodLink = 'https://play.google.com/store/apps/details?id=com.tatasky.binge';
                    jQuery('.SSV-play-modal-addtocart').attr('data-link', prodLink);
                    jQuery('.SSV-pm-buy-now').html('Share Now');
                    prodLink1 = 'https://twitter.com/BeingSalmanKhan?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor';
                    jQuery('.SSV-play-modal-addtocart').attr('data-link', prodLink1); 
                } 
                if(product['product_id'] == '20335')
                {
                    jQuery('.SSV-pm-add-to-cart').show();
                    jQuery('.SSV-pm-add-to-cart').html('Apply Now');
                    jQuery('.SSV-pm-add-to-cart').attr('data-action', '2');
                    prodLink = 'https://www.emiratesnbd.com/en/private-banking/contact-us/?src=footer';
                    jQuery('.SSV-play-modal-addtocart').attr('data-link', prodLink);
                    jQuery('.SSV-pm-buy-now').html('Talk to us');
                    prodLink1 = 'https://beta.emiratesnbd.com/en/help-and-support/contact-us';
                    jQuery('.SSV-pm-buy-now').attr('data-link', prodLink1); 
                }

                if(product['product_id'] == '59742')
                {
                    jQuery('.SSV-pm-buy-now').html('Book a tour');
                    prodLink1 = 'https://www.krahejacorphomes.com/project/2-bhk-flats-in-nibm-pune/';
                    jQuery('.SSV-pm-buy-now').attr('data-link', prodLink1); 
                }
...
function openMultiProductDetail(prodElem) {
    ...
    if (prodLink) {
        ...
        if (addedtoCart.includes(prodLink)) {
            ...
            jQuery('.SSV-pmm-add-to-cart').html('Add to Cart');
...
function SSVaddToCart(link, btn) {
    ...
    jQuery.ajax({
        ...
        if (product) {
            ...
            jQuery(btn).html('Failed').delay(3000).html('Add to Cart');
        }
    });
}
