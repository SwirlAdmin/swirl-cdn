                ...
                <div id="SWIRL-short-videos">
                    ...
                    <div class="SSV-play-modal">                
                        <div class="SSV-play-modal-video-container">
                            <video loop ontimeupdate="updateSSVModalProgressBar(this);" onloadeddata="updateSSVModalInfos(this);" playsinline="playsinline" preload="metadata" data-setup="{}" >
            ...
            `);
                ...
                if (typeof SSVvideosAll['swilrs']['video'] != 'undefined') {
                    ...
                    SSVvideosAll['swilrs']['video'].forEach(swirl => {
                        ...
                        <video poster="${coverPoster}" ontimeupdate="updateSSVProgressBar(this);" onloadeddata="updateSSVDurations(this);" playsinline="playsinline" preload="metadata" data-setup="{}" muted ${firstFivePlay} width="100%" height="100%" data-product="${product_link}" data-title="${swirl['video_title']}" data-cover="${swirl['image']}" data-link="${swirl['link']}" data-vid="${swirl['video_id']}" data-did="${swirl['designer_id']}" data-productid="${product_id}" >
                    ...
                    jQuery('.swiper-slide').click(function () {
                        ...
                        jQuery('.SSV-play-modal video').get(0).play();
        ...
        function executeNow() {
            ...
            jQuery(document).ready(function () {
                ...
                <div id="SWIRL-short-videos">
                    ...
                    <div class="SSV-play-modal">                
                        <div class="SSV-play-modal-video-container">
                            <video id="demovideo" loop ontimeupdate="updateSSVModalProgressBar(this);" onloadeddata="updateSSVModalInfos(this);" playsinline="playsinline" preload="metadata" data-setup="{}" >
                                <source src="" type="video/mp4">
                            </video>
                    ...
                    success: function (data) {
                        if (typeof data['swilrs']['video'] != 'undefined') {
                            ...
                            data['swilrs']['video'].forEach(swirl => {
                                ...
                                append += `<div class="swiper-slide">
                                <video poster="${coverPoster}" ontimeupdate="updateSSVProgressBar(this);" onloadeddata="updateSSVDurations(this);" playsinline="playsinline" preload="metadata" data-setup="{}" muted ${firstFivePlay} width="100%" height="100%" data-product="${product_link}" data-title="${swirl['video_title']}" data-cover="${swirl['image']}" data-link="${swirl['link']}" data-vid="${swirl['video_id']}" data-did="${swirl['designer_id']}" data-productid="${product_id}"  data-gumletassetid="${swirl['gumlet_asset_id']}" data-totalviews="${swirl['total_views']}">
                                    <source src="${swirl['video_url']}" type="video/mp4">
                                </video>
                                <div class="SSV-play-btn">
                                    <label></label>
...
function updateSSVModalInfos(player) {
    ...
    if (Object.keys(products).length > 0) {
        ...
        if(product['product_id'] == '19894')
        {
            jQuery('.SSV-play-modal-buynow-on').text('Download');       
        }
