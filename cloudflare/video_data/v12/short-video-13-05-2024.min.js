...
let ssv_baseURL =
  ssv_mode === "Live"
    ? "https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/short_video/v12/swirl-style-v76.min.css"
    : "";
...
async function impressionCount(brand_id, playlistCode, videoidsArray) {
      ...
      jQuery.ajax({
        ...
        success: function (data) {
          ...
          if (
            ...
            console.log("295----", ssv_responseData.swilrs.video);
            impressionCount(
              ssv_responseData.swilrs.data.brand_id,
              ssv_storePlaylist,
              ssv_responseData.swilrs.video.map((item) => item.video_id)
            );
          } else if (
            ...
            console.log("345----", ssv_responseData.swilrs);
          } else {
  ...
  videos.forEach((video) => {
    ...
    if (!ssv_pip && !ssv_pdppipHideOnscreen) {
      ...
      let outerProduct = outerProductCheck
        ? `
            ...
            ssv_brandCustomizations.front_color_buy_btn
                    ...
                    <label class="dynamic-price-ssv-${
                      outerProductFinal.product_id
                    }" style="${
            ssv_brandCustomizations.product_price_status == "0"
              ? "display: none !important;"
              : ""
          } color:${ssv_brandCustomizations.dis_fk_color} !important;">${
      ...
      onpageSlides += `
        ...
        ssv_brandCustomizations.product_blog_img == "0" || !outerProductCheck
          ...
          : ""
      } class="carousel-video-ssv ${
        video.is_landscape == "0"
          ? "landscape-video-c-ssv"
          : "potrait-video-c-ssv"
      }" poster="${video.cover_image}" ${
        ssv_brandCustomizations["auto_play"] === "1" && i < 5 ? "autoplay" : ""
                    ...
                    ${outerProduct}
                    <p class="video-title-ssv" style="${
                      ssv_brandCustomizations.video_title == "0" ||
      ...
      if (Object.keys(video.product).length > 1) {
        ...
        video.product.forEach((product) => {
          ...
          let moredetails =
            ssv_storeType == "6"
              ? `
                        <a class="ontile-addtocart-ssv ga-tracking-size-ssv" data-ssv-product-id="${
                          product.sku_code
                        }" onclick="jQuery(this).parents('.frommoredetail').click();" style="background: none !important; border: 2px solid ${
                  ssv_brandCustomizations.front_color_add_to_cart_btn
                } !important; color: ${
                  ssv_brandCustomizations.front_color_add_to_cart_btn
                } !important; ${
                  ...
                  ssv_brandCustomizations.buy_now == "0"
                    ...
                    `
              : `
                        <a class="ontile-addtocart-ssv ga-tracking-cart-ssv" data-ssv-product-id="${
                          product.sku_code
                        }" onclick="addtocartssv(${video.video_id}, ${
                  product.product_id
                }, '${product.sku_code}', this, 1); CTAClicksssv(${
                  product.product_id
                }, '${product.sku_code}', '${product.title}', '${
                  product.image
            ...
            ssv_brandCustomizations.cta_on_tile == "1"
              ? `
                        <div class="ontile-cta-ssv">
                            ${moredetails}
                            <a class="ontile-buynow-ssv ga-tracking-buy-ssv" data-ssv-product-id="${
                              product.sku_code
                            }" href="${product.url}" onclick="CTAClicksssv(${
                  product.product_id
                }, '${product.sku_code}', '${product.title}', '${
                  product.image
                }', '${product.url}', ${video.designer_id}, ${
          ...
          } ${formatCurrencyssv(product.discount_price)} <strike style="${
          ...
          pb += `
                        <div class="video-modal-product-block-product-ssv video-modal-product-block-product-multi-ssv" style="transform: translateX(110%);">
                            ...
                            <div class="product-middle-pb-ssv">                            
                                <div class="product-detail-pb-ssv" style="${
                                  ssv_brandCustomizations.buy_now == "1"
                                    ? "cursor: pointer;"
                                    : ""
                                }" ${ptClick}>
                                    ...
                                    <div class="product-detail-block-pb-ssv">
                                        ...
                                        <label class="dynamic-price-up-ssv dynamic-price-ssv-${
                                          product.product_id
                                        }" style="${
            ssv_brandCustomizations.product_price_status == "0"
              ? "display: none !important;"
            ...
            parseFloat(product.price) > parseFloat(product.discount_price)
              ...
              : ""
                                ...
                                <div class="product-desc-pb-ssv">
                                    <p class="product-desc-title-pb-ssv">${
                                      ssv_brandCustomizations.product_desc_title
                                    }</p>
                                    <section>${product.desription}</section>
                                    ${customDetail}                                                                       
                                </div>                                    
                                ...
                                <div class="product-options-pb-ssv possv-${
                                  video.video_id
                                }-${
            product.product_id
          }">                                    
                            ...
                            <div class="product-bottom-pb-ssv">
                                <button class="product-addtocart-pb-ssv ga-tracking-cart-ssv" data-ssv-product-id="${
                                  product.sku_code
                                }" onclick="addtocartssv(${video.video_id}, ${
            product.product_id
          }, '${product.sku_code}', this); CTAClicksssv(${
            product.product_id
            ...
            ssv_brandCustomizations.buy_now == "0"
              ...
              : ""
                                ...
                                <a href="${
                                  product.url
                                }" class="ga-tracking-buy-ssv" data-ssv-product-id="${
            product.sku_code
          }" onclick="CTAClicksssv(${product.product_id}, '${
            product.sku_code
          }', '${product.title}', '${product.image}', '${product.url}', ${
            video.designer_id
          }, ${video.video_id}, '1');">
        ...
        let moredetails =
          ssv_storeType == "6"
            ...
            : `
              ...
              }, '${video.product[0].sku_code}', this, 1); CTAClicksssv(${
                video.product[0].product_id
              }, '${video.product[0].sku_code}', '${
        ...
        let cta =
          ssv_brandCustomizations.cta_on_tile == "1"
            ? `
                ...
                video.product[0].sku_code
              }', '${video.product[0].title}', '${video.product[0].image}', '${
                video.product[0].url
              }', ${video.designer_id}, ${
                video.video_id
              }, '1');" style="background: ${
            ...
            ? `
                    <div class="product-custom-details-ssv">
                        <div class="product-cd-ssv">
                            ...
                            <label>
                                <img src="${
                                  video.product[0].product_gender == "Male"
                                    ? "https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/assets/images/webp/men-line.webp"
                                    : "https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/assets/images/webp/women-line.webp"
                                }" alt="Clock">
        ...
        productList = `
          ...
          video.product[0].product_id
        }, '${video.product[0].sku_code}', this); CTAClicksssv(${
          video.product[0].product_id
    ...
    modalSlides += `
      ...
      video.video_id
                    ...
                    <p class="video-title-modal-ssv" style="${
                      ssv_brandCustomizations.video_title == "0"
                        ? "display: none !important;"
                        : ""
                    }" title="${video.video_title}">
                    ...
                    <button class="video-modal-pip-ssv" title="PIP Mode" onclick="playpipssv();" style="${
      ...
      ssv_brandCustomizations.download_icon == "0"
        ...
        : ""
                    ...
                    <div class="video-model-marquee-ssv" style="${
                      ssv_brandCustomizations.marque_txt == "0"
                        ? "display: none !important;"
                        : ""
                    ...
                    <div class="video-modal-share-modal-ssv">
                        ...
                        <a onclick="copyEmailEmbedssv('${shareURLssv}', '${
      video.cover_image
            ...
            if (Object.keys(response.data.skus).length) {
              ...
              response.data.skus.forEach(function (sku, s) {
                optionsAppend += `                                    
                  ...
                  sku.quantity == 0 ? "disabled" : ""
                } data-p-mrp="${sku.mrp}" data-p-selling="${
                  sku.sellingPrice
                }">${sku.size}</option>                                    
                                `;
              ...
              $(`.swiper-ssv-c .dynamic-price-ssv-${product.product_id}`).html(`
                ...
                response.data.skus[i].sellingPrice
                                ...
                                <strike style="${
                                  parseFloat(response.data.skus[i].mrp) >
                                  parseFloat(response.data.skus[i].sellingPrice)
                                    ? ""
                                    : "display: none;"
                                } color:${
                ssv_brandCustomizations.mrp_fk_color
                                            ...
                                            <div>
                                                <p>${
                                                  r.UserNickname
                                                    ...
                                                    <label class="bh-stars" data-bh-rating="${
                                                      r.Rating
                                                    }">
                                                        <svg version="1.1" class="bh-star bh-star--1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24" xml:space="preserve"><path class="outline" d="M12,4.2L14.5,9l0.2,0.5l0.5,0.1l5.5,0.8L16.8,14l-0.4,0.4l0.1,0.5l1,5.3l-5-2.5L12,17.5l-0.4,0.2l-5,2.5L7.5,15l0.1-0.5 L7.2,14l-4-3.7l5.5-0.8l0.5-0.1L9.5,9L12,4.2 M11.9,2L8.6,8.6L1,9.7l5.5,5.1L5.2,22l6.8-3.4l6.8,3.4l-1.3-7.2L23,9.6l-7.6-1L11.9,2 L11.9,2z"/><polygon class="full" points="18.8,22 12,18.6 5.2,22 6.5,14.8 1,9.7 8.6,8.6 11.9,2 15.4,8.6 23,9.6 17.5,14.7"/><polyline class="left-half" points="12,18.6 5.2,22 6.5,14.8 1,9.7 8.6,8.6 11.9,2"/></svg>
...
function updatePriceBySKUssv(drp, cSymbol) {
  ...
  $(drp)
    ...
    .find(".dynamic-price-up-ssv").html(`
        ${cSymbol}${selling} 
        <strike style="${
          parseFloat(mrp) > parseFloat(selling) ? "" : "display: none;"
        } color:${
    ssv_brandCustomizations.mrp_fk_color
    ...
    parseFloat(mrp) > parseFloat(selling)
