...
(function () {
    if (localStorage.getItem('SSVallURL') && localStorage.getItem('SSVlastPlayed') && document.querySelector('#swirl-short-videos') == null) {
        ...
        jqTag.href = 'https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/multiple-playlist/v3/swirl-short-videos-v3.4.min.css';
                            ...
                            jQuery('.swirl-short-videos-M').each(function () {
                                ...
                                if (Object.keys(data['swilrs'][jQuery(cElem).data('playlist')]).length > 0) {
                                    ...
                                    data['swilrs'][jQuery(cElem).data('playlist')].forEach(swirl => {
                                        ...
                                        productsAll[swirl['video_id']] = swirl['product'];
                                        append += `<div class="swiper-slide">
                                                <video poster="${coverPoster}" ontimeupdate="updateSSVProgressBar(this);" playsinline preload="metadata" data-setup="{}" muted ${firstFivePlay} width="100%" height="100%" data-product="${product_link}" data-title="${swirl['video_title']}" data-cover="${swirl['image']}" data-link="${swirl['link']}" data-vid="${swirl['video_id']}" data-did="${swirl['designer_id']}" data-productid="${product_id}" data-productlink="${product_link}" data-gumletassetid="${swirl['gumletAssetId']}" data-totalviews="${swirl['total_views']}" data-buynow="${swirl['cta_customization']}" data-videourl="${swirl['video_url']}">
