...
(function () {
    if (localStorage.getItem('SSVallURL') && localStorage.getItem('SSVlastPlayed') && document.querySelector('#swirl-short-videos') == null) {
        ...
        jqTag.href = 'https://apigoswirl.com/short_video/v3/multiple_page/swirl-short-videos-v3.9.min.css';
        ...
        function executeNow1() {
            ...
            jQuery(document).ready(function () {
                ...
                <div id="SSV-short-videos">
                    ...
                    <div class="SSV-play-modal">                
                        <div class="SSV-play-modal-video-container">
                            ...
                            <button type="button" class="SSV-play-modal-play-pause SSV-play-modal-operation-btns" title="Play/Pause">
                                <img src="https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/assets/images/goswirl-webp/pause.webp" alt="Play/Pause icon" height="" width="">
                            </button>                    
                            <button type="button" class="SSV-play-modal-askaque SSV-play-modal-operation-btns" title="Ask Question">
                                <img src="https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/assets/images/goswirl-webp/ask-question.webp" alt="Ask Question icon" height="" width="">
                            </button>
                            ...
                            <button type="button" class="SSV-play-modal-pip SSV-play-modal-operation-btns" title="PIP Mode">
                                <img src="https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/assets/images/goswirl-webp/pip.webp" alt="Share icon" height="" width="">
                            </button>
                            ...
                            <div class="SSV-video-popup-share">
                                ...
                                <img class="SSV-facebook" src="https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/assets/images/goswirl-webp/facebook.webp" data-sharelink="" alt="Facebook icon" title="Share on Facebook" height="" width="">
                                <img class="SSV-twitter" src="https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/assets/images/goswirl-webp/twitter.webp" data-sharelink="" alt="Twitter icon" title="Share on Twitter" height="" width="">
                                <img class="SSV-whatsapp" src="https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/assets/images/goswirl-webp/whatsapp.webp" data-sharelink="" alt="Whatsapp icon" title="Share on Whatsapp" height="" width="">
                                <img class="SSV-email" src="https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/assets/images/goswirl-webp/email.webp" data-sharelink="" alt="Email icon" title="Copy email embed code" height="" width="">
                                <textarea class="SSV-email-textarea" style="display: none !important;" onclick="copyFormatedssv(this);"></textarea>
                                <img class="SSV-copy" src="https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/assets/images/goswirl-webp/copy-link.webp" data-sharelink="" alt="Copy link icon" title="Copy Link" height="" width="">
                        ...
                        <img src="https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/assets/images/goswirl-webp/back-btn.webp" class="SSV-modal-left" alt="Previous icon" height="" width="">
                        <img src="https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/assets/images/goswirl-webp/next-btn.webp" class="SSV-modal-right" alt="Next icon" height="" width="">
                    </div>
                    ...
                    <a href="/?add-to-cart=" data-quantity="1" data-product_id="" class="ajax-add-to-cart-ssv ${brandCustomizations.ajax_cart_class}" style="display: none;"></a>
            ...
            `);
                ...
                if (typeof SSVvideosAll['swilrs']['video'] != 'undefined') {
                    ...
                    SSVvideosAll['swilrs']['video'].forEach(swirl => {
                        ...
                        if (brandData['views'] === '1') {
                            videoViewsTop = `<div class="SSV-video-views-count-top">
                                                <p><img src="https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/assets/images/goswirl-webp/views-icon.webp" alt="Views icon" height="" width=""> ${swirl['total_views']}</p>                            
                                            </div>`;
                        }
                        ...
                        let autoplayVideo = swirl.cover_video ? swirl.cover_video : swirl.video_url;
                        autoplayVideo = firstFive < 6 && brandData['auto_play'] === '1' ? autoplayVideo : '';

                        append += `<div class="swiper-slide">
                        <video poster="${coverPoster}" ontimeupdate="updateSSVProgressBar(this);" ${brandData['time_sec'] === '1' ? 'onloadeddata="updateSSVDurations(this);"' : ''} playsinline preload="metadata" data-setup="{}" muted ${brandData['auto_play'] === '1' && firstFive < 6 ? 'autoplay loop' : ''} width="100%" height="100%" data-product="${product_link}" data-title="${swirl['video_title']}" data-cover="${swirl['image']}" data-link="${swirl['link']}" data-vid="${swirl['video_id']}" data-did="${swirl['designer_id']}" data-productid="${product_id}" data-productlink="${product_link}" data-gumletassetid="${swirl['gumletAssetId']}" data-totalviews="${swirl['total_views']}" data-buynow="${swirl['cta_customization']}" data-videourl="${swirl['video_url']}" data-landscape="${swirl['is_landscape']}">
                    ...
                    jQuery('#SSV-short-videos .swiper-slide').click(function () {
                        ...
                        let video = jQuery(this).children('video').attr('data-videourl');
                    ...
                    jQuery('.SSV-play-modal video').on('play', function () {
                        jQuery('.SSV-play-modal-play-pause').children('img').attr('src', 'https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/assets/images/goswirl-webp/pause.webp');
                        jQuery('.SSV-play-modal-play-pause').hide();
                    });

                    jQuery('.SSV-play-modal video').on('pause', function () {
                        jQuery('.SSV-play-modal-play-pause').children('img').attr('src', 'https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/assets/images/goswirl-webp/play.webp');
                    });
                    ...
                    jQuery('.SSV-modal-left').click(function () {
                        ...
                        if (typeof SSVallURL[(n - 1)] != 'undefined') {
                            ...
                            let poster = jQuery(`.swiper-wrapper video[data-videourl="${SSVallURL[(n - 1)]}"]`).attr('data-cover');
                            jQuery('.SSV-play-modal video').attr('poster', poster);
                    ...
                    jQuery('.SSV-copy').click(function () {
                        ...
                        jQuery('.SSV-video-popup-share span').html('Link copied!').fadeIn().delay(3000).fadeOut();
                    });

                    jQuery('.SSV-email').click(function () {
                        let link = jQuery(this).attr('data-sharelink');
                        let poster = jQuery('.SSV-play-modal video').attr('poster');

                        jQuery('.SSV-email-textarea').val(
                            `<center>
                                <a href="${link}">
                        ...
                        var htmlEditor = CodeMirror.fromTextArea(jQuery('.SSV-email-textarea')[0], {
                            mode: 'text/html'
                        });
                        copyFormatted(htmlEditor.getValue());
                        jQuery('.SSV-video-popup-share span').html('Email embed code copied!').fadeIn().delay(3000).fadeOut();
                    });
            ...
            `);
                ...
                if (document.querySelector('.swirl-short-videos-M') != null) {
                    jQuery('.swirl-short-videos-M').each(function () {
                        ...
                        urlPass = "https://api.goswirl.live/index.php/shopify/videolistingV4?user=" + code + "&playlist=" + playlistCodes;
                    });
                }
                            ...
                            jQuery('.swirl-short-videos-M').each(function () {
                                ...
                                if (Object.keys(data['swilrs'][jQuery(cElem).data('playlist')]).length > 0) {
                                    ...
                                    data['swilrs'][jQuery(cElem).data('playlist')].forEach(swirl => {
                                        ...
                                        let staticVideoTime = swirl['video_len'] ? secondsToHms(swirl['video_len']) : '00:00';
                                        ...
                                        // ontimeupdate="updateSSVProgressBar(this);" ${brandData['time_sec'] === '1' ? 'onloadeddata="updateSSVDurations(this);"' : ''}
                                        // <div class="SSV-video-progress">
                                        //      <div class="SSV-video-progress-inner" style="width: 0%;">&nbsp;</div>
                                        // </div>
                                        append += `<div class="swiper-slide">
                                                <video poster="${coverPoster}" playsinline preload="metadata" data-setup="{}" muted ${brandData['auto_play'] === '1' && firstFive < 6 ? 'autoplay loop' : ''} width="100%" height="100%" data-product="${product_link}" data-title="${swirl['video_title']}" data-cover="${swirl['image']}" data-link="${swirl['link']}" data-vid="${swirl['video_id']}" data-did="${swirl['designer_id']}" data-productid="${product_id}" data-productlink="${product_link}" data-gumletassetid="${swirl['gumletAssetId']}" data-totalviews="${swirl['total_views']}" data-buynow="${swirl['cta_customization']}" data-videourl="${swirl['video_url']}" data-landscape="${swirl['is_landscape']}">
                                                    <source src="${autoplayVideo}" type="video/mp4">
                                                </video>
                                                <div class="SSV-play-btn">
                                                    <label></label>
...
function updateSSVModalInfos(player) {
    ...
    jQuery('.SSV-CTA-modal-inner label').css('cssText', 'background: ' + brandCustomizations['bk_color_buy_btn'] + '; color: ' + brandCustomizations['front_color_buy_btn'] + ' !important;');
    ...
    jQuery('.SSV-CTA-modal-inner button').css('cssText', 'background: ' + brandCustomizations['bk_color_buy_btn'] + '; color: ' + brandCustomizations['front_color_buy_btn'] + ' !important;');
    ...
    // sold out
    jQuery('.SSV-play-modal-addtocart').removeAttr('disabled');

    // title
    let video = jQuery(player).children('source').attr('src');
    let title = jQuery(`.swiper-wrapper video[data-videourl="${video}"]`).attr('data-title');
    jQuery(player).parent('.SSV-play-modal-video-container').children('.SSV-video-popup-title').html(title);

    jQuery(player).removeClass('SSV-landscape-video');
    if (jQuery(`.swiper-wrapper video[data-videourl="${video}"]`).attr('data-landscape') === '1') {
        jQuery(player).addClass('SSV-landscape-video');
    }

    // data of modal carousel
    let currentPlaylistCode = (jQuery(`.swiper-wrapper video[data-videourl="${video}"]`).closest('.swirl-short-videos-M').data('playlist'));
    SSVallURL = SSVallBreakURL[currentPlaylistCode] ? SSVallBreakURL[currentPlaylistCode] : SSVallURL;

    // Product if attached
    let vid = jQuery(`.swiper-wrapper video[data-videourl="${video}"]`).attr('data-vid');
    ...
    if (Object.keys(products).length > 0) {
        if (Object.keys(products).length === 1) {
            ...
            // let prodLink = jQuery(`.swiper-wrapper video[data-videourl="${video}"]`).attr('data-product');
            ...
            products.forEach(product => {
                ...
                appendProds += `
                    <div class="SSV-video-popup-product-item-multi" onclick="openMultiProductDetail(this)">
                        ...
                        <div>
                            <p data-pid="${product['product_id']}" data-bpid="${product['brand_product_id']}" data-desc="${product['desription'].replace('"', '').replace('<', '').replace('>', '')}">${product['title']}</p>
        ...
        let rLink = jQuery(`.swiper-wrapper video[data-videourl="${video}"]`).attr('data-productlink');
        if (rLink) {
            jQuery('.SSV-play-modal-buynow-on').show();
            jQuery('.SSV-play-modal-buynow-on').attr('data-link', rLink);
        }
    ...
    // CTA updates
    let buynow = jQuery(`.swiper-wrapper video[data-videourl="${video}"]`).attr('data-buynow');
    ...
    // hide/show price by flag
    if (!brandCustomizations['product_price_status']) {
        jQuery('.SSV-video-popup-product label').hide();
        ...
        jQuery('.SSV-video-popup-product label').show();
        jQuery('.SSV-video-product-open label').show();
        jQuery('.SSV-video-popup-product-list-multi-product-detail label').show();
        jQuery('.SSV-video-popup-product-item-multi label').show();
    }

    // hide ask question 
    if (!brandCustomizations['ask_question']) {
        jQuery('.SSV-play-modal-askaque').hide();
    }

    // Append thumb on sharing
    let cover = jQuery(`.swiper-wrapper video[data-videourl="${video}"]`).attr('data-cover');
    jQuery('.SSV-video-popup-share img').attr('data-sharelink', jQuery('.SSV-video-popup-share img').attr('data-sharelink') + '&thumbnail=' + cover);
}
...
function SSVsendOTP(form) {
    ...
    if (!formData[0]['value'].match(regName)) {
        jQuery('.SSV-CTA-message').css('color', '#F44336');
        jQuery('.SSV-CTA-message').html('Please Enter valid name.').fadeIn().delay(2500).fadeOut();
        return false;
    }
    var regPhone = /^\d{10}$/;
    if (!formData[2]['value'].match(regPhone)) {
        jQuery('.SSV-CTA-message').css('color', '#F44336');
        jQuery('.SSV-CTA-message').html('Please Enter valid phone number.').fadeIn().delay(2500).fadeOut();
        return false;
    }
    ...
    localStorage.setItem('SWIRLVerifiedUser', JSON.stringify(user));
    SWIRLuser = user;
...
function SSVaskQuestion(form) {
    ...
    if (SWIRLuser) {
        let designerId = jQuery(`.swiper-wrapper video[data-videourl="${SSVCurrentURL}"]`).attr('data-did');
        let videoId = jQuery(`.swiper-wrapper video[data-videourl="${SSVCurrentURL}"]`).attr('data-vid');

        // ssv_fsdb.collection("swirlshortvideo_askquestion_" + designerId).doc(`${videoId}`).collection('queries').add({
        //     user_name: SWIRLuser.user_name,
        //     user_phone_code: SWIRLuser.user_phone_code,
        //     user_phone: SWIRLuser.user_phone,
        //     video_id: videoId,
        ...
        // }).catch((error) => {
        //     jQuery('.SSV-CTA-message').css('color', '#F44336');
        //     jQuery('.SSV-CTA-message').html('Failed! Try again.').fadeIn().delay(2500).fadeOut();
        ...
        jQuery.ajax({
            ...
            data: "user_id=" + encodeURIComponent('0') + "&designer_id=" + encodeURIComponent(designerId) + "&msg=" + encodeURIComponent(question) + "&swirls_id=" + encodeURIComponent(videoId) + "&username=" + encodeURIComponent(SWIRLuser.user_name) + "&userphone=" + encodeURIComponent(SWIRLuser.user_phone) + "&userphonecode=" + encodeURIComponent(SWIRLuser.user_phone_code),
            beforeSend: function () {
...
function SSVaddToCart(link, btn) {
    if (storeType == '1') {
        ...
        let productId = jQuery(btn).attr('data-bpid');

        if (brandCustomizations.ajax_cart_class == '') {
            woo_commerce_add_to_cart(jQuery(btn).attr('data-bpid'), link, btn);
        } else {
            jQuery('.ajax-add-to-cart-ssv').attr('data-quantity', 1);
            ...
            setTimeout(() => {
                // jQuery(btn).html(brandCustomizations.add_to_cart_btn);
                jQuery(btn).removeAttr('disabled');
                jQuery(btn).html('View Cart');
                jQuery(btn).attr('data-action', '3');

                // Cart count
                // if (brandCustomizations.dot_class) {
                //     if (jQuery(`.${brandCustomizations.dot_class}`).length > 0) {
                //         jQuery('.cart-count-ssv').html(parseInt(jQuery(`.${brandCustomizations.dot_class}`).html()));
                //     }
                // }
            }, 1000);
        }
...
function SSVCTAClicksTrack(pId, type) {
    // let vId = jQuery(`.swiper-wrapper video[data-videourl="${SSVCurrentURL}"]`).attr('data-vid');
    // let dId = jQuery(`.swiper-wrapper video[data-videourl="${SSVCurrentURL}"]`).attr('data-did');

    // let product = [];
    // let proucts = productsAll[vId];
    // proucts.forEach(p => {
    //     if (p.product_id == pId) {
    //         product = p;
    //     }
    ...
    //     user_name: SWIRLuser ? SWIRLuser.user_name : '',
    //     user_phone_code: SWIRLuser ? SWIRLuser.user_phone_code : '',
    //     user_phone: SWIRLuser ? SWIRLuser.user_phone : '',
    //     video_id: vId,
    //     product_id: pId,
    //     product_title: Object.keys(product).length ? product.title : '',
    //     product_image: Object.keys(product).length ? product.image : '',
    //     product_url: Object.keys(product).length ? product.url : '',
    //     designer_id: dId,
    //     cta_type: type,
    //     created_at: Math.round((new Date().getTime() / 1000))
    // }).then(function () {
    ...
    let pid = pId;
    let cType = type;
    let uid = SWIRLuser ? SWIRLuser.user_id : 0;
...
function gumletVideoCount() {
    ...
    // let gumletAssetId = jQuery(`.swiper-wrapper video[data-videourl="${SSVCurrentURL}"]`).attr('data-gumletassetid');
