...
(function () {
    if (localStorage.getItem('SSVallURL') && localStorage.getItem('SSVlastPlayed') && document.querySelector('#swirl-short-videos') == null) {
        ...
        jqTag.href = 'https://apigoswirl.com/short_video/v3/laavanya/swirl-short-videos-v3.9.min.css';
                    ...
                    <div class="SSV-play-modal">                
                        <div class="SSV-play-modal-video-container">
                            ...
                            <div class="SSV-video-popup-share">
                                ...
                                <input type="text" class="SSV-copylink-input" value="" style="color: #323232 !important; display: none;" onclick="SSVcopyLink(this);">
                            </div>
