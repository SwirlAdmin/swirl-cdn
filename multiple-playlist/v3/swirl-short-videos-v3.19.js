                    ...
                    <div class="SSV-play-modal">                
                        <div class="SSV-play-modal-video-container">
                            ...
                            <div class="SSV-video-popup-share">
                                ...
                                <img class="SSV-email" src="https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn@latest/assets/images/email.png" data-sharelink="" alt="Email icon" title="Copy email embed code" height="" width="">
            ...
            `);
                ...
                if (typeof SSVvideosAll['swilrs']['video'] != 'undefined') {
                    ...
                    SSVvideosAll['swilrs']['video'].forEach(swirl => {
                        ...
                        <video poster="${coverPoster}" ontimeupdate="updateSSVProgressBar(this);" ${brandData['time_sec'] === '1' ? 'onloadeddata="updateSSVDurations(this);"' : ''} playsinline preload="metadata" data-setup="{}" muted ${firstFivePlay} width="100%" height="100%" data-product="${product_link}" data-title="${swirl['video_title']}" data-cover="${swirl['image']}" data-link="${swirl['link']}" data-vid="${swirl['video_id']}" data-did="${swirl['designer_id']}" data-productid="${product_id}" data-productlink="${product_link}" data-gumletassetid="${swirl['gumletAssetId']}" data-totalviews="${swirl['total_views']}" data-buynow="${swirl['cta_customization']}" data-videourl="${swirl['video_url']}" data-landscape="${swirl['is_landscape']}">
                            ...
                            jQuery('.swirl-short-videos-M').each(function () {
                                ...
                                if (Object.keys(data['swilrs'][jQuery(cElem).data('playlist')]).length > 0) {
                                    ...
                                    data['swilrs'][jQuery(cElem).data('playlist')].forEach(swirl => {
                                        ...
                                        // </div>
                                        append += `<div class="swiper-slide">
                                                <video poster="${coverPoster}" playsinline preload="metadata" data-setup="{}" muted ${firstFivePlay} width="100%" height="100%" data-product="${product_link}" data-title="${swirl['video_title']}" data-cover="${swirl['image']}" data-link="${swirl['link']}" data-vid="${swirl['video_id']}" data-did="${swirl['designer_id']}" data-productid="${product_id}" data-productlink="${product_link}" data-gumletassetid="${swirl['gumletAssetId']}" data-totalviews="${swirl['total_views']}" data-buynow="${swirl['cta_customization']}" data-videourl="${swirl['video_url']}" data-landscape="${swirl['is_landscape']}">
                                                    <source src="${firstFivePlay && swirl['cover_video'] ? swirl['cover_video'] : swirl['video_url']}" type="video/mp4">
                                                </video>
                                                <div class="SSV-play-btn">
                                                    <label></label>
                                                </div>
