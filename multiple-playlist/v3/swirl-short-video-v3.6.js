                            ...
                            jQuery('.swirl-short-videos-M').each(function () {
                                ...
                                if (Object.keys(data['swilrs'][jQuery(cElem).data('playlist')]).length > 0) {
                                    ...
                                    data['swilrs'][jQuery(cElem).data('playlist')].forEach(swirl => {
                                        ...
                                        // </div>
                                        append += `<div class="swiper-slide">
                                                <video poster="${coverPoster}" playsinline preload="metadata" data-setup="{}" muted ${firstFivePlay} width="100%" height="100%" data-product="${product_link}" data-title="${swirl['video_title']}" data-cover="${swirl['image']}" data-link="${swirl['link']}" data-vid="${swirl['video_id']}" data-did="${swirl['designer_id']}" data-productid="${product_id}" data-productlink="${product_link}" data-gumletassetid="${swirl['gumletAssetId']}" data-totalviews="${swirl['total_views']}" data-buynow="${swirl['cta_customization']}" data-videourl="${swirl['video_url']}">
