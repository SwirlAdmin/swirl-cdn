...
(function () {
    ...
    if (localStorage.getItem('SSVallURL') && localStorage.getItem('SSVlastPlayed') && document.querySelector('#swirl-short-videos') == null) {
        ...
        jqTag.href = 'https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/multiple-playlist/v7/swirl-short-video-v7.2.min.css';
                ...
                jQuery.ajax({
                    ...
                    success: function (data) {
                        if (data) {
                            ...
                            // console.log(SSVallBreakURL);
                            // console.log(SSVallURL);
...
window.onresize = updateSSVSwiperNavigation;