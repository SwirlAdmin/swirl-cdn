...
(function () {
    ...
    if (localStorage.getItem('SSVallURL') && localStorage.getItem('SSVlastPlayed') && document.querySelector('#swirl-short-videos') == null) {
        ...
        jqTag.src = 'https://goswirl.shop/swirl-embed/short-videos-carousel/v7/swiper-bundle.min.js';
        ...
        jqTag.href = 'https://goswirl.shop/swirl-embed/short-videos-carousel/v7/short-videos.css';
        ...
        var jqTag = document.createElement('link');
        jqTag.rel = 'stylesheet';
        jqTag.href = 'https://goswirl.shop/swirl-embed/short-videos-carousel/v7/swiper-bundle.min.css';
        headTag.insertBefore(jqTag, headTag.firstChild);
                        ...
                        if (typeof data['swilrs']['video'] != 'undefined') {
                            ...
                            data['swilrs']['video'].forEach(swirl => {
                                ...
                                if (Object.keys(swirl['product']).length > 0) {
                                    ...
                                    let strikePrice = parseFloat(swirl['product'][0]['price']) > parseFloat(swirl['product'][0]['discount_price']) ? `<strike>${swirl['product'][0]['currencysymbols'] +' '+ swirl['product'][0]['price']}</strike> ${swirl['product'][0]['currencysymbols'] +' '+ swirl['product'][0]['discount_price']}` : swirl['product'][0]['currencysymbols'] +' '+ swirl['product'][0]['price'];
