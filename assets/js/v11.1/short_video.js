...
(function () {
    ...
    if (localStorage.getItem('SSVallURL') && localStorage.getItem('SSVlastPlayed') && document.querySelector('#swirl-short-videos') == null) {
        ...
        jqTag.href = 'https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn@latest/assets/css/v9/short-videos.min.css';
            ...
            `);
                ...
                if (typeof SSVvideosAll['swilrs']['video'] != 'undefined') {
                    ...
                    SSVvideosAll['swilrs']['video'].forEach(swirl => {
                        ...
                        <video poster="${coverPoster}" ontimeupdate="updateSSVProgressBar(this);" ${brandData['time_sec'] === '1' ? 'onloadeddata="updateSSVDurations(this);"' : ''} playsinline preload="metadata" data-setup="{}" muted ${firstFivePlay} width="100%" height="100%" data-product="${product_link}" data-title="${swirl['video_title']}" data-cover="${swirl['image']}" data-link="${swirl['link']}" data-vid="${swirl['video_id']}" data-did="${swirl['designer_id']}" data-productid="${product_id}" data-productlink="${product_link}" data-gumletassetid="${swirl['gumletAssetId']}" data-totalviews="${swirl['total_views']}">
        ...
        function executeNow() {
            ...
            `);
                ...
                let urlPass = '';
                urlPass = "https://shop.goswirl.live/index.php/shopify/videolistingV2?user=" + code;
                ...
                if (typeof jQuery('#swirl-short-videos').data('onpdp') != 'undefined') {
                    urlPass = 'https://shop.goswirl.live/index.php/shopify/getmultiple_productvideo?url=' + url;
                }
                    ...
                    success: function (data) {
                        if (typeof data['swilrs']['video'] === 'undefined' && localStorage.getItem('SSVallURL') && typeof jQuery('#swirl-short-videos').data('onpdp') != 'undefined') {
                            if(localStorage.getItem('SSVallURL') && localStorage.getItem('SSVlastPlayed')) {
                                ...
                                jQuery('#SWIRL-short-videos .swiper').css('display', 'none');                                         
                            }
                        }
                        ...
                        if (typeof data['swilrs']['video'] != 'undefined') {
                            ...
                            data['swilrs']['video'].forEach(swirl => {
                                ...
                                if (Object.keys(swirl['product']).length > 0) {
                                    product_id = swirl['product'][0]['product_id'];
                                    product_link = swirl['product'][0]['url'];
                                    let productsBadge = Object.keys(swirl['product']).length > 1 ? `<span>${Object.keys(swirl['product']).length}</span>` : '';
                            ...
                            jQuery('#SWIRL-short-videos .swiper-wrapper').empty();
                            jQuery('#SWIRL-short-videos .swiper').hide();
                        }
                    }
                });
...
function updateSSVModalInfos(player) {
    ...
    jQuery('.SSV-play-modal-buynow-on').css('color', brandCustomizations['front_color_buy_btn']);
    jQuery('.SSV-pm-buy-now').css('color', brandCustomizations['front_color_buy_btn']);
    jQuery('.SSV-pmm-buy-now').css('color', brandCustomizations['front_color_buy_btn']);
    ...
    jQuery('.SSV-pm-add-to-cart').css('color', brandCustomizations['front_color_add_to_cart_btn']);
    jQuery('.SSV-pmm-add-to-cart').css('color', brandCustomizations['front_color_add_to_cart_btn']);
    ...
    jQuery('.SSV-CTA-modal-inner label').css('color', brandCustomizations['front_color_buy_btn']);

    jQuery('.SSV-CTA-modal-inner button').css('background', brandCustomizations['bk_color_buy_btn']);
    jQuery('.SSV-CTA-modal-inner button').css('color', brandCustomizations['front_color_buy_btn']);
