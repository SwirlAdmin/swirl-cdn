...
function resetPIPSL() {
    document.querySelector('.SL-pip-live').innerHTML = `
        ...
        <img class="SL-pip-close-btn" onclick="closePIPSL();" src="https://apigoswirl.com/assets/vivo/live-close-icon.svg">  
...
function executeSLiveNow() {
    $('body').append(`
        <div class="SL-iframe-live" style="display:none;">
            ...
            <img class="SL-popup-close-btn SL-popup-close-btn-P" onclick="closeLiveStreamPop(true);" src="https://apigoswirl.com/assets/vivo/arrow-down-s-line.svg">          
...
function openPIPSL() {
    ...
    // let pW = window.innerWidth > 768 ? 180 : 150;
    // let lW = window.innerWidth > 768 ? 250 : 200;
    // $('.SL-pip-live').css('aspect-ratio', `${pipStreamData.video_orientation == '1' ? '9/16' : '16/9'}`);
    // $('.SL-pip-live')[0].style.setProperty('width', `${pipStreamData.video_orientation == '1' ? pW + 'px' : lW + 'px'}`, 'important');
    // $('.SL-pip-live')[0].style.setProperty('height', 'auto', 'important');
...
function fullScreenPIPSL() {
    ...
    if (event.target.classList == 'SL-pip-close-btn') return;
...
function SLtoggleFullScreen(fs) {
    ...
    //     let elem = document.documentElement; // Use the entire page as fullscreen target
