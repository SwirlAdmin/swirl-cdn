...
function executeSLiveNow() {
    ...
    $.ajax({
        ...
        url: `https://goswirl-livestream-configs.s3.ap-south-1.amazonaws.com/static-assets/${code}.json`,
...
function openPIPSL() {
    ...
    if (pipStreamData.is_live == '0' && pipStreamData.show_preview == '0') return;
