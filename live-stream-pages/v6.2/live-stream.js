...
var jqTag = document.createElement('link');
jqTag.rel = 'stylesheet';
jqTag.href = 'https://goswirl.shop/swirl-embed/live-stream-page/v6.1/live-streams.css';
...
function openPIPSL() {
    ...
    } else if (pipStreamData.recording_url != '' && pipStreamData.recording_url.includes('.mp4')) {
        if (pipStreamData.video_orientation == '1') $('.SL-pip-live').addClass('SL-pip-live-P');
        $('.SL-pip-live video source').attr('type', 'video/mp4');
