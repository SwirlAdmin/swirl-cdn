                                    ...
                                    <div class="col-md-12 mb-2 SL-full-card" style="background: #fff8fc !important;">
                                        <div class="row align-items-center justify-content-center">
                                            <div class="col-12 col-md-2 p-0">
                                                <video autoplay class="SL-vdo-thmub-full" playsinline="playsinline" preload="auto" muted="muted" loop>
                                                    <source src="${scheduled.shopify_url}" type="video/mp4">
                                                </video>
                                            </div>
                                ...
                                append += `                                
                                    <div class="col-6 col-md-2 mb-1 px-md-1 loading-SL" ${scounts > (displaySL + 1) ? 'style="display: none;"' : ''}>                                        
                                        <div class="SL-active-stream-video-container position-relative" data-stream="${scheduled.streamURL}">
                                            <video autoplay class="SL-vdo-thmub" playsinline="playsinline" preload="auto" muted="muted" loop>
                                                <source src="${scheduled.shopify_url}" type="video/mp4">
                                            </video>
                                            <img src="https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/assets/images/goswirl-webp/play.webp" class="SL-play-btn" alt="Play icon"
                                                >                                                                                
                                    ...
                                    <div class="col-md-12 mb-2 SL-full-card" style="background: #fff8fc !important;" data-stream="${completed.streamURL}">
                                        <div class="row align-items-center justify-content-center">
                                            <div class="col-6 col-md-2 p-0">
                                                <video autoplay class="SL-vdo-thmub-full" playsinline="playsinline" preload="auto" muted="muted" loop>
                                                    <source src="${completed.shopify_url}" type="video/mp4">
                                                </video>
                                            </div>
                                            <div class="col-6 col-md-10 py-1 ${customization.scheduled_grid == '0' ? 'order-md-first' : ''}"">
