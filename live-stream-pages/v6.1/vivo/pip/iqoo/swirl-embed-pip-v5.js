...
function executeSLiveNow() {
    $('#swirl-live-streams').append(`
        ...
        <div class="SL-iframe-live" style="display:none;">
            <iframe style="width: 100%;height: 100vh;border: none;position: fixed;top: 0;left: 0;z-index: 1211;" src="" allow="clipboard-read; clipboard-write; fullscreen"></iframe>
                                    ...
                                    <div class="col-md-12 mb-2 SL-full-card" style="background: #fff8fc !important;" data-stream="${scheduled.streamURL}">
                                        <div class="row align-items-center justify-content-center">
                                            <div class="col-md-4 p-0 position-relative">
                                                ...
                                                <label class="SL-stream-badge" style="color: ${customization.date_fk_color} !important; background: ${customization.date_bk_color} !important;">Upcoming</label>
                                            </div>
...
function watchStream(stream) {
    ...
    // slsFrame.src = stream.includes("?flag") ? stream + '&plugin=' + link + '&page=listing' : stream + '?plugin=' + link + '&page=listing';
    slsFrame.contentWindow.location.replace(stream.includes("?flag") ? stream + '&plugin=' + link + '&page=listing' : stream + '?plugin=' + link + '&page=listing');
