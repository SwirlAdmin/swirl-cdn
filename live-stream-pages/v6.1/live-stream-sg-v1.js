                    ...
                    if (data['scheduled'].length) {
                        data['scheduled'].forEach(scheduled => {
                            ...
                            if (scounts == 1) {
                                append += `                                
                                    <div class="col-md-12 mb-2 SL-full-card" style="background: #fff8fc !important;">
                                        <div class="row align-items-center justify-content-center">
                                            ...
                                            <div class="col-md-10 py-1 ${customization.scheduled_grid == '0' ? 'order-md-first' : ''}">
                                ...
                                append += `                                
                                    <div class="col-md-2 mb-1 px-md-1 loading-SL" ${scounts > (displaySL + 1) ? 'style="display: none;"' : ''}>                                        
