        ...
        success: function (data) {
            ...
            if (Object.keys(data).length && (data['scheduled'].length || data['completed'].length)) {
                    ...
                    if (data['completed'].length) {
                        data['completed'].forEach(completed => {
                            ...
                            if (scounts == 1) {
                                ...
                                append += `
                                    <div class="col-md-3 mb-1 px-md-1 loading-SL" ${scounts > (displaySL + 1) ? 'style="display: none;"' : ''}>                                        
                                        <div class="SL-active-stream-video-container position-relative" data-stream="${completed.streamURL}">
                ...
                if (typeof params['stream'] != 'undefined') {
                    ...
                    setTimeout(() => {
                        $(`div[data-stream="${window.atob(params['stream'])}"]`).find('.streamClick').click();
                    }, 500);
                }
