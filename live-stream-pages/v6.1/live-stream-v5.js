...
function executeSLiveNow() {
    $('#swirl-live-streams').append(`
        ...
        <div class="SL-iframe-live" style="display:none;">
            <iframe style="width: 100%;height: 100vh;border: none;position: fixed;top: 0;left: 0;z-index: 1211;" src="" allow="clipboard-read; clipboard-write"></iframe>
            <img onclick="closeLiveStreamPop();" src="https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/assets/images/live-close-icon.svg" style="position: fixed;top: 15px;right: 15px;z-index: 1211;height: 30px;width: 30px;cursor: pointer;">            
        </div> 
    ...
    $.ajax({
        type: "POST",
        dataType: "json",
        url: "https://api.apigoswirl.live/index.php/api/LiveAPI/streamlisting?user=" + code,
                ...
                if (customization.format == 0) {
                    ...
                    if (data['scheduled'].length) {
                        data['scheduled'].forEach(scheduled => {
                            ...
                            if (scounts == 1) {
                                append += `                                
                                    <div class="col-md-12 mb-2 SL-full-card" style="background: #fff8fc !important;">
                                        <div class="row align-items-center justify-content-center">
                                            <div class="col-md-4 p-0">
                                                <img src="${scheduled.cover_img}" class="SL-vdo-thmub-full" alt="Stream Thumbnail" >
                                            </div>
                                            <div class="col-md-8 py-1 ${customization.scheduled_grid == '0' ? 'order-md-first' : ''}">
                                                ...
                                                <div class="SL-share mt-2">
                                                    ...
                                                    <img class="SL-facebook SL-share-images" src="https://apigoswirl.com/short_video/assets/images/goswirl-webp/facebook.webp" data-sharelink="${urlSL + '?stream=' + window.btoa(scheduled.streamURL)}" alt="Facebook icon" title="Share on Facebook">
                                                    <img class="SL-twitter SL-share-images" src="https://apigoswirl.com/short_video/assets/images/goswirl-webp/twitter.webp" data-sharelink="${urlSL + '?stream=' + window.btoa(scheduled.streamURL)}" alt="Twitter icon" title="Share on Twitter">
                                                    <img class="SL-whatsapp SL-share-images" src="https://apigoswirl.com/short_video/assets/images/goswirl-webp/whatsapp.webp" data-sharelink="${urlSL + '?stream=' + window.btoa(scheduled.streamURL)}" alt="Whatsapp icon" title="Share on Whatsapp">
                                                    <img class="SL-copy SL-share-images" src="https://apigoswirl.com/short_video/assets/images/goswirl-webp/copy-link.webp" data-sharelink="${urlSL + '?stream=' + window.btoa(scheduled.streamURL)}" alt="Copy link icon" title="Copy link">                                                
                                                </div>                                                
                                            </div>                                            
                                        </div>                                        
                                    </div>                                    
                                ...
                                x[scheduled.id] = setInterval(function () {
                                    ...
                                    if (distance[scheduled.id] < 0) {
                                        ...
                                        $('.SL-schedule-timer').html(`
                                            ...
                                            <button class="SL-watch-live-btn" onclick="watchStream('${scheduled.streamURL}');" style="color: ${customization.date_fk_color} !important; background: ${customization.date_bk_color} !important;">WATCH LIVE</button>
                                        `);
                                    }
                                }, 1000);
                            } else {
                                append += `                                
                                    <div class="col-md-3 mb-1 px-md-1 loading-SL" ${scounts > (displaySL + 1) ? 'style="display: none;"' : ''}>                                        
                                        <div class="SL-active-stream-video-container position-relative" data-stream="${scheduled.streamURL}" onclick="!event.target.className.includes('SL-share-images') ? watchStream('${scheduled.streamURL}') : '';">
                                            ...
                                            <img src="https://apigoswirl.com/short_video/assets/images/goswirl-webp/play.webp" class="SL-play-btn" alt="Play icon"
                                                >                                                                                
                                    ...
                                    <div class="col-md-12 mb-2 SL-full-card" style="background: #fff8fc !important;">
                                        <div class="row align-items-center justify-content-center">
                                            ...
                                            <div class="col-md-8 py-1 ${customization.scheduled_grid == '0' ? 'order-md-first' : ''}"">
                                                ...
                                                <button class="SL-stream-play-action-full" onclick="watchStream('${completed.streamURL}');" style="color: ${customization.date_bk_color} !important; border-color: ${customization.date_bk_color} !important;">Watch Now</button>

                                                <div class="SL-share mt-2">
                                                    <p class="SL-link-copied" style="color: ${customization.date_bk_color} !important;">Link Copied!</p>
                                                    <img class="SL-facebook SL-share-images" src="https://apigoswirl.com/short_video/assets/images/goswirl-webp/facebook.webp" data-sharelink="${urlSL + '?stream=' + window.btoa(completed.streamURL)}" alt="Facebook icon" title="Share on Facebook">
                                                    <img class="SL-twitter SL-share-images" src="https://apigoswirl.com/short_video/assets/images/goswirl-webp/twitter.webp" data-sharelink="${urlSL + '?stream=' + window.btoa(completed.streamURL)}" alt="Twitter icon" title="Share on Twitter">
                                                    <img class="SL-whatsapp SL-share-images" src="https://apigoswirl.com/short_video/assets/images/goswirl-webp/whatsapp.webp" data-sharelink="${urlSL + '?stream=' + window.btoa(completed.streamURL)}" alt="Whatsapp icon" title="Share on Whatsapp">
                                                    <img class="SL-copy SL-share-images" src="https://apigoswirl.com/short_video/assets/images/goswirl-webp/copy-link.webp" data-sharelink="${urlSL + '?stream=' + window.btoa(completed.streamURL)}" alt="Copy link icon" title="Copy link">                                                
                                                </div>
                                            </div>
                                        </div>                                        
                                    </div>                                    
                                    ...
                                    <div class="col-md-3 mb-1 px-md-1 loading-SL" ${scounts > (displaySL + 1) ? 'style="display: none;"' : ''}>                                        
                                        <div class="SL-active-stream-video-container position-relative" data-stream="${completed.streamURL}" onclick="!event.target.className.includes('SL-share-images') ? watchStream('${completed.streamURL}') : '';">
                                            ...
                                            <img src="https://apigoswirl.com/short_video/assets/images/goswirl-webp/play.webp" class="SL-play-btn" alt="Play icon"
                                                >                                        
                                            <p class="SL-date-top">${onDT.split(',')[0]}</p>
                                            ${customization.total_view_set ? `<p class="SL-views-top"><img src="https://apigoswirl.com/short_video/assets/images/goswirl-webp/views-icon.webp" alt="Views icon"> ${completed.total_views}</p>` : ''}                                        
                                            <div class="SL-stream-info-container" style="background: ${customization.date_bk_color} !important;">
                                                <div class="SL-stream-info">                                                    
                                                    <div class="text-left SL-share">
                                                        <p class="SL-link-copied" style="color: ${customization.date_fk_color} !important;">Link Copied!</p>
...
function watchStream(stream) {
    ...
    slsFrame.src = stream.includes("?flag") ? stream + '&plugin=' + link : stream + '?plugin=' + link;
