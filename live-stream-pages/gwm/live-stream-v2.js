...
document.addEventListener("DOMContentLoaded", function () {
    ...
    jqTag.href = 'https://cdn.jsdelivr.net/gh/SwirlAdmin/swirl-cdn/live-stream-pages/gwm/style-v1.min.css';
...
async function executeSLiveNow() {
    const isExactDomain = window.location.hostname === 'www.gwmoman.com';
